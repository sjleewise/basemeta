...
function initGrid()
{
    ...
    with(grid_sheet){
        ...
        var headers = [
                    {Text:"No.|상태|선택|도메인ID|제정차수|공통표준도메인그룹명|공통표준도메인분류명|공통표준도메인명|공통표준도메인설명|데이터타입|데이터길이|데이터소수점길이|저장형식|표현형식|단위|허용값", Align:"Center"}
                    /* No.|상태|선택|도메인그룹명|인포타입명|만료일시|시작일시|데이터타입|데이터길이|데이터소수점길이|버전|설명|작성시각|작성사용자ID */
//                     No.|상태|선택|제정차수|공통표준도메인그룹명|공통표준도메인분류명|공통표준도메인명|공통표준도메인설명|데이터타입|데이터길이|데이터소수점길이|저장형식|표현형식|단위|허용값								
        ...
        var cols = [                        
                    ...
                    {Type:"Text",   Width:200,  SaveName:"dmnId",    Align:"Left", Edit:1, Hidden:1},
                    {Type:"Text",   Width:100,  SaveName:"enactDgr",    Align:"Left", Edit:1}, 
                    {Type:"Text",   Width:200,  SaveName:"uppDmngLnm",    Align:"Left", Edit:1},
                    {Type:"Text",   Width:200,  SaveName:"dmngLnm",    Align:"Center", Edit:1, Hidden:0},
                    {Type:"Text",   Width:300,  SaveName:"dmnLnm",    Align:"Center", Edit:1, Hidden:0, KeyField:1},
                    {Type:"Text",   Width:300,  SaveName:"objDescn",    Align:"Center", Edit:1, Hidden:0, KeyField:1},
                    {Type:"Text",   Width:150,  SaveName:"dataType",    Align:"Left", Edit:1, KeyField:0},          
                    {Type:"Int",   Width:130,  SaveName:"dataLen",    Align:"Center", Edit:1},
                    {Type:"Int",   Width:120,  SaveName:"dataScal",     Align:"Center", Edit:1},
                    {Type:"Text",   Width:130,  SaveName:"saveType",      Align:"Center",   Edit:1, Hidden:0},
                    {Type:"Text",   Width:130,  SaveName:"examData",      Align:"Left",   Edit:1, Hidden:0},
                    {Type:"Text",   Width:130,  SaveName:"unitType",      Align:"Left",   Edit:1, Hidden:1},
                    {Type:"Text",   Width:130,  SaveName:"cdValRule",      Align:"Left",   Edit:1, Hidden:0}
                ];
...
function doAction(sAction)
{
    ...
    {		    
        ...
        case "Delete" :
        	...
        	var url = '<c:url value="/commons/damgmt/gov/govDmnLstDellist.do"/>';
        	var param = "";
...
//         	}
            ...
            var url = "<c:url value="/commons/damgmt/gov/govDmnLstReglist.do"/>";
//         	var param = "commDcdNm=test";
        ...
        case "Search":
        	...
        	//alert(param);
        	grid_sheet.DoSearch('<c:url value="/commons/damgmt/gov/govDmnLstSelectlist.do" />', param);
                    ...
                    <tbody>     
                        <tr>  
                          <th scope="row"><label for="dmnLnm">
                           ...
                           <td>
                           <input type="text"  id="sditmLnm" name="sditmLnm"  />
                            </td>  
                          <th scope="row"><label for="objDescn">
                          	 공통표준도메인 설명
                          </label></th> <!--  공통표준단어 설명 -->
                           <td>
                           <input type="text"  id="objDescn" name="objDescn"  />
                           </td>
                        </tr>  
                   </tbody> 
                 </table>   
