...
function initGrid()
{
    ...
    with(grid_sheet){
        ...
        var cols = [                        
                    ...
                    {Type:"Combo",   Width:40,  SaveName:"stndAsrt",    Align:"Center", Edit:1, KeyField:1,UpdateEdit:0},
...
function loadDetail(param) {
	$('div#detailInfo').load('<c:url value="/commons/damgmt/symn/ajaxgrid/admin_symn_dtl.do"/>', param, function(){
		if(!isBlankStr(param)) {
			initDtlGrid();
			grid_sub_symnchange.DoSearch('<c:url value="/commons/damgmt/symn/ajaxgrid/symnchange_dtl.do" />', param);
		}
	});
...
<div style="clear:both; height:5px;"><span></span></div>
	...
	<div id="tabs">
	  ...
	  <div id="tabs-1">
		...
		<div id="tabs-2">
			<%@include file="symnchange_dtl.jsp" %>
	  </div>
	 </div>
	<!-- 선택 레코드의 내용을 탭처리 END -->
