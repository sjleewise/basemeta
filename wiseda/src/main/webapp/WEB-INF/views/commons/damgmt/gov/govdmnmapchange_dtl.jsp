...
function initgrid_sub_govdmnmapchange() {

    with(grid_sub_govdmnmapchange){
    	
    	var cfg = {SearchMode:2,Page:100};
        SetConfig(cfg);
        
        var headers = [
                    {Text:"No.|상태|선택|공통표준도메인ID|제정차수|공통표준도메인그룹명|공통표준도메인분류명|공통표준도메인명|공통표준도메인설명|데이터타입|길이|소수점|저장형식|표현형식|단위|허용값|기관표준도메인ID|기관표준도메인논리명|기관표준도메인물리명|등록유형코드|등록일자|등록자ID|등록자명", Align:"Center"}
                ];
...
//                     {Type:"Combo",   Width:130,  SaveName:"stndAsrt",    Align:"Left", Edit:0, KeyField:1,UpdateEdit:0},
                    ...
                    {Type:"Text",   Width:100,  SaveName:"dataType",    Align:"Center", Edit:0, KeyField:1},
                    {Type:"Text",   Width:100,  SaveName:"dataLen",    Align:"Right", Edit:0, KeyField:0},
                    {Type:"Text",   Width:100,  SaveName:"dataScal",    Align:"Right", Edit:0, KeyField:0},
                    {Type:"Text",   Width:100,  SaveName:"saveType",    Align:"Left", Edit:0, KeyField:0},
                    {Type:"Text",   Width:100,  SaveName:"examData",    Align:"Left", Edit:0, KeyField:0},
                    {Type:"Text",   Width:100,  SaveName:"unitType",    Align:"Left", Edit:0, KeyField:0},
                    {Type:"Text",   Width:100,  SaveName:"cdValRule",    Align:"Left", Edit:0, KeyField:0},
                    
                    {Type:"Text",   Width:50,  SaveName:"dmnId",    Align:"Left", Edit:0, Hidden:1},
                    {Type:"Text",   Width:200,  SaveName:"dmnLnm",    Align:"Center", Edit:0, KeyField:0},
...
//         SetColProperty("stndAsrt", 	${codeMap.stndAsrtibs});     	
   	...
   	//==시트설정 후 아래에 와야함=== 
    init_sheet(grid_sub_govdmnmapchange);    
    //===========================
...
y : y좌표
*/
function grid_sub_govdmnmapchange_OnDblClick(row, col, value, cellx, celly) {

	if(row < 1) return;
	
}

function grid_sub_govdmnmapchange_OnClick(row, col, value, cellx, celly) {
...
function grid_sub_govdmnmapchange_OnSearchEnd(code, message, stCode, stMsg) {
	if (stCode == 401) {
...
<div style="clear:both; height:5px;"><span></span></div>
	...
	<!-- 그리드 입력 입력 -->
	<div class="grid_01">
	     <script type="text/javascript">createIBSheet("grid_sub_govdmnmapchange", "100%", "150px");</script>
	</div>
	<!-- 그리드 입력 입력 End -->
