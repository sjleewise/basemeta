...
function initGrid()
{
    ...
    with(grid_sheet){
        ...
        var headers = [
                    {Text:"No.|상태|선택|공통표준ID|차수|공통표준용어명|공통표준용어영문약어명|공통표준용어설명|도메인ID|공통표준도메인명|저장 형식|표현 형식|허용값|행정표준코드명|소관기관명", Align:"Center"}
                    /* No.|상태|선택|도메인그룹명|인포타입명|만료일시|시작일시|데이터타입|데이터길이|데이터소수점길이|버전|설명|작성시각|작성사용자ID */
                    /* No.|상태|선택|차수|공통표준용어명|공통표준용어설명|공통표준용어영문약어명|공통표준도메인명|허용값|저장 형식|표현 형식|행정표준코드명|소관기관명 */
                    ];
...
//                     {Type:"Combo",   Width:130,  SaveName:"stndAsrt",    Align:"Left", Edit:1, KeyField:1,UpdateEdit:0},
                    ...
                    {Type:"Text",   Width:130,  SaveName:"enactDgr",    Align:"Center", Edit:1, Hidden:0},
                    {Type:"Text",   Width:300,  SaveName:"sditmLnm",    Align:"Center", Edit:1 , KeyField:1},
                    {Type:"Text",   Width:200,  SaveName:"sditmPnm",    Align:"Center", Edit:1, KeyField:1},
                    {Type:"Text",   Width:300,  SaveName:"objDescn",    Align:"Left", Edit:1, KeyField:1},          
                    {Type:"Text",   Width:130,  SaveName:"dmnId",    Align:"Left", Edit:0,Hidden:1, KeyField:0},          
                    {Type:"Text",   Width:130,  SaveName:"dmnLnm",    Align:"Center", Edit:1},
                    ...
                    {Type:"Text",   Width:130,  SaveName:"govStndCd",      Align:"Left",   Edit:1, Hidden:0},
                    {Type:"Text",   Width:130,  SaveName:"govOrgNm",      Align:"Left",   Edit:1, Hidden:0},
//                     {Type:"Text",   Width:130,  SaveName:"regTypCd",      Align:"Left",   Edit:0, Hidden:1}
...
function doAction(sAction)
{
    ...
    {		    
        ...
        case "Delete" :
        	...
        	var url = '<c:url value="/commons/damgmt/gov/govSditmLstDellist.do"/>';
        	var param = "";
...
//         	}
            ...
            var url = "<c:url value="/commons/damgmt/gov/govSditmLstReglist.do"/>";
//         	var param = "commDcdNm=test";
        ...
        case "Search":
        	...
        	//alert(param);
        	grid_sheet.DoSearch('<c:url value="/commons/damgmt/gov/govSditmLstSelectlist.do" />', param);
            ...
            <div class="tb_basic2">
                <table width="100%" border="0" cellspacing="0" cellpadding="0" summary="<s:message code='USER.INQ' />"> <!-- 사용자조회 -->
                   ...
                   <col style="width:35%;" />
                    ...
                    <tbody>      
                        <tr>  
                          <th scope="row"><label for="sditmLnm">
                          		공통표준용어명
                          </label></th> <!-- 공통표준단어명 -->
                           <td>
