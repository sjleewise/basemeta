...
function initGrid()
{
    ...
    with(grid_sheet){
        ...
        var headers = [
                    ...
                    /* No.|상태|선택|시스템구분|업무구분|결재레벨|결재자ID|결재자|결재방식|결재그룹|전결대결구분|
                    	대결자ID|대체결재자|대체결재시작일자|대체결재종료일자|설명|버전|등록유형|작성일시|작성자ID|작성자명 */
                ];
        ...
        var cols = [                        
                    ...
                    {Type:"Combo",    Width:120,  SaveName:"sysDcd",     Align:"Left", Edit:0, KeyField:0, Hidden:1}, 
