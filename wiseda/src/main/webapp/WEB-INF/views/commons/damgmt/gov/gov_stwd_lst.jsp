...
function initGrid()
{
    ...
    with(grid_sheet){
        ...
        var headers = [ 
                        {Text:"No.|상태|선택|공통표준단어ID|제정차수|공통표준단어명|공통표준단어영문약어명|공통표준단어 영문명|공통표준단어 설명|형식단어여부|공통표준도메인분류명|이음동의어 목록|금칙어 목록", Align:"Center"}
//                     {Text:"<s:message code='COMMON.HEADER.DMNGINFOMAP.LST'/>", Align:"Center"}
                    ...
                    /* No.|상태|선택|공통표준단어ID|공통표준단어명|공통표준단어영문약어명|공통표준단어영문명|공통표준단어설명|형식단어여부|공통표준도메인분류명|이음동의어목록|금칙어목록 */
                ];
...
//                     {Type:"Combo",   Width:130,  SaveName:"stndAsrt",    Align:"Left", Edit:1, KeyField:1,UpdateEdit:0},
                    ...
                    {Type:"Text",   Width:80,  SaveName:"enactDgr",    Align:"Left", Edit:1, KeyField:1},
                    {Type:"Text",   Width:400,  SaveName:"stwdLnm",    Align:"Center", Edit:1 , KeyField:1},
                    {Type:"Text",   Width:200,  SaveName:"stwdPnm",    Align:"Center", Edit:1, KeyField:1},
                    {Type:"Text",   Width:130,  SaveName:"engNm",    Align:"Center", Edit:1},
                    {Type:"Text",   Width:400,  SaveName:"objDescn",    Align:"Left", Edit:1, KeyField:1},          
                    {Type:"Combo",   Width:80,  SaveName:"dmnYn",    Align:"Center", Edit:1},
                    {Type:"Text",   Width:180,  SaveName:"dataLen",    Align:"Center", Edit:1},
                    {Type:"Text",   Width:200,  SaveName:"synonyms",     Align:"Center", Edit:1},
                    {Type:"Text",   Width:200,  SaveName:"prohibits",      Align:"Center",   Edit:1},
//                     {Type:"Text",   Width:130,  SaveName:"regTypCd",      Align:"Left",   Edit:1, Hidden:0},
//                     {Type:"Date",   Width:130,  SaveName:"regDtm",      Align:"Left",   Edit:0, Hidden:1, Format:"yyyy-MM-dd HH:mm:ss"},
//                     {Type:"Text",   Width:130,  SaveName:"regUserId",      Align:"Left",   Edit:0, Hidden:1},
//                     {Type:"Text",   Width:130,  SaveName:"aplDtm",      Align:"Left",   Edit:0, Hidden:1},
...
function doAction(sAction)
{
    ...
    {		    
        ...
        case "Delete" :
        	...
        	var url = '<c:url value="/commons/damgmt/gov/govStwdLstDellist.do"/>';
        	var param = "";
...
//         	}
            ...
            var url = "<c:url value="/commons/damgmt/gov/govStwdLstReglist.do"/>";
//         	var param = "commDcdNm=test";
        ...
        case "Search":
        	...
        	//alert(param);
        	grid_sheet.DoSearch('<c:url value="/commons/damgmt/gov/govStwdLstSelectlist.do" />', param);
            ...
            <div class="tb_basic2">
                <table width="100%" border="0" cellspacing="0" cellpadding="0" summary="<s:message code='USER.INQ' />"> <!-- 사용자조회 -->
                   ...
                   <col style="width:35%;" />
                    ...
                    <tbody>      
                          <th scope="row"><label for="stwdLnm">
                          		공통표준단어명
                          </label></th> <!-- 공통표준단어명 -->
                           <td>
                           <input type="text"  id="stwdLnm" name="stwdLnm"  />
                            </td>  
