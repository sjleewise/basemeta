	...
	$('.btnDelPop').click(function(event){
	 ...
	 $('.btnSearchPop').click(function(event){
			...
			//$('div#popSearch').dialog("open");
				...
				var popwin = OpenModal(url+"?"+param, "menupop",  850, 450, "no");
				popwin.focus();
...
<body>
   ...
   <!-- 입력폼 시작 -->
    ...
    <table border="0" cellspacing="0" cellpadding="0"  summary="">
      ...
      <tr>
        <th class="" ><s:message code="ALTR.WORD.LGC.NM" /></th> <!-- 대체어논리명 -->
        <td>
        ...
        <th class="" ><s:message code="ALTR.WORD.PHYC.NM" /></th> <!-- 대체어물리명 -->
        <td>
