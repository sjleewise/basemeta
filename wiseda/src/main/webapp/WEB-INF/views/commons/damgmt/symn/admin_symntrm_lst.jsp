...
function initGrid()
{
    ...
    with(grid_sheet){
        ...
        var headers = [
                     {Text:"<s:message code='COMMON.HEADER.ADMIN.SYMN.TRM.LST'/>"}
                ];
        //No.|상태|선택|유사어ID|유사어/금칙어 명|유사어물리명|구분코드|표준단어ID|대체어논리명|대체어물리명|설명|버전|
        //등록유형코드|최초요청일시|최초요청사용자ID|최초요청사용자명|요청일시|요청사용자ID|승인일시|승인사용자ID
