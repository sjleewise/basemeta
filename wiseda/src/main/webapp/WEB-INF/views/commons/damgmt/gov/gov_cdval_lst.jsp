...
function initGrid()
{
    ...
    with(grid_sheet){
        ...
        var headers = [
                    {Text:"No.|상태|선택|코드값ID|코드값|코드값명|도메인ID|도메인논리명|상위코드값ID|객체설명|등록유형코드|표시순서|사용여부", Align:"Center"}
                    /* No.|상태|선택|도메인그룹명|인포타입명|만료일시|시작일시|데이터타입|데이터길이|데이터소수점길이|버전|설명|작성시각|작성사용자ID */
                    /* No.|상태|선택|코드값ID|코드값|코드값명|도메인ID|도메인논리명|상위코드값ID|객체설명|등록유형코드|표시순서|사용여부*/
...
//                     {Type:"Combo",   Width:130,  SaveName:"stndAsrt",    Align:"Left", Edit:1, KeyField:1,UpdateEdit:0},
                    {Type:"Text",   Width:200,  SaveName:"cdValId",    Align:"Left", Edit:1, Hidden:1}, 
                    {Type:"Text",   Width:200,  SaveName:"cdVal",    Align:"Left", Edit:1, KeyField:1,UpdateEdit:0},
                    {Type:"Text",   Width:200,  SaveName:"cdValNm",    Align:"Center", Edit:1, KeyField:1, Hidden:0},
                    {Type:"Text",   Width:130,  SaveName:"dmnId",    Align:"Center", Edit:0, Hidden:1},
                    {Type:"Text",   Width:200,  SaveName:"dmnLnm",    Align:"Left", Edit:1, KeyField:1},          
                    {Type:"Text",   Width:200,  SaveName:"uppCdValId",    Align:"Center", Edit:0, Hidden:1},
                    {Type:"Text",   Width:300,  SaveName:"objDescn",     Align:"Center", Edit:1, KeyField:1},
                    {Type:"Text",   Width:130,  SaveName:"regTypCd",      Align:"Center",   Edit:0, Hidden:1},
//                     {Type:"Text",   Width:130,  SaveName:"regDtm",      Align:"Left",   Edit:1, Hidden:0},
//                     {Type:"Date",   Width:130,  SaveName:"regUserId",      Align:"Left",   Edit:0, Hidden:1},
                    {Type:"Text",   Width:130,  SaveName:"dispOrd",      Align:"Left",   Edit:1, Hidden:0},
//                     {Type:"Text",   Width:130,  SaveName:"aprStrDt",      Align:"Left",   Edit:0, Hidden:1},
//                     {Type:"Text",   Width:130,  SaveName:"aprEndDt",      Align:"Left",   Edit:0, Hidden:1},
                    {Type:"Text",   Width:130,  SaveName:"useYn",      Align:"Left",   Edit:1, Hidden:0}
...
function doAction(sAction)
{
    ...
    {		    
        ...
        case "Delete" :
        	...
        	var url = '<c:url value="/commons/damgmt/gov/govCdValLstDellist.do"/>';
        	var param = "";
...
//         	}
            ...
            var url = "<c:url value="/commons/damgmt/gov/govCdValLstReglist.do"/>";
//         	var param = "commDcdNm=test";
        ...
        case "Search":
        	...
        	//alert(param);
        	grid_sheet.DoSearch('<c:url value="/commons/damgmt/gov/govCdValLstSelectlist.do" />', param);
...
<%-- 	    <s:message code="DMN.GRP.INFO.TY.MAPG" /> --%>
		공통표준유효값관리
	    </div> <!-- 도메인그룹 인포타입 매핑 -->
	</div>
</div>
            ...
            <div class="tb_basic2">
                <table width="100%" border="0" cellspacing="0" cellpadding="0" summary="<s:message code='USER.INQ' />"> <!-- 사용자조회 -->
                   ...
                   <col style="width:35%;" />
                    ...
                    <tbody>      
                        <tr>  
                          <th scope="row"><label for="cdVal">
                          		공통표준유효값
                          </label></th> <!-- 공통표준유효값 -->
                           <td>
                           <input type="text"  id="cdVal" name="cdVal"  />
                            </td>  
                          <th scope="row"><label for="cdValNm">
                          	 공통표준유효값명
                          </label></th> <!-- 공통표준유효값명 -->
                           <td>
                           <input type="text"  id="cdValNm" name="cdValNm"  />
                           </td>
                        </tr> 
                   </tbody> 
                 </table>   
