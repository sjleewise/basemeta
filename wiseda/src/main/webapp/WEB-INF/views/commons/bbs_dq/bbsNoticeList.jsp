...
function addNotice(){
	document.frm.action = "<c:url value='/commons/bbs_dq/addBoardArticle.do'/>";
	document.frm.submit();
}
...
function inquire_notice(i, bbsId, nttId) {
	...
	document.subForm.bbsId.value = bbsId;
  	document.subForm.action = "<c:url value='/commons/bbs_dq/selectBoardArticle.do'/>";
...
<div class="">
       ...
       <div class="search_div">    
			...
			<div style="clear:both; height:5px;"><span></span></div>
            <form name="frm" action ="<c:url value='/commons/bbs_dq/selectBoardList.do'/>" method="post">
...
<%--               	<td><c:out value="${result.nttId}"/></td> --%>
              	<td>${result.cateNm}</td>
              	<td class="link_txt">
              		<form name="subForm" method="post" action="<c:url value='/commons/bbs_dq/selectBoardArticle.do'/>">
