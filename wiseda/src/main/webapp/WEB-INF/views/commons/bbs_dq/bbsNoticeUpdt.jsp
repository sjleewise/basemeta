...
function doAction(action) {
	...
	switch(action) {
	case 'UPDATE':
		document.board.action = "<c:url value='/commons/bbs_dq/updateBoardArticle.do'/>";
...
function select_noticeList() {
	document.board.action = "<c:url value='/commons/bbs_dq/selectBoardList.do'/>";
	document.board.submit();
}
...
<body>
        ...
        <div style="clear:both; height:5px;"><span></span></div>
			...
			<form:form commandName="board" name="board" method="post" enctype="multipart/form-data" >
				...
				<input type="hidden" name="returnUrl" value="<c:url value='/commons/bbs_dq/forUpdateBoardArticle.do'/>"/>
