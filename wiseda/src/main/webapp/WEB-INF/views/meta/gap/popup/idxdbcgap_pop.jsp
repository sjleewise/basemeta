...
//     	var cfg = {SearchMode:2,Page:100};
        SetConfig(cfg);
        SetMergeSheet(5);
        var header1 = "<s:message code='META.HEADER.IDXDBCGQP.POP1'/>";
        /* No.|상태|인덱스명|컬럼명|DBC|DBC|DBC|DBC|DBC(운영)|DBC(운영)|DBC(운영)|DBC(운영)|DBC(운영)|DBC(운영) */
        var header2 = "<s:message code='META.HEADER.IDXDBCGQP.POP2'/>";
        ...
        var cols = [                        
						...
						{Type:"Text",   Width:100,   SaveName:"dbcIdxNm",	 	Align:"Center", Edit:0, Hidden:0},
						{Type:"Text",   Width:100,   SaveName:"dbcIdxColNm",	 	Align:"Center", Edit:0, Hidden:0},
						{Type:"Text",   Width:50,   SaveName:"ord",	 	Align:"Center", Edit:0, Hidden:0},
						{Type:"Combo",   Width:50,   SaveName:"pkYn",	 	Align:"Center", Edit:0, Hidden:0},
						{Type:"Combo",   Width:50,   SaveName:"uqYn",	 	Align:"Center", Edit:0, Hidden:0},
						{Type:"Text",   Width:40,   SaveName:"sortType",	 	Align:"Center", Edit:0, Hidden:0},
						{Type:"Text",   Width:30,   SaveName:"dbcRealIdxNm",	 	Align:"Center", Edit:0, Hidden:1},
						{Type:"Text",   Width:80,   SaveName:"dbcRealIdxColNm",	 	Align:"Center", Edit:0, Hidden:1},
						{Type:"Text",   Width:50,   SaveName:"ddlTsfIdxColOrd",	 	Align:"Center", Edit:0, Hidden:0},
						{Type:"Combo",   Width:50,   SaveName:"ddlTsfPkYn",	 	Align:"Center", Edit:0, Hidden:0},
						{Type:"Combo",   Width:50,   SaveName:"ddlTsfUqYn",	 	Align:"Center", Edit:0, Hidden:0},
						{Type:"Text",   Width:40,   SaveName:"tsfSortTyp",	 	Align:"Center", Edit:0, Hidden:0},
		...
		SetColProperty("ddlTsfUqYn", 	{ComboCode:"N|Y", ComboText:"<s:message code='COMBO.NO.YES'/>"}); /* 아니요|예 */
...
function doAction(sAction)
{
    ...
    {		    
        case "Search":
        	var param = "dbSchId=${search.dbSchId}&dbTsfSchId=${search.dbTsfSchId}&dbcIdxNm=${search.dbcIdxNm}&dbcRealIdxNm=${search.dbcRealIdxNm}";
           
            //if($("#dbSchId option:selected").val()==''){
            //	showMsgBox("INF", "<s:message code="REQ.NO.TGTSCH" />");	
            //	return false;
            //}
        	gapcollist_grid.DoSearch('<c:url value="/meta/gap/getDbcIdxColGapList.do" />', param);
        	//alert(param);
        	break;
