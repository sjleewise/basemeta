...
//     	var cfg = {SearchMode:2,Page:100};
        SetConfig(cfg);
        SetMergeSheet(5);
        var header1 = "<s:message code='META.HEADER.IDXDDLTSFGQP.POP1'/>";
        /* No.|상태|인덱스명|컬럼명|DDL|DDL|DDL|DDL|DDL(운영)|DDL(운영)|DDL(운영)|DDL(운영)|DDL(운영)|DDL(운영) */
        var header2 = "<s:message code='META.HEADER.IDXDDLTSFGQP.POP2'/>";
        ...
        var cols = [                        
						...
						{Type:"Text",   Width:40,   SaveName:"ddlIdxColOrd",	 	Align:"Center", Edit:0, Hidden:0},
						...
						{Type:"Text",   Width:30,   SaveName:"ddlTsfIdxPnm",	 	Align:"Center", Edit:0, Hidden:1},
						{Type:"Text",   Width:100,   SaveName:"ddlTsfIdxColPnm",	 	Align:"Center", Edit:0, Hidden:0},
						{Type:"Text",   Width:40,   SaveName:"ddlTsfIdxColOrd",	 	Align:"Center", Edit:0, Hidden:0},
						{Type:"Combo",   Width:40,   SaveName:"ddlTsfPkYn",	 	Align:"Center", Edit:0, Hidden:0},
						{Type:"Combo",   Width:40,   SaveName:"ddlTsfUqYn",	 	Align:"Center", Edit:0, Hidden:0},
...
function doAction(sAction)
{
    ...
    {		    
        case "Search":
        	var param = "dbSchId=${search.dbSchId}&ddlIdxId=${search.ddlIdxId}&ddlTsfIdxId=${search.ddlTsfIdxId}&dbTsfSchId=${search.dbTsfSchId}";
           
            //if($("#dbSchId option:selected").val()==''){
            //	showMsgBox("INF", "<s:message code="REQ.NO.TGTSCH" />");	
            //	return false;
            //}
        	gapcollist_grid.DoSearch('<c:url value="/meta/gap/getDdlTsfIdxColGapList.do" />', param);
        	//alert(param);
        	break;
		...
		<tr>
			<td>
			 	<div id="grid_99" class="grid_01">
				     <script type="text/javascript">createIBSheet("gapcollist_grid", "100%", "500px");</script>            
				</div>
			</td>
		</tr>
		</tbody>
