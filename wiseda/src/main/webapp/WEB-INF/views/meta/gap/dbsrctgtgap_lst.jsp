...
function initGrid()
{
    ...
    with(grid_sheet){
        ...
        var headtext  = "<s:message code='META.HEADER.DBSRCTGTGAP.LST'/>";
        ...
        var cols = [                        
                    ...
                    {Type:"Text",   Width:100,  SaveName:"srcDbcColCnt",  Align:"Center", Edit:0},
                    {Type:"Text",   Width:100,  SaveName:"tgtDbcColCnt",  Align:"Center", Edit:0},
...
function initColGrid()
{
    ...
    with(col_sheet){
        ...
        var headtext1  = "<s:message code='META.HEADER.DBSRCTGTGAP.LST1'/>";
        var headtext2  = "<s:message code='META.HEADER.DBSRCTGTGAP.LST2'/>";
        ...
        var cols = [                        
					...
					{Type:"Text",   Width:120,  SaveName:"srcDbcColPnm",	Align:"Left",   Edit:0},
                    {Type:"Text",   Width:120,  SaveName:"srcDbcColLnm",    Align:"Left",   Edit:0}, 
                    {Type:"Text",   Width:80,   SaveName:"srcDbcColOrd",	Align:"Left",   Edit:0},
                    {Type:"Text",   Width:80,   SaveName:"srcDbcPkYn",	    Align:"Center", Edit:0}, 
                    {Type:"Text",   Width:80,   SaveName:"srcDbcDataType",  Align:"Center", Edit:0},                     
                    {Type:"Text",   Width:80,   SaveName:"srcDbcDataLen",   Align:"Center", Edit:0}, 
                    {Type:"Text",   Width:80,   SaveName:"srcDbcDataScal",  Align:"Center", Edit:0},
                    {Type:"Text",   Width:80,   SaveName:"srcDbcNonulYn",   Align:"Center", Edit:0},	
                    {Type:"Text",   Width:80,   SaveName:"srcSchDefltVal",  Align:"Center", Edit:0},
					{Type:"Text",   Width:120,  SaveName:"tgtDbcColPnm",	Align:"Left",     Edit:0},
                    {Type:"Text",   Width:120,  SaveName:"tgtDbcColLnm",    Align:"Left",     Edit:0}, 
                    {Type:"Text",   Width:80,   SaveName:"tgtDbcColOrd",	Align:"Center",   Edit:0},                    
                    {Type:"Text",   Width:80,   SaveName:"tgtDbcPkYn",      Align:"Center",   Edit:0}, 
                    {Type:"Text",   Width:80,   SaveName:"tgtDbcDataType",  Align:"Center",   Edit:0}, 
                    {Type:"Text",   Width:80,   SaveName:"tgtDbcDataLen", 	Align:"Center",   Edit:0}, 
                    {Type:"Text",   Width:80,   SaveName:"tgtDbcDataScal",  Align:"Center",   Edit:0},
                    {Type:"Text",   Width:80,   SaveName:"tgtDbcNonulYn",   Align:"Center", Edit:0},	
                    {Type:"Text",   Width:80,   SaveName:"tgtDbcDefltVal",  Align:"Center", Edit:0},
...
function grid_sheet_OnClick(row, col, value, cellx, celly) {
	...
	col_sheet.DoSearch("<c:url value="/meta/gap/getDbSrcTgtColGapList.do" />", param1); 		 	
}
	...
	<fieldset>
	     ...
	     <div class="tb_basic2">
	         <table width="100%" border="0" cellspacing="0" cellpadding="0" summary="DB간 GAP분석">
	            ...
	            <tbody>                            
					<tr>	 
					    <th scope="row" class="th_require"><label for="srcDbConnTrgId">소스DBMS/스키마명</label></th> <!--DBMS/스키마명  -->
						<td>							 
				             <select id="srcDbSchId" class="" name="srcDbSchId" style="width:250px;">				             
				             </select>
				        </td>
					    
					    <th scope="row" class="th_require"><label for="tgtDbcConnTrgId">타겟DBMS/스키마명</label></th> <!--DBMS/스키마명  -->
						<td>							 
