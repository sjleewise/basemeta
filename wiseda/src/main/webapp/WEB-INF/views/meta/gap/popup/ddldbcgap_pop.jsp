...
//     	var cfg = {SearchMode:2,Page:100};
        SetConfig(cfg);
        SetMergeSheet(5);
        var header1 = "<s:message code='META.HEADER.DDLDBCGAP.POP1'/>";
        /* No.|상태|테이블명|테이블한글명|컬럼명|컬럼한글명|DDL|DDL|DDL|DDL|DDL|DDL|DDL|DDL|DDL|DDL|DBC|DBC|DBC|DBC|DBC|DBC|DBC|DBC|DBC */
        var header2 = "<s:message code='META.HEADER.DDLDBCGAP.POP2'/>";
        ...
        var cols = [                        
						...
						{Type:"Text",   Width:30,   SaveName:"dbcColPnm",	 	Align:"Center", Edit:0, Hidden:1},
...
function doAction(sAction)
{
    ...
    {		    
        case "Search":
        	var param = "ddlTblPnm=${search.ddlTblPnm}&dbConnTrgLnm=${search.dbConnTrgLnm}&dbSchId=${search.dbSchId}&dbcTblNm=${search.dbcTblNm}";
           
            //if($("#dbSchId option:selected").val()==''){
            //	showMsgBox("INF", "<s:message code="REQ.NO.TGTSCH" />");	
            //	return false;
            //}
        	gapcollist_grid.DoSearch('<c:url value="/meta/gap/getDdlDbcColGap.do" />', param);
        	//alert(param);
        	break;
