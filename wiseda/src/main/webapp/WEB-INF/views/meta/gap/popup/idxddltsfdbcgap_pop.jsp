...
//     	var cfg = {SearchMode:2,Page:100};
        SetConfig(cfg);
        SetMergeSheet(5);
        var header1 = "<s:message code='META.HEADER.IDXDDLTSFDBCGQP.POP1'/>";
        /* No.|상태|인덱스명|컬럼명|DDL|DDL|DDL|DDL|DBC|DBC|DBC|DBC|DBC|DBC */
        var header2 = "<s:message code='META.HEADER.IDXDDLTSFDBCGQP.POP2'/>";
...
function doAction(sAction)
{
    ...
    {		    
        case "Search":
        	var param = "dbSchId=${search.dbSchId}&ddlIdxPnm=${search.ddlIdxPnm}&dbcIdxNm=${search.dbcIdxNm}";
           
            //if($("#dbSchId option:selected").val()==''){
            //	showMsgBox("INF", "<s:message code="REQ.NO.TGTSCH" />");	
            //	return false;
            //}
        	gapcollist_grid.DoSearch('<c:url value="/meta/gap/getDdlTsfDbcIdxColGapList.do" />', param);
        	//alert(param);
        	break;
