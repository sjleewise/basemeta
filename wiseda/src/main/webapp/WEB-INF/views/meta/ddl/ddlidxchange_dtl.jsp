...
//     	var cfg = {SearchMode:2,Page:100};
        ...
        SetMergeSheet(1);
        var headers = [
                    {Text:"<s:message code='META.HEADER.DDLIDXCHANGE.DTL1'/>"
                    	/* No.|인덱스ID|만료일시|시작일시|인덱스명|인덱스명(논리)|DBMSID|DBMS명|스키마ID|DB스키마명|DDL테이블ID|DDL테이블명|DDL테이블명(논리)|인덱스스페이스ID|인덱스스페이스명| */
						+"<s:message code='META.HEADER.DDLIDXCHANGE.DTL2'/>", Align:"Center"}
...
function grid_sub_ddlidxchange_OnSearchEnd(code, message, stCode, stMsg) {
	if (stCode == 401) {
