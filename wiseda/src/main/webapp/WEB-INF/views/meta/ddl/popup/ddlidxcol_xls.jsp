...
<html>
<head>
<title><s:message code="DDL.IDEX.CLMN.EXCL.UPLOAD" /></title> <!-- DDL인덱스컬럼-엑셀업로드 -->
...
//     		alert("저장할 대상이 없습니다...");
		...
		//인덱스컬럼순서로 정렬 후 값이 넘어간다
		grid_sheet.ColumnSort("10|18");
    	//doAction("Save");  
	});
	// 엑셀내리기 Event Bind
...
function initGrid()
{
    ...
    with(grid_sheet){
        ...
        var headtext  = "<s:message code='META.HEADER.DDLIDXCOL.XLS.1'/>"; //No.|상태|선택|검토상태|검토내용|요청구분|등록유형|검증결과
        headtext += "<s:message code='META.HEADER.DDLIDXCOL.XLS.2'/>"; //|DB접속정보명|DB스키마명|DDL테이블명|인덱스스페이스명|인덱스(물리명)
    	headtext += "";
    	headtext += "<s:message code='META.HEADER.DDLIDXCOL.XLS.3'/>"; //|DDL컬럼ID|인덱스ID|인덱스컬럼ID|인덱스컬럼(물리명)|인덱스컬럼(논리명)|인덱스컬럼순서|정렬순서


    	//headtext += "|데이터타입|길이|소수점길이|PK 여부|PK 순서|NOT NULL여부|DEFAULT 값";
	    headtext += "<s:message code='META.HEADER.DDLIDXCOL.XLS.4'/>"; //|설명|요청일시|요청자ID|요청자명|요청번호|요청일련번호|요청상세일련번호
        ...
        var cols = [                        
					...
					{Type:"Combo",  Width:80,   SaveName:"vrfCd",	  Align:"Center", Edit:0, Hidden:1},
					
					{Type:"Text",    Width:120,  SaveName:"dbConnTrgPnm"    ,Align:"Left",   Edit:1, Hidden:0, KeyField:1},
					{Type:"Text",    Width:120,  SaveName:"dbSchPnm"    ,Align:"Left",   Edit:1, Hidden:0, KeyField:1},
					{Type:"Text",    Width:120,  SaveName:"ddlTblPnm"    ,Align:"Left",   Edit:1, Hidden:0, KeyField:1},
					{Type:"Text",    Width:120,  SaveName:"idxSpacPnm"    ,Align:"Left",   Edit:1, Hidden:0, KeyField:0},
					{Type:"Text",    Width:120,  SaveName:"ddlIdxPnm"    ,Align:"Left",   Edit:1, Hidden:0, KeyField:1},
                    ...
                    {Type:"Text",    Width:130, SaveName:"ddlIdxColPnm"   ,Align:"Left",   Edit:1, KeyField:1},
                    {Type:"Text",    Width:130, SaveName:"ddlIdxColLnm"   ,Align:"Left",   Edit:1, KeyField:1},
                    
                    {Type:"Int",     Width:80,  SaveName:"ddlIdxColOrd"      ,Align:"Center",   Edit:1, KeyField:1},
                    {Type:"Combo",    Width:80,  SaveName:"sortTyp"     ,Align:"Center",   Edit:1, KeyField:1},
...
//  	 	   	if(SaveJson.data.length == 0) return;
 	 	    ...
 	 	    var url = "<c:url value="/meta/ddl/regddlidxcolxlsrqstlist.do"/>";
 	 		//iframe 형태의 팝업일 경우
        	var param = "";
        	if ("${search.popType}" == "I") {
...
<div class="pop_tit" >
    ...
    <div class="pop_tit_txt"><s:message code="EXCL.UPLOAD.DDL.IDEX.CLMN" /></div> <!-- 엑셀업로드-DDL인덱스컬럼 -->
