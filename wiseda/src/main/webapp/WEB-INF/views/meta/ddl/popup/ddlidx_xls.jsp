...
<html>
<head>
<title><s:message code="DDL.IDEX.-.EXCL.UPLOAD" /></title> <!-- DDL인덱스-엑셀업로드 -->
...
function initGrid()
{
    ...
    with(grid_sheet){
        ...
        var headtext  = "<s:message code='META.HEADER.DDLIDX.XLS1'/>";
        /* No.|상태|선택|검토상태|검토내용|요청구분|등록유형|검증결과 */
    	headtext += "<s:message code='META.HEADER.DDLIDX.XLS2'/>";
    	/* |DDL테이블ID|테이블(물리명)|테이블(논리명) */
		        	
    	headtext += "<s:message code='META.HEADER.DDLIDX.XLS3'/>";
    	/* |DDL인덱스ID|인덱스(물리명)|인덱스(논리명)|PK여부|UNIQUE여부|인덱스유형 */
    	
    	headtext += "<s:message code='META.HEADER.DDLIDX.XLS4'/>";
    	/* |DB접속대상명|DB스키마명|인덱스스페이스|스크립트정보 */
    	headtext += "<s:message code='META.HEADER.DDLIDX.XLS5'/>";
        ...
        var cols = [                        
                    ...
                    {Type:"Text",   Width:120,  SaveName:"ddlIdxPnm", 	 Align:"Left",   Edit:1, KeyField:1},
                    {Type:"Text",   Width:120,  SaveName:"ddlIdxLnm", 	 Align:"Left",   Edit:1},
                    {Type:"Combo",   Width:70,  SaveName:"pkIdxYn", 	 Align:"Center",   Edit:1},
                    {Type:"Combo",   Width:70,  SaveName:"ukIdxYn", 	 Align:"Center",   Edit:1},
                    {Type:"Combo",   Width:100,  SaveName:"idxTypCd", 	 Align:"Center",   Edit:1},
                    
                    
                    {Type:"Text",   Width:120,  SaveName:"dbConnTrgPnm"	,    Align:"Left",   Edit:1, KeyField:1},
                    {Type:"Text",   Width:120,  SaveName:"dbSchPnm",    Align:"Left",   Edit:1, KeyField:1},
                    {Type:"Text",   Width:120,  SaveName:"idxSpacPnm"	,    Align:"Left",   Edit:1, KeyField:0},
...
<div class="pop_tit" >
    ...
    <div class="pop_tit_txt"><s:message code="EXCL.UPLOAD.-DDL.IDEX" /></div><!-- 엑셀업로드-DDL인덱스 -->
