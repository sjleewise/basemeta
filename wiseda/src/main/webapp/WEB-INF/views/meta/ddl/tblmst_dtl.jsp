...
<body>
   ...
   <!-- 입력폼 시작 -->
    ...
    <table border="0" cellspacing="0" cellpadding="0"  summary="">
      ...
      <tbody>                   
                            <tr>
                     	        <th scope="row"><label for="mstDdlTblPnm"><s:message code="MAIN.TBL.PHYC.LGC.NM" /></label></th><!-- 주테이블 물리/논리명 -->
                           	...
                           	<tr>
                           	<th scope="row"><label for="histDdlTblPnm"><s:message code="ASSI.TBL.PHYC.LGC.NM" /></label></th><!-- 보조테이블 물리/논리명 -->
