...
<html>
<head>
<title><s:message code="DDL.TBL.INQ" /></title> <!-- DDL 테이블 검색 -->
...
function initGrid()
{
    ...
    with(grid_sheet){
        ...
        //headtext += "No.|상태|선택|주제영역ID|주제영역|DBMS명|스키마명|테이블ID|DDL테이블(물리명)|DDL테이블(논리명)|요청자명|객체설명";
        //headtext += "Num|State|Choice|SubjectAreaID|Subject Area|DBMS Name|Schema Name|Table ID|DDL table (physical name)|DDL table (physical name)|Requester name|Object Description"
        
        headtext = "<s:message code='META.HEADER.DDLTBLFORIDX.POP'/>"
        //No.|상태|선택|주제영역ID|주제영역|DBMS명|스키마명|테이블ID|DDL테이블(물리명)|DDL테이블(논리명)|테이블스페이스ID|테이블스페이스|요청자명|객체설명
        ...
        var cols = [                        
			            ...
			            {Type:"Text",     Width:120,  SaveName:"idxSpacId",      Align:"Left",   Edit:0}, 
			            {Type:"Text",     Width:120,  SaveName:"idxSpacPnm", 	 Align:"Left",   Edit:0},
...
// 	     SetColProperty("regTypCd", 	{ComboCode:"C|U|D", ComboText:"<s:message code='NEW.CHG.DEL' />"});/* 신규|변경|삭제 */
        ...
        SetColHidden("idxSpacId",1);
        SetColHidden("idxSpacPnm",1);
      	if(popRqst == 'N') {
                       ...
                       <tr>                               
                           ...
                           <th scope="row"><label for="ddlTblLnm"><s:message code="TBL.NM" /></label></th> <!-- 테이블명 -->
                            <td colspan="3">
                                ...
                                <input type="text" name="ddlTblLnm" id="pdmTblLnm" value="${search.ddlTblPnm}"/>
                                </span>
                            </td>                           
                       </tr>
