...
function initGrid()
{
    ...
    with(grid_sheet){
        ...
        var headtext  = "<s:message code='META.HEADER.DDLSEQ.XLS'/>";
        //No.|상태|삭제|검토상태|검토내용|요청사유|요청구분|등록유형|검증결과|시퀀스(물리명)|시퀀스(논리명)|DB접속대상(물리명)|DB사용자(물리명)|명명규칙|사용용도|테이블명|컬럼명|L1코드|L3코드|권한목록|INCREMENT BY|START WITH|MIN VALUE|MAX VALUE|CYCLE여부|ORDER여부|CACHE SIZE|패키지명|클래스명|초기화구분코드|초기화실패업무영향도|스크립트정보|적용요청구분|적용요청일자|설명|요청일시|요청자ID|요청자명|요청번호|요청일련번호
        var headers = [
        ...
        var cols = [                        
					...
					{Type:"Text",   Width:100,   SaveName:"ddlSeqPnm",	 Align:"Left",   Edit:1, KeyField:1},
					{Type:"Text",   Width:0,   SaveName:"ddlSeqLnm",	 Align:"Left",   Edit:0, Hidden:1},		
					{Type:"Text",   Width:100,   SaveName:"dbConnTrgPnm",	 Align:"Center",   Edit:1, KeyField:1},
					{Type:"Text",   Width:100,   SaveName:"dbSchPnm",	 Align:"Center",   Edit:1, KeyField:1},
					...
					{Type:"Text",   Width:100,   SaveName:"incby",	 Align:"Center",   Edit:1, KeyField:1},
					{Type:"Text",   Width:100,   SaveName:"strtwt",	 Align:"Center",   Edit:1, KeyField:1},
					{Type:"Text",   Width:100,   SaveName:"minval",	 Align:"Center",   Edit:1, KeyField:1},
					{Type:"Text",   Width:100,   SaveName:"maxval",	 Align:"Center",   Edit:1, KeyField:1},
					
					
					{Type:"Combo",   Width:100,   SaveName:"cycYn",	 Align:"Center",   Edit:1},
					{Type:"Combo",   Width:100,   SaveName:"ordYn",	 Align:"Center",   Edit:1},
					{Type:"Text",   Width:100,   SaveName:"cacheSz",	 Align:"Center",   Edit:1},
                    ...
                    {Type:"Combo",  Width:80,  SaveName:"aplReqTypCd",  Align:"Center",   Edit:1, Hidden:1},
                    {Type:"Text",   Width:80,  SaveName:"aplReqdt",  Align:"Left",   Edit:1, Hidden:1, Format:"yyyy-MM-dd"},
...
function grid_sheet_OnLoadExcel(result,code,msg) {
	var excelCnt = "";
  	if ("${search.popType}" == "I") {
 		excelCnt = $("#mstFrm #excelCnt", parent.document).val();
 	} else {
 		excelCnt = $("#mstFrm #excelCnt", opener.document).val();
 	}
	if(code==1){
	}else{
...
<div class="pop_tit" >
    ...
    <div class="pop_tit_txt">엑셀업로드-DDL시퀀스</div>
...
<div id="search_div">
                   ...
                   <tbody>
                   		<tr>                          
                            ...
                            <td>
                                ...
                                <input type="text" name="ddlSeqPnm" id="ddlSeqPnm" />
                                </span>
                            </td>  
                       </tr>
                   </tbody>
       ...
       <div class="tb_comment">
       	...
       	<br>4. 권한목록에 2개의 이상의 권한을 입력하는 경우 구분자 ; 를 이용하여 입력해야합니다. 예)LNA;FEX;
       </div>
