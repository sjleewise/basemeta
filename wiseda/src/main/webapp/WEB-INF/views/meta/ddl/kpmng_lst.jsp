...
function initGrid()
{
    ...
    with(grid_sheet){
		...
		var headers = [
						{Text:"<s:message code='META.HEADER.KPMNG.LST'/>", Align:"Center"}
						/* No.|상태|선택|등록유형|주제영역|주테이블ID|테이블|테이블논리명|분리보관 주제영역|분리보관 대상 테이블 ID|분리보관 테이블명|분리보관 테이블논리명|스키마명|오브젝트ID|설명 */
					];
			...
			var cols = [
						...
						{Type:"Text",   Width:100,   SaveName:"mstDdlTblId",	 	Align:"Left", Edit:0, Hidden:1},
						{Type:"Text",   Width:100,   SaveName:"mstDdlTblPnm",	 	Align:"Left", Edit:0, Hidden:0},
						...
						{Type:"Text",   Width:100,   SaveName:"histDdlTblId",	 	Align:"Left", Edit:0, Hidden:1},
						{Type:"Text",   Width:100,   SaveName:"histDdlTblPnm",	 	Align:"Left", Edit:0, Hidden:0},
...
// 			var popup = OpenWindow(url+param,"pdmtbl_ddlrqst","800","600","yes");
        ...
        case "Search":
			...
			grid_sheet.DoSearch("<c:url value="/meta/ddl/getKpMngList.do" />", param);
        ...
        case "SaveRow" :
			...
			var url = "<c:url value="/meta/ddl/regKpMngList.do"/>";
        ...
        case "Delete" : 	
        	...
        	var url = "<c:url value="/meta/ddl/delKpMngList.do"/>";
        	var param = "";
...
function loadDetail(param) {
		$('div#detailInfo1').load('<c:url value="/meta/ddl/ajaxgrid/kpmng_dtl.do"/>', param, function(){
        ...
        <form id="frmSearch" name="frmSearch" method="post">
            ...
            <div class="tb_basic2">
                <table width="100%" border="0" cellspacing="0" cellpadding="0" summary="<s:message code='STRD.TERMS.INQ' />"> <!-- 표준용어조회 -->
                   ...
                   <tbody>                            
						<tr>
							<th scope="row"><label for="mstDdlTblLnm"><s:message code="TBL.NM" /></div> <!-- 테이블명 -->
							<td><input type="text" id="mstDdlTblLnm" name="mstDdlTblLnm" class="wd200" /></td>		
							<th scope="row"><label for="histDdlTblLnm"><s:message code="SPRT.STGE.TRGT.TBL.NM" /></label></th><!-- 분리보관대상 테이블명 -->
