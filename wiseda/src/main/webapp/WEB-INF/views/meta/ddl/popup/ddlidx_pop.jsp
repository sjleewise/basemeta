...
<html>
<head>
<title><s:message code="DDL.IDEX.INQ" /></title> <!-- DDL 인덱스 검색 -->
...
function initGrid()
{
    ...
    with(grid_sheet){
        ...
        // headText = "No.|상태|선택|주제영역ID|주제영역|테이블ID|DDL인덱스(물리명)|DDL인덱스(논리명)|DDL테이블ID|DDL테이블(물리명)|DDL테이블(논리명)|요청자명|객체설명";
        // headText = "Num|State|Choice|SubjectAreaID|Subject area|IndexID|DDL Index name|DDL Index(logical) name|TableID|DDL Table name|DDL table (logical name)|Requester name|Object Description";
                        
        var headText = "<s:message code='META.HEADER.DDLIDX.POP'/>";
        ...
        var cols = [                        
                    ...
                    {Type:"Text",     Width:80,  SaveName:"ddlIdxId",   	 Align:"Left",   Edit:0},
                    {Type:"Text",     Width:120, SaveName:"ddlIdxPnm",     Align:"Left",   Edit:0}, 
                    {Type:"Text",     Width:120, SaveName:"ddlIdxLnm", 	 Align:"Left",   Edit:0},
...
// 	     SetColProperty("regTypCd", 	{ComboCode:"C|U|D", ComboText:"<s:message code='NEW.CHG.DEL' />"});/* 신규|변경|삭제 */
        ...
        SetColHidden("ddlIdxId",1);
        SetColHidden("ddlTblId",1);
        SetColHidden("ddlIdxLnm",1);
      //  SetColHidden("ddlTblLnm",0);
...
function doAction(sAction)
{
    ...
    switch(sAction)
    {
        ...
        case "Apply":
        	...
        	var url = "<c:url value="/meta/ddl/regWam2WaqDdlIdx.do" />";
...
<div class="pop_tit"> <!-- 팝업가로사이즈 여기서 조절하면 됩니다 기본은 100% -->
    ...
    <div class="pop_tit_txt"><s:message code="IDEX.INQ" /></div><!-- 인덱스 검색 -->
        ...
        <form id="frmSearch" name="frmSearch" method="post">
            ...
            <div class="tb_basic">
                <table width="100%" border="0" cellspacing="0" cellpadding="0" summary="<s:message code='SUBJ.TRRT.INQ' />"> <!-- 주제영역조회 -->
                   ...
                   <tbody>  
                        <tr>                               
							<th scope="row" class="th_require"><label for="dbSchPnm"><s:message code="DB.MS.INFO" /></label></th> <!-- DBMS/스키마 -->
                            <td>
                           ...
                           <th scope="row"><label for="ddlTblPnm"><s:message code="DDL.TBL.NM" /></label></th> <!-- 테이블명 -->
                            <td>
                       ...
                       <tr>                                                            
                           <th scope="row"><label for="ddlIdxPnm"><s:message code="DDL.IDEX.NM" /></label></th>  <!-- 인덱스명 -->
                           <td colspan=3>
                                <span class="input_file">
                                <input type="text" name="ddlIdxPnm" id="ddlIdxPnm" value="${search.ddlIdxPnm}"/>
                                </span>
                           </td>                                                        
                       </tr>
