...
<html>
<head>
<title><s:message code="EXCL.UPLOAD.-DDL.ETC" /></title> <!-- DDL인덱스-엑셀업로드 -->
...
function initGrid()
{
    ...
    with(grid_sheet){
        ...
        headtext +=  "<s:message code='META.HEADER.ETC.RQST'/>";
        // No.|상태|선택|검토상태|검토내용|요청구분|등록유형|검증결과|DB명|스키마명|오브젝트구분|기타오브젝트명|기타오브젝트한글명|DDL|DDL수정|스크립트정보|설명|요청일시|요청자ID|요청자명|요청번호|요청일련번호
        ...
        var cols = [                        
                    ...
                    {Type:"Text",     Width:90,   SaveName:"dbConnTrgPnm",	Align:"Center", Edit:0, KeyField:1},
                    {Type:"Text",     Width:90,   SaveName:"dbSchPnm",	    Align:"Center", Edit:0, KeyField:1},
                    {Type:"Combo",    Width:90,   SaveName:"etcObjDcd",	    Align:"Center", Edit:0, KeyField:1},
                    ...
                    {Type:"CheckBox", Width:70, SaveName:"ddlCheck", 	 Align:"Center",   Edit:1, Hidden:1},
                    {Type:"Html",     Width:70,   SaveName:"ddlUpdBtn", 	    Align:"Center",   Edit:0, Hidden:1},                                        
                    {Type:"Text",     Width:300,  SaveName:"scrtInfo",      Align:"Left",   Edit:0, Hidden:0,KeyField:1},
...
//  	 	   	if(SaveJson.data.length == 0) return;
 	   ...
 	   case "Down2Excel":  //엑셀내려받기
            ...
            var downColNms = "";
     	 	...
     	 	grid_sheet.Down2Excel(    { HiddenColumn:1,DownCols:downColNms, Merge:1, FileName:'기타오브젝트 등록요청' }    );
            break;
...
<div class="pop_tit" >
    ...
    <div class="pop_tit_txt"><s:message code="EXCL.UPLOAD.-DDL.ETC" /></div><!-- 엑셀업로드-DDL인덱스 -->
...
<div id="search_div">
       ...
       <div class="tb_comment"><s:message  code='ETC.EXCEL' />
