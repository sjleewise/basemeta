...
function initGrid()
{
    ...
    with(grid_sheet){
		...
		var headtext  = "<s:message code='META.HEADER.DDLETC.POP'/>";
		//No.|상태|선택|기타오브젝트ID|기타오브젝트구분|기타오브젝트물리명|기타오브젝트논리명
		...
		var cols = [						
					...
					{Type:"Text",   Width:100,  SaveName:"ddlEtcId",   Align:"Left", Edit:0, Hidden:1 },
					{Type:"Combo",  Width:200,  SaveName:"etcObjDcd",  Align:"Left", Edit:0},
...
// 			alert(saveJson.Code); 처리대상 행이 없는 경우 리턴한다.
        	...
        	param += "&rqstDcd=CU"; 
        	var url = "<c:url value="/meta/ddletc/regWam2WaqDdlEtc.do" />";
...
<div class="pop_tit"> <!-- 팝업가로사이즈 여기서 조절하면 됩니다 기본은 100% -->
    ...
    <div class="pop_tit_txt">기타오브젝트검색</div> <!-- 기타오브젝트검색 -->
        ...
        <form id="frmSearch" name="frmSearch" method="post">
            ...
            <div class="tb_basic">
                <table width="100%" border="0" cellspacing="0" cellpadding="0" summary="<s:message code='STRD.TERMS.INQ' />"> <!-- 표준용어조회 -->
                   ...
                   <tbody>                            
						<tr>
							<th scope="row"><label for="sditmLnm">DB스키마</label></th> <!-- DB스키마 -->
							<td>
							...
							<th scope="row"><label for="etcObjDcd">오브벡트구분</label></th> <!-- 오브벡트구분 -->
							<td>
