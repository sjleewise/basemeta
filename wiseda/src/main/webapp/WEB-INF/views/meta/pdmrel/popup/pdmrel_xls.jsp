...
function initGrid()
{
    ...
    with(grid_sheet){
        ...
        var headtext  = "<s:message code='META.HEADER.ASIS.PDM.REL.XLS'/>";
		//No.|상태|선택|요청구분|관계물리명|관계논리명|관계유형코드|카디널리티유형코드|Parent Optionality유형코드|부모테이블주제영역명|부모테이블명|부모테이블컬럼명|자식테이블주제영역명|자식테이블명|자식테이블컬럼명|설명|요청일시|요청자ID|요청자명|요청번호|요청일련번호|요청상세일련번호|이전관계명|이전부모테이블명|이전부모테이블컬럼명|이전자식테이블명|이전자식테이블컬럼명
        ...
        var cols = [                        
                    ...
                    {Type:"Text",    Width:100, SaveName:"paColPnm"    , Align:"Left",   Edit:0, Hidden:0, KeyField:1},                    
                    {Type:"Text",    Width:100, SaveName:"chFullPath"  , Align:"Left",   Edit:0, Hidden:0, KeyField:1},                    
                    {Type:"Text",    Width:100, SaveName:"chTblPnm"    , Align:"Left",   Edit:0, Hidden:0, KeyField:1},                    
                    {Type:"Text",    Width:100, SaveName:"chColPnm"    , Align:"Left",   Edit:0, Hidden:0, KeyField:1},
    ...
    {		    
        ...
        case "Search":
 	 	...
 	 	case "Save" : //엑셀 일괄 저장
 	 	    ...
 	 	    var url = "<c:url value="/meta/pdmrel/regPdmRelMstXlsRqstList.do"/>";
...
<div class="pop_tit" >
    ...
    <div class="pop_tit_txt"><s:message code="PHYC.MDEL.RLT.EXCL.UPLOAD" /></div> <!-- 엑셀업로드-물리모델관계 -->
