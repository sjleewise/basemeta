...
<html>
<head>
<title><s:message code="RLT.INQ" /></title> <!-- 관계조회 -->
...
function initGrid()
{
    ...
    with(grid_sheet){
        ...
        headtext = "<s:message code='META.HEADER.ASIS.PDM.REL.POP'/>";
        //No.|상태|선택|관계ID|부모테이블주제영역ID|부모테이블주제영역|부모테이블ID|부모테이블물리명|관계명|자식테이블주제영역ID|자식테이블주제영역|자식테이블ID|자식테이블물리명
        ...
        var cols = [                        
                    ...
                    {Type:"Text",   Width:150, SaveName:"paFullPath"  , Align:"Left",   Edit:0},
                    {Type:"Text",   Width:80,  SaveName:"paTblId"     , Align:"Left",   Edit:0, Hidden:1},
                    {Type:"Text",   Width:150, SaveName:"paTblPnm"    , Align:"Left",   Edit:0},                    
                    {Type:"Text",   Width:100, SaveName:"pdmRelPnm"	  , Align:"Center", Edit:0},
                    {Type:"Text",   Width:100, SaveName:"chSubjId"	  , Align:"Left",   Edit:0, Hidden:1},
                    {Type:"Text",   Width:150, SaveName:"chFullPath"  , Align:"Left",   Edit:0},
                    {Type:"Text",   Width:80,  SaveName:"chTblId"     , Align:"Left",   Edit:0, Hidden:1},
                    {Type:"Text",   Width:150, SaveName:"chTblPnm"    , Align:"Left",   Edit:0},
                ];
...
function doAction(sAction)
{
    ...
    switch(sAction)
    {
        ...
        case "Search":
        	...
        	grid_sheet.DoSearch("<c:url value="/meta/pdmrel/getWamPdmRelList.do" />", param);
...
// 			alert(saveJson.Code); 처리대상 행이 없는 경우 리턴한다.
        	...
        	param += "&rqstDcd=CU";
        	var url = "<c:url value="/meta/pdmrel/regWam2WaqPdmRel.do" />";
...
function returnSubjPop (ret) {  
	...
	//$("#frmSearch #paFullPath").val(retjson.paFullPath);
	$("#frmSearch #paFullPath").val(fullPath);
...
<div class="pop_tit"> <!-- 팝업가로사이즈 여기서 조절하면 됩니다 기본은 100% -->
    ...
    <div class="pop_tit_txt"><s:message code="RLT.INQ" /></div> <!-- 관계조회 -->
        ...
        <form id="frmSearch" name="frmSearch" method="post">
            ...
            <div class="tb_basic2">
                <table width="100%" border="0" cellspacing="0" cellpadding="0" summary="<s:message code='SUBJ.TRRT.INQ' />"> <!-- 주제영역조회 -->
                   ...
                   <tbody>   
                       <tr>                               
                           <th scope="row" class="th_require"><label for="paFullPath"><s:message code="SUBJ.TRRT.NM" /></label></th>  <!-- 주제영역명 -->                       
						   <td>
                                <span class="input_file"> 
                                	<input type="text" name="paFullPath" id="paFullPath" style="width:75%;" />
