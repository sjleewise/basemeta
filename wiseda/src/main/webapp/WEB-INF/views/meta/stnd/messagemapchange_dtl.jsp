...
//     	var cfg = {SearchMode:2,Page:100};
        ...
        SetMergeSheet(1);
        var headers = [
                    {Text:"<s:message code='META.HEADER.MESSAGE.MAP.CHG.DTL'/>", Align:"Center"}
                ];
        //No.|대외기관매핑ID|만료일자|시작일자|오류코드|전산메세지오류원인내용|고객메세지오류원인내용|기관사용불가여부|대표오류코드여부|도메인명|도메인물리명|유효값(코드값)|유효값(코드값)명|요청번호|요청일련번호|설명|버전|등록유형|최초요청일시|최초요청사용자ID|요청일시|요청사용자ID|승인일시|승인사용자ID|비고
        ...
        var cols = [                        
					...
					{Type:"Text",   Width:100,  SaveName:"msgMapId",  Align:"Left", Edit:0},
