...
var dmnginfotpJson = ${codeMap.codedmnginfotp} ; //코드성도메인그룹만
...
// 		var param = $("form#frmInput").serialize();
		var param = "";
		    ...
		    param += "&dmnLnm="+$("#dmnLnm").val();
		openLayerPop ("<c:url value='/meta/stnd/popup/dmndivsion_pop.do' />", 800, 600, param);
...
// 				$("#dmnStwdPop").show();
	...
	$("#dmnPop").click(function(){
    	var param = ""; //$("form#frmInput").serialize();
    	openLayerPop("<c:url value='/meta/stnd/popup/stnddmn_pop.do' />", 800, 600, param);
    });
...
$(window).on('load',function() {
	$("#dmngId option:eq(1)").prop("selected", "selected");	
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0" summary="<s:message code='DMN.INFO' />"> <!-- 도메인정보 -->
			...
			<tbody>
				<tr>
					...
					<th scope="row" class="th_require"><label for="dmnLnm"><s:message code="LGC.NM" /></label></th> <!-- 영문판용(한글버젼시 위 주석 사용) -->
					<td>
					...
					<%-- <th scope="row" class="th_require"><label for="dmnPnm"><s:message code="DMN.PHYC.NM" /></label></th> --%> <!-- 도메인물리명 -->
					<th scope="row" class="th_require"><label for="dmnPnm"><s:message code="PHYC.NM" /></label></th><!-- 영문판용(한글버젼시 위 주석 사용) -->
					<td >
						<div>
							<input type="text" id="dmnPnm" name="dmnPnm" value="${result.dmnPnm}" class="wd200" />
...
<!-- 						<input type="text" id="dmnDscd" name="dmnDscd" class="wd200"/> -->
				...
				<tr>
					...
					<td>
						...
						<span class="input_inactive"><input type="text" class="wd80" id="lstEntyLnm" name="lstEntyLnm" value="${result.lstEntyLnm}" /></span>
						<span class="input_inactive"><input type="text" class="wd80" id="lstEntyPnm" name="lstEntyPnm" value="${result.lstEntyPnm}" /></span>
						<button class="btnDelPop" id="lstEntyClr"><s:message code="DEL" /></button> <!-- 삭제 -->
						<button class="btnSearchPop" id="lstEntyPop"><s:message code="SRCH" /></button> <!-- 검색 -->
					</td>
					...
					<td>
						...
						<span class="input_inactive"><input type="text" class="wd80" id="lstAttrLnm" name="lstAttrLnm" value="${result.lstAttrLnm}" /></span>
						<span class="input_inactive"><input type="text" class="wd80" id="lstAttrPnm" name="lstAttrPnm" value="${result.lstAttrPnm}" /></span>
				...
				<tr>
					<th scope="row"><label for="dataFrm"><s:message code="DATA.FRMT" /></label></th> <!-- 데이터형식 -->
					<td>
				...
				<!-- 	<th scope="row"><label for="dmnOrgDs">출처구분</label></th>
					<td >
						<input type="text" id="dmnOrgDs" name="dmnOrgDs" class="wd200"/>
					</td> -->
