...
function initGrid()
{
    ...
    with(grid_sheet){
		...
		if ("${govYn}" == "Y") {
        	headtext += "<s:message code='META.HEADER.STNDITEM.XLS.4'/>"; //범정부 중앙메타 연계항목
        }
		
		//No.|상태|삭제|요청구분|등록유형|
		//표준분류|표준용어논리명|표준용어물리명|논리명기준구분|물리명기준구분|도메인논리명|도메인물리명|도메인그룹논리명|인포타입논리명|데이터타입|길이|소수점|암호화여부|중복여부|고객정보변환여부|개인정보여부|
		//설명
		//|공개/비공개 여부|비공개사유|개인정보여부|제약조건
...
// 				{Type:"Combo",  Width:60,   SaveName:"infotpId",  Align:"Left", Edit:1, Hidden:0},
				...
				{Type:"Combo",  Width:130,  SaveName:"dupYn",	  Align:"Center", Edit:1, Hidden:1},
...
// 				{Type:"Int",   Width:60,  SaveName:"rqstSno",  Align:"Center", Edit:0}
	...
	if ("${govYn}" == "Y") {
		cols.push(
				//범정부연계항목
				{Type:"Combo",  Width:100,  SaveName:"openYn"  , 		Align:"Center",   Edit:1},
				{Type:"Combo",  Width:100,  SaveName:"priRsn"  ,    	Align:"Left",   Edit:1},
				{Type:"Combo",  Width:100,  SaveName:"prsnInfoYn"  ,    Align:"Center",   Edit:1},
				{Type:"Text",   Width:100,  SaveName:"constCnd"  ,		Align:"Left",   Edit:1}
		);
	}
