...
//     	var cfg = {SearchMode:2,Page:100};
        ...
        SetMergeSheet(1);
        var headers = [
                    {Text:"<s:message code='META.HEADER.MESSAGE.CODE.CHG.DTL'/>", Align:"Center"}
                ];
        //No.|조치코드ID|만료일자|시작일자|조치코드|언어구분코드|조치코드사용여부|조치코드삭제여부|조치코드적용일자|조치내용|요청번호|요청일련번호|설명|버전|등록유형|최초요청일시|최초요청사용자ID|요청일시|요청사용자ID|승인일시|승인사용자ID|비고
