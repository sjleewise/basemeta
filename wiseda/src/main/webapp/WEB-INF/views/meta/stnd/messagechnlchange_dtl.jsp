...
//     	var cfg = {SearchMode:2,Page:100};
        ...
        SetMergeSheet(1);
        var headers = [
                    {Text:"<s:message code='META.HEADER.MESSAGE.CHNL.CHG.DTL'/>", Align:"Center"}
                ];
        //No.|채널오류코드ID|만료일자|시작일자|표준오류코드ID|오류코드|채널오류전문언어구분코드|오류유형코드|채널오류메세지내용|채널오류코드|오류코드사용여부|채널유형코드|채널세부코드|오류코드적용일자|조치코드|요청번호|요청일련번호|설명|버전|등록유형|최초요청일시|최초요청사용자ID|요청일시|요청사용자ID|승인일시|승인사용자ID|비고
