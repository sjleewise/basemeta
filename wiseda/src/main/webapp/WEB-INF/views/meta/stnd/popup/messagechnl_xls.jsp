...
function initGrid()
{
    ...
    with(grid_sheet){
        ...
        var headtext  = "<s:message code='META.HEADER.MESSAGE.CHNL.XLS'/>";
        //No.|상태|선택|요청구분|등록유형|오류코드|채널오류전문언어구분코드|오류유형코드|채널오류메세지내용|채널오류코드|오류코드사용여부|채널유형코드|채널세부코드|오류코드적용일자|조치코드
        var headers = [
