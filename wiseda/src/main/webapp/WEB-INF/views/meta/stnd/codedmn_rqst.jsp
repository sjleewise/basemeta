...
function initGrid()
{
	...
	with(grid_sheet){
		...
		var headtext  = "<s:message code='META.HEADER.CODEDMN.RQST.1'/>";
			headtext += "|<s:message code='META.HEADER.CODEDMN.RQST.2'/>";
			headtext += "|<s:message code='META.HEADER.CODEDMN.RQST.3'/>";
			headtext += "|<s:message code='META.HEADER.CODEDMN.RQST.4'/>";
			...
			//headtext += "|용어자동생성여부|모델|상위주제영역|주제영역|주제영역ID|코드값유형|코드값부여방식|데이터형식|목록엔티티논리명|목록엔티티물리명|목록어트리뷰트논리명|목록어트리뷰트물리명|부모도메인";
		...
		var cols = [						
					...
					{Type:"Combo",   Width:100,   SaveName:"encYn",	 	Align:"Left", Edit:0, Hidden:0},
					{Type:"Combo",   Width:100,   SaveName:"sditmAutoCrtYn",	 	Align:"Left", Edit:0, Hidden:1},
					...
					{Type:"Text",   Width:100,   SaveName:"lstEntyLnm",	 	Align:"Left", Edit:0, Hidden:0},
					{Type:"Text",   Width:100,   SaveName:"lstEntyPnm",	 	Align:"Left", Edit:0, Hidden:0},
					{Type:"Text",   Width:100,   SaveName:"lstAttrLnm",	 	Align:"Left", Edit:0, Hidden:0},
					{Type:"Text",   Width:100,   SaveName:"lstAttrPnm",	 	Align:"Left", Edit:0, Hidden:0},
					{Type:"Text",   Width:100,   SaveName:"uppDmnLnm",	 	Align:"Left", Edit:0, Hidden:0},
					<!--{Type:"Text",   Width:100,   SaveName:"dmnOrgDs",	 	Align:"Left", Edit:0, Hidden:0},-->
...
//	    		$("form#frmSearch input[name=rqstSno]").val(res.ETC.rqstSno);
		...
		case "<%=WiseMetaConfig.RqstAction.APPROVE%>":
			var url = '<c:url value="/meta/stnd/codedmn_rqst.do" />';
			var param = $('form[name=mstFrm]').serialize();
...
<!-- 		<div id="detailInfo"></div> -->
		<%@include file="codedmn_rqst_dtl.jsp" %>
	</div>
	<!-- 유효값 목록 탭 -->
	<div id="tabs-2">
