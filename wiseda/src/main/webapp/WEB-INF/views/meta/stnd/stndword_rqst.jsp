...
function initGrid()
{
	...
	with(grid_sheet){
		...
		var cols = [						
					...
					{Type:"Text",   Width:100,  SaveName:"stwdLnm",   	Align:"Left", Edit:0, KeyField:1},
					{Type:"Text",   Width:100,  SaveName:"stwdPnm",   	Align:"Left", Edit:0, KeyField:1}, 
					{Type:"Text",   Width:100,   SaveName:"engMean", 	Align:"Left", Edit:0, Hidden:0},
					{Type:"Text",   Width:60,   SaveName:"cchNm",	 	Align:"Left", Edit:0, Hidden:0},
