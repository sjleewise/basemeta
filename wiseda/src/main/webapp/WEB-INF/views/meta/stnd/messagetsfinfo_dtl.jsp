      		       ...
      		       <tr>
						...
						<td colspan = "3">
                            ...
                            <tr>
                                ...
                                <td>
                                <select id="regTypCd" class="wd100" name="regTypCd" value = "${result.regTypCd}" disabled="disabled">
                                 ...
                                 <td>
                                <select id="useYn" class="wd100" name="useYn" value="${result.useYn}" disabled="disabled">
                                		<option value=""></option>
                            ...
                            <tr>
						          ...
						          <td>
						          	...
						          	<select  class="wd100"  id="typDivCd" name="typDivCd" disabled="disabled">
						          	  <option value=""></option>
						          ...
						          <td>
						          	<select  class="wd100"  id="bizDivCd" name="bizDivCd" disabled="disabled">
						          	  <option value=""></option>
