...
//     	var cfg = {SearchMode:2,Page:100};
        ...
        var headers = [
                    {Text:"No.|표준분류|논리명|물리명|영문의미|한자명|출처구분|설명", Align:"Center"}
                ];
...
//                     {Type:"Combo",   Width:100,  SaveName:"objType",    Align:"Center", Edit:0, Hidden:0},
                    ...
                    {Type:"Text",   Width:140,  SaveName:"cchNm",    Align:"Left", Edit:0},
                    {Type:"Text",   Width:140,  SaveName:"orgDs",    Align:"Left", Edit:0},
