...
function initGrid()
{
    ...
    with(grid_sheet){
        ...
        var headers = [
                    {Text:"<s:message code='META.HEADER.JEJECTMY.LST'/>", Align:"Center"}
                ];
                //No.|상태|선택|요청번호|요청구분|요청명|요청일자|승인일자|요청자|진행상태|결재결과|승인진행레벨
        ...
        var cols = [                        
                    ...
                    {Type:"Text",   Width:130,  SaveName:"rqstNo",    Align:"Left", Edit:0, Hidden:0},
                    {Type:"Combo",   Width:150,  SaveName:"bizDcd",    Align:"Center", Edit:0, Hidden:0}, 
                    {Type:"Text",   Width:500,  SaveName:"rqstNm",    Align:"Left", Edit:0, Hidden:0}, 
                    {Type:"Date",   Width:150,  SaveName:"rqstDtm",    Align:"Center", Edit:0, Hidden:0, Format:"yyyy-MM-dd HH:mm:ss"}, 
                    {Type:"Date",   Width:150,  SaveName:"aprvDtm",    Align:"Center", Edit:0, Hidden:1, Format:"yyyy-MM-dd HH:mm:ss"}, 
                    {Type:"Text",   Width:100,  SaveName:"rqstUserNm",    Align:"Left", Edit:0, Hidden:0}, 
                    {Type:"Combo",   Width:100,  SaveName:"rqstStepCd",    Align:"Center", Edit:0, Hidden:0},
                    {Type:"Text",   Width:100,  SaveName:"aprvStatus",    Align:"Center", Edit:0},
                    {Type:"Text",   Width:50,  SaveName:"aprvStepLvl",    Align:"Left", Edit:0}
...
function doAction(sAction)
{
    ...
    switch(sAction)
    {
        case "Search":
			...
			grid_sheet.DoSearch("<c:url value="/meta/stnd/selectRejMyList.do" />", param);
        	break;

        case "Down2Excel":  //엑셀내려받기
        
          
            grid_sheet.Down2Excel({HiddenColumn:1, Merge:1, FileName:'내요청반려건조회'});
...
function grid_sheet_OnDblClick(row, col, value, cellx, celly) {
	...
	window.location.href = "../../meta/stnd/regRejectedReq.do?rqstNo="+rqstNo + "&bizDcd=" + bizDcd;	
...
<div class="menu_subject">
	<div class="tab">
	    <div class="menu_title"><s:message code="MSG.MY.REG.DEMD.RTN.EROR.INQ.INQ" /></div> <!-- 내 등록요청 반려/오류조회 조회 -->
	</div>
</div>
<!-- 메뉴 메인 제목 -->
                   ...
                   <tbody>                            
                            ...
                            <tr style = "display:none;">
                                ...
                                <td colspan="3"><select id="rqstStepCd" class="wd300" name="rqstStepCd">
					                    <option value="A" selected><s:message code="APRL.TRTT" /></option> <!-- 결재처리 -->
                                    </select></td>
                            </tr>
                            <tr>
...
<div style="clear:both; height:5px;"><span></span></div>
	...
	<div class="selected_title_area">
		    <div class="selected_title" id="rqst_sel_title"> <span></span></div>
	</div>
