...
$(document).ready(function() {
    ...
    $("#btnSave").click(function(){
		icons: { primary: "ui-icon-lightbulb" }
    		...
    		//저장할래요? 확인창...
    		var message = "표준도메인 자동분할을 실행하시겠습니까?";
    		showMsgBox("CNF", message, 'AutoDivision');	
	}).show().find(".ui-button-text").text("자동분할");
    ...
    $("#btn_rqst").click(function(){
    	...
    	//저장할래요? 확인창...
		var message = "표준도메인 요청서를 작성 시 요청가능한 데이터만 요청됩니다.<br>표준도메인 요청서를 작성하시겠습니까?";
...
function initGrid()
{
    ...
    with(grid_sheet){
		...
		headtext += "|DV_RQST_NO|분할결과|도메인논리명|도메인물리명|논리명기준구분|물리명기준구분|도메인그룹논리명|DMNG_ID|인포타입논리명|INFOTP_ID|데이터타입|길이|소수점|설명";
		headtext += "|요청가능여부";
	var headers = [
...
// 				{Type:"Text",   Width:150,  SaveName:"dicAsmLnm",	Align:"Left", Edit:1, KeyField:1},
				...
				{Type:"Text",   Width:100,   SaveName:"dmngLnm",	 	Align:"Left", Edit:1, Hidden:0, KeyField:1},
				{Type:"Text",   Width:100,   SaveName:"dmngId",	 	Align:"Left", Edit:1, Hidden:1},
				{Type:"Text",   Width:100,   SaveName:"infotpLnm",	 	Align:"Left", Edit:1, Hidden:0, KeyField:1},
				...
				{Type:"Text",   Width:60,   SaveName:"dataLen",	 	Align:"Right", Edit:0, Hidden:0},
				{Type:"Text",   Width:60,   SaveName:"dataScal",	 	Align:"Right", Edit:0, Hidden:0},
...
function grid_sheet_OnChange(Row, Col, Value) {
       //if(Col = "dmngLnm"){
    	   //var tempdmngLnm = grid_sheet.GetCellText(Row, Col);
//
    	   //grid_sheet.SetFilterValue('dmngLnm',tempdmngLnm, 11);
...
<div class="menu_subject">
	<div class="tab">
	    <div class="menu_title">사전통합 조회</div>
	</div>
</div>
<!-- 메뉴 메인 제목 -->
...
<div id="search_div">
        ...
        <form id="frmSearch" name="frmSearch" method="post">
            ...
            <div class="tb_basic2">
                <table width="100%" border="0" cellspacing="0" cellpadding="0" summary="<s:message code='STRD.WORD.INQ' />"> <!-- 표준단어조회 -->
                   ...
                   <tbody>                            
                            <tr>
                                <th scope="row"><label for="dvRqstNo">조회목록</label></th>
								<td>
									<span id="selectDvRqstNo"><select id="dvRqstNo"  name="dvRqstNo" class="wd400">
									<option value=""><s:message code="CHC" /></option> <!-- 선택 -->
									</select></span>
								</td>
                                <th scope="row"><label for="dvRqstDiv">분할구분</label></th>
								<td>
									<select id="dvRqstDiv"  name="dvRqstDiv" >
									<option value=""><s:message code="WHL" /></option> <!-- 전체 -->
									<option value="ASC">최소길이</option>
									<option value="DESC">최대길이</option>
									</select>
								</td>								
                            </tr>
                   </tbody>
        ...
        <div class="tb_comment">- 존재하는 영문약어는 빨간색으로 표시됩니다. 데이터를 복사하시려면 복사할 컬럼을 선택하시고 <span style="font-weight:bold; color:#444444;">Ctrl + C</span><s:message code="MSG.CHC.USE" /></div>
        <!--  -->
        <!-- 를 사용하시면 됩니다. -->
        </form>
