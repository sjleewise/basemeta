...
//     	var cfg = {SearchMode:2,Page:100};
        ...
        SetMergeSheet(1);
        var headers = [
                    {Text:"<s:message code='META.HEADER.MESSAGECHANGE.DTL'/>", Align:"Center"}
                ];
                //No.|메시지ID|만료일자|시작일자|유형구분코드|업무구분코드|메시지코드|메시지내용|사용여부|요청번호|요청일련번호|설명|버전|등록유형|최초요청일시|최초요청사용자ID|요청일시|요청사용자ID|승인일시|승인사용자ID|비고
