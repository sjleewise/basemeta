...
// 		$("#frmInput #dupYn").val('${result.dupYn}');
		$("#frmInput #dmnDscd").val('${result.dmnDscd}');
		$("#frmInput #cdId").val('${result.cdId}');
// 		if('${result.dupYn}' == ""){
...
<!--                             </tr> -->
                            ...
                            <tr>
                                ...
                                <th scope="row"><label for="dataFrm"><s:message code="DATA.FRMT.CD.ID" /></label></th> <!-- 데이터형식 -->
				     	        <td >
                            ...
                            <tr>
					            ...
					            <th scope="row"><label for="uppDmnLnm"><s:message code="PRNT.DMN.NM" /></label></th> <!-- 부모도메인명 -->
				     	        <td >
									<input type="text" id="uppDmnLnm" name="uppDmnLnm" class="wd200" value="${result.uppDmnLnm }"/>
					            </td>
