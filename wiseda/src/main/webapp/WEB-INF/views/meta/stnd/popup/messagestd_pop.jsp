...
function initGrid()
{
    ...
    with(grid_pop){
        ...
        var headtext = "<s:message code='META.HEADER.MESSAGE.STD.POP'/>";			
        //No.|상태|선택|표준오류코드ID|AS-IS오류코드|오류전문언어구분코드|오류유형코드|메시지유형|메시지구분|업무구분|표준오류코드여부|오류코드|전산메세지오류원인내용|고객메세지오류원인내용|오류코드적용일자|조치코드|담당파트|담당자명
        var headers = [
