...
// 			alert("비표준용어논리명과 도메인논리명이 틀릴경우 논리명기준구분과 물리명기준구분을 작성해야 합니다.");
...
// 			$("#dmnLnm").val("");
		    ...
		    for(var i = 0; i < firstSelectBoxId.length; i++){
			    ...
			    $("#frmInput #"+ firstSelectBoxId[i]).val( data.dmngId ); 
...
<%-- 	  <input type="hidden" id="ibsStatus" name="ibsStatus" value="${saction }" > --%>
	...
	<!-- 요청서 공통 부분 (검토결과, 요청구분, 검증결과) -->
		...
		<div style="clear:both; height:10px;"><span></span></div>
			<div class="stit">비표준용어정보</div>
 		<div style="clear:both; height:5px;"><span></span></div>
		<legend>비표준용어정보</legend>
		<div class="tb_basic">
			<table width="100%" border="0" cellspacing="0" cellpadding="0" summary="비표준용어정보">
				<caption>비표준용어 정보입력	</caption>
				<colgroup>
				<col style="width:15%;" />
				<col style="width:35%;" />
				<col style="width:15%;" />
				...
				<tbody>
					<tr>
						<th scope="row" class="th_require"><label for="sditmLnm">비표준용어논리명</label></th>
						<td>
							<input type="text" id="sditmLnm" name="sditmLnm" class="wd200" value="${result.sditmLnm}"  />
                              	<button class="btnDelPop" type="button" id="btnSditmClr"	name="btnSditmClr">지우기</button>
                              	<button class="btnSearchPop" type="button" id="btnSditmGen"	name="btnSditmGen">자동분할</button>
                              	<button class="btnSearchPop" type="button" id="btnSditmDiv"	name="btnSditmDiv">분리</button>
						</td>
						<th scope="row" class="th_require"><label for="sditmPnm">비표준용어물리명</label></th>
						<td ><input type="text" id="sditmPnm" name="sditmPnm" value="${result.sditmPnm}" class="wd200" />
								<button class="btnSearchPop" id="sditmStwdPop">검색</button></td>
					</tr>
					<tr>
						<th scope="row" ><label for="lnmCriDs">논리명기준구분</label></th> 
						<td><input type="text" id="lnmCriDs" name="lnmCriDs" class="wd200" value="${result.lnmCriDs}"  readonly/></td>
						<th scope="row" ><label for="pnmCriDs">물리명기준구분</label></th> 
...
<!--  								<button class="btnDelPop" type="button" id="btnDmnClr"	name="btnDmnClr">지우기</button> -->
								<button class="btnSearchPop" type="button" id="btnDmnSch"	name="btnDmnSch">검색</button>
							</td>
						<th scope="row" class=""><label for="stndInfo">기준정보</label></th>
						<td >
								<input type="text" id="stndInfo" name="dmnLnm" class="wd200" value="${result.stndInfo}"  />
							</td>
					</tr>
					<tr>
...
-->					
					<tr>
						<th scope="row" class="th_require"><label for="objDescn">설명</label></th>
