...
function initGrid()
{
    ...
    with(grid_sheet){
        ...
        var headtext = "<s:message code='META.HEADER.STNDDMN.CD.VAL'/>";
        //No.|상태|선택|도메인ID|도메인명|도메인물리명|유효값(코드값)ID|유효값(코드값)|유효값(코드값)명
		var headers = [
...
function doAction(sAction)
{
    ...
    switch(sAction)
    {
        case "Search":
			...
			grid_sheet.DoSearch("<c:url value="/meta/stnd/ajaxgrid/dmncdval_dtl.do" />", param);
