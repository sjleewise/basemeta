...
function initGrid()
{
    ...
    with(grid_sheet){
        ...
        var cols = [                        
                    ...
                    {Type:"Combo",   Width:40,  SaveName:"stndAsrt",    Align:"Center", Edit:0, KeyField:1},
                    {Type:"Text",   Width:40,  SaveName:"symnLnm",    Align:"Left", Edit:0, Hidden:0 ,KeyField:1}, 
                    {Type:"Text",   Width:40,  SaveName:"symnPnm",    Align:"Left", Edit:0, Hidden:0 ,KeyField:1}, 
                    {Type:"Combo",   Width:40,  SaveName:"symnDcd",    Align:"Center", Edit:0, Hidden:0 ,KeyField:1}, 
                    {Type:"Text",   Width:40,  SaveName:"stwdId",    Align:"Left", Edit:0, Hidden:1}, 
                    {Type:"Text",   Width:40,  SaveName:"sbswdLnm",    Align:"Left", Edit:0, Hidden:0 ,KeyField:1}, 
                    {Type:"Text",   Width:40,  SaveName:"sbswdPnm",    Align:"Left", Edit:0, Hidden:0 ,KeyField:1},
...
function loadDetail(param) {
	$('div#detailInfo').load('<c:url value="/meta/stnd/ajaxgrid/symn_dtl.do"/>', param, function(){
		//$('#tabs').show();
	});
}
