...
function initGrid()
{
    ...
    with(grid_sheet){
        ...
        var headtext  = "<s:message code='META.HEADER.MESSAGE.MAP.XLS'/>";
        
        //No.|상태|선택|요청구분|등록유형|오류코드|전산메세지오류원인내용|고객메세지오류원인내용|기관사용불가여부|대표오류코드여부|도메인명|도메인물리명|유효값(코드값)|유효값(코드값)명
