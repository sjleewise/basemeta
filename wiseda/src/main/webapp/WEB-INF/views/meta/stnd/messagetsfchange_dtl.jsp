...
//     	var cfg = {SearchMode:2,Page:100};
        ...
        SetMergeSheet(1);
        var headers = [
                    {Text:"<s:message code='META.HEADER.MESSAGETSFCHANGE.DTL'/>", Align:"Center"}
                ];
                //No.|메시지ID|만료일자|시작일자|타겟DB_ID|타겟DB명|타겟스키마ID|타겟스키마명|유형구분코드|업무구분코드|메시지코드|메시지내용|사용여부|요청번호|요청일련번호|설명|버전|등록유형|최초요청일시|최초요청사용자ID|요청일시|요청사용자ID|승인일시|승인사용자ID|설명
...
//                  {Type:"CheckBox", Width:60, SaveName:"ibsCheck",    Align:"Center", Edit:1, Hidden:0},
                    {Type:"Text",   Width:120,  SaveName:"msgId",    Align:"Left", Edit:0, Hidden:1},
                    ...
                    {Type:"Combo",   Width:80,  SaveName:"typDivCd",    Align:"Left", Edit:0, Hidden:0}, 
                    {Type:"Combo",   Width:80,  SaveName:"bizDivCd",    Align:"Left", Edit:0, Hidden:0}, 
