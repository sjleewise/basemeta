...
$(document).ready(function(){
	...
	$("#frmColInput").validate({
		...
		messages: {
			...
			ldmAttrLnm	: requiremessage, 
			attrOrd		: requiremessage
		}
	});
...
// 		showMsgBox("CNF", message, 'SaveCol');
    ...
    $("#stndSearchPop").click(function(){
    	...
    	var param = "sditmLnm="+$("#frmColInput #ldmAttrLnm").val(); //$("form#frmInput").serialize();
...
function returnItemPop(ret){
	...
	$("#frmColInput #ldmAttrLnm").val(retjson.sditmLnm);
	...
	<div style="clear:both; height:10px;"><span></span></div>
     ...
     <div class="tb_basic">
         <table width="100%" border="0" cellspacing="0" cellpadding="0" summary="<s:message code='MSG.TBL.SMRY' />"> <!-- 테이블 서머리입니다. -->
             ...
             <tbody>
                 <tr>
                     <th scope="row" class="th_require"><label><s:message code="ATTR.NM" /></label></th> <!-- 어트리뷰트명 -->
                     <td colspan="3">                      	
                     	<span class="ui-icon ui-icon-carat-1-e frm_input_icon"></span>
                     	<input type="text" id="ldmAttrLnm" name="ldmAttrLnm" class="wd200" value="${result.ldmAttrLnm }" />
                 ...
                 <tr>
                     <th scope="row" class="th_require"><label for="attrOrd"><s:message code="CLMN.SQNC" /></label></th> <!-- 컬럼순서 -->
                     <td colspan="3"><input type="text" id="attrOrd" name="attrOrd" class="wd200" value="${result.attrOrd }" /></td>
                 </tr>
                 <tr>
