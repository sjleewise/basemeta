...
function initGrid()
{
    ...
    with(grid_sheet){
        ...
        var headtext  = "<s:message code='META.HEADER.PDMCOL.XLS.5'/>";
        //No.|상태|삭제|요청구분|등록유형|주제영역|엔티티명|어트리뷰트명|어트리뷰트순서|데이터타입|길이|소수점길이|PK 여부|PK 순서|NOT NULL여부|DEFAULT 값|설명|요청일시|요청자ID|요청자명|요청번호|요청일련번호|요청상세일련번호
        ...
        var cols = [                        
                    ...
                    {Type:"Text",     Width:100, SaveName:"ldmEntyLnm"  , Align:"Left",   Edit:1, KeyField:1},					
                    {Type:"Text",     Width:100, SaveName:"ldmAttrLnm"  , Align:"Left",   Edit:1, KeyField:0},                    
                    {Type:"Int",      Width:60,  SaveName:"attrOrd"     , Align:"Left",   Edit:1, KeyField:1},
    ...
    {		    
        ...
        case "Search":
 	 	...
 	 	case "Save" : //엑셀 일괄 저장
 	 	    ...
 	 	    var url = "<c:url value="/meta/ldm/regLdmEntyAttrXlsRqstList.do"/>";
