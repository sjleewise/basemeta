...
$(document).ready(function(){
	...
	$("#frmInput").validate({
		...
		messages: {
			...
			ldmEntyPnm	: requiremessage,
			ldmEntyLnm 	: requiremessage,
       ...
       <div class="tb_basic">
           <table width="100%" border="0" cellspacing="0" cellpadding="0" summary="<s:message code='MSG.TBL.SMRY' />"> <!-- 테이블 서머리입니다. -->
               ...
               <tbody>
                   ...
                   <tr>                       
                       <th scope="row" class="th_require"><label for="ldmEntyLnm"><s:message code="ENTY.NM" /></label></th> <!-- 엔티티명 -->
                       <td><input type="text" id="ldmEntyLnm" name="ldmEntyLnm" class="wd500" value="${result.ldmEntyLnm }"   /></td>
                       
                       <th scope="row" ><s:message code="STRD.APL.YN"/></th> <!-- 적용 여부 -->
                       <td>
                           <input type="checkbox" id="stdAplYn" name="stdAplYn" value="Y" disabled /><span class="input_check"><s:message code="STRD.APL.YN" /></span> <!-- 표준적용여부 -->
                       </td>                       
                   </tr>
