...
function initGrid()
{
    ...
    with(grid_sheet){
        ...
        var headtext = "<s:message code='META.HEADER.LDMENTYSEARCH.POP'/>";

	    //headtext = "No.|상태|선택|주제영역ID|주제영역|엔티티ID|엔티티명|표준적용여부|담당사용자ID|객체설명";    
...
//         	grid_sheet.DoSearchScript("testJsonlist");
        ...
        case "Apply":
        	...
        	param += "&rqstDcd=CU";
        	var url = "<c:url value="/meta/ldm/regWam2WaqLdmEnty.do" />";
...
<div class="pop_tit"> <!-- 팝업가로사이즈 여기서 조절하면 됩니다 기본은 100% -->
    ...
    <div class="pop_tit_txt"><s:message code="ENTY.INQ" /></div> <!-- 엔티티 검색 -->
        ...
        <form id="frmSearch" name="frmSearch" method="post">
            ...
            <div class="tb_basic2">
                <table width="100%" border="0" cellspacing="0" cellpadding="0" summary="<s:message code='SUBJ.TRRT.INQ' />"> <!-- 주제영역조회 -->
                   <caption><s:message code="ENTY.NM" /></caption> <!-- 엔티티명 -->
                   <colgroup>
                   <col style="width:15%;" />
                   <col style="width:50%;" />
                   <col style="width:15%;" />
                   ...
                   <tbody>                            
                       <tr>                               
                           ...
                           <td>
                                <span class="input_file">
                                <input type="text" name="ldmEntyLnm" id="ldmEntyLnm" value="${search.ldmEntyLnm}"/>
                                </span>
                           </td>
                       </tr>
                   </tbody>
