...
//            headtext += "|주제영역|엔티티명|어트리뷰트ID|어트리뷰트명";
//            headtext += "|엔티티ID";
...
//            headtext += "|설명|요청일시|요청자ID|요청자명|요청번호|요청일련번호|요청상세일련번호";
        ...
        var cols = [                        
                    ...
                    {Type:"Text",    Width:150, SaveName:"ldmEntyLnm"  , Align:"Left",   Edit:0, KeyField:1},
					{Type:"Text",    Width:40,  SaveName:"ldmAttrId"   , Align:"Left",   Edit:0, Hidden:1},                    
                    {Type:"Text",    Width:150, SaveName:"ldmAttrLnm"  , Align:"Left",   Edit:0, KeyField:0},                    
                    {Type:"Text",    Width:40,  SaveName:"ldmEntyId"   , Align:"Left",   Edit:0, Hidden:1},
                    ...
                    {Type:"Int",     Width:80,  SaveName:"attrOrd"     , Align:"Center", Edit:0, KeyField:1},
                    {Type:"Text",    Width:80,  SaveName:"dataType"    , Align:"Left",   Edit:0},
                    {Type:"Text",    Width:80,  SaveName:"dataLen"     , Align:"Center", Edit:0},
                    {Type:"Text",    Width:80,  SaveName:"dataScal"    , Align:"Center", Edit:0},
                    {Type:"Combo",   Width:80,  SaveName:"pkYn"        , Align:"Left",   Edit:0},
                    {Type:"Int",     Width:80,  SaveName:"pkOrd"       , Align:"Left",   Edit:0},
...
//         	ibsSaveJson = col_sheet.GetSaveJson(1);	//DoAllSave와 동일...
            ...
            var url = "<c:url value="/meta/ldm/regpdmcolrqstlist.do"/>";
...
//         	var param = $('#colfrmSearch').serialize();
        	...
        	col_sheet.DoSearch("<c:url value="/meta/ldm/getLdmAttrRqstList.do" />", param);
//         	col_sheet.DoSearchScript("testJsonlist");
        ...
        case "SearchRow": //단일 조회...
        	...
        	col_sheet.DoRowSearch(crow, "<c:url value="/meta/ldm/getpdmcolrqstinfo.do" />",  param ,0);
        break;
        ...
        case "LoadExcel":  //엑셀업로드
			var url = "<c:url value="/meta/ldm/popup/pdmcol_xls.do" />";
...
function loadDetailCol(param) {
	...
	$('div#detailInfocol').load('<c:url value="/meta/ldm/ajaxgrid/ldmattr_rqst_dtl.do"/>', param, function( response, status, xhr ) {
		  if ( status == "error" ) {
...
function col_sheet_OnDblClick(row, col, value, cellx, celly) {
	...
	param1 += "&rqstSno=" + param.rqstSno + "&rqstDtlSno=" + param.rqstDtlSno   + "&searchObj=" + param.ldmEntyLnm + "&subInfo=COL";
	$("#tabs #colinfo").click();
...
function col_sheet_OnClick(row, col, value, cellx, celly) {
	...
	var tmphtml = '<s:message code="CLMN.NM" /> : ' + param.pdmColPnm + ' [' + param.ldmAttrLnm +']'; //컬럼명
