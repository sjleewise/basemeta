...
function initGrid()
{
    ...
    with(grid_pop){
        ...
        var headtext = "<s:message code='META.HEADER.APPSTNDWORD.XLS'/>";
//         	headtext += "No.|상태|삭제|요청구분|APP단어ID|APP단어논리명|APP단어물리명|영문의미|한자|출처구분|도메인여부|설명|버전";			
        ...
        var cols = [                        
                    ...
                    {Type:"Text",   Width:40,  SaveName:"appStwdId",    Align:"Center", Edit:0, Hidden:1},
                    {Type:"Text",   Width:80,  SaveName:"appStwdLnm",    Align:"Left", Edit:1, KeyField:1}, 
                    {Type:"Text",   Width:80,  SaveName:"appStwdPnm",    Align:"Left", Edit:1, KeyField:1}, 
                    {Type:"Text",   Width:80,  SaveName:"engMean",    Align:"Left", Edit:1}, 
                    {Type:"Text",   Width:60,  SaveName:"cchNm",    Align:"Left", Edit:1, Hidden:1}, 
                    {Type:"Text",   Width:80,  SaveName:"orgDs",    Align:"Left", Edit:1, Hidden:1}, 
...
//              break;
        ...
        case "Search":
        	...
        	grid_pop.DoSearch('<c:url value="/meta/app/getStndWordlist.do" />', param);
...
// 			alert(saveJson.Code);
        	...
        	var url = "<c:url value="/meta/app/regWam2WaqStndword.do" />";
...
// 	 	   	ibsSaveJson = grid_sheet.GetSaveJson(1); //doAllSave와 동일한 대상을 가져옴...
        ...
        case "Down2Excel":  //엑셀내려받기
        	grid_pop.Down2Excel(    { HiddenColumn:1, Merge:1, FileName:'변수단어등록요청' }    );
            break;
...
// 	if ('ibsSeq' == colsavename || 'ibsStatus' == colsavename || 'ibsCheck' == colsavename) return;
	...
	var tmphtml = 'APP단어명 : ' + param.stwdLnm +' [ 물리명 : ' + param.stwdPnm + ' ]';
...
<div class="pop_tit" >
    ...
    <div class="pop_tit_txt">엑셀업로드-APP단어</div>
        ...
        <form id="frmSearch" name="frmSearch" method="post">
            ...
            <div class="tb_basic"  style="display: none;">
                <table width="100%" border="0" cellspacing="0" cellpadding="0" summary="메뉴조회">
                   ...
                   <tbody>
                   		<tr>                          
                            <th scope="row"><label for="stwdLnm">APP단어명</label></th>
                            <td>
