...
//     		alert("저장할 대상이 없습니다...");
	...
	//항목 자동 분할 기능 추가....
// 	$("#btn_prgm_div").click(function(event){
// 		event.preventDefault();  //브라우저 기본 이벤트 제거...
...
function initGrid()
{
    ...
    with(grid_sheet){
        ...
        var headtext  = "<s:message code='META.HEADER.APPPRGMITEM.XLS'/>";
        //No.|상태|선택|검토상태|요청구분|등록유형|응용프로그램용어ID|응용프로그램용어논리명|응용프로그램용어물리명|응용프로그램용어구분|설명
        ...
        var cols = [                        
                    ...
                    {Type:"Text",     Width:40,  SaveName:"appPrgmId",  Align:"Left", Edit:1, Hidden:1},
                    {Type:"Text",     Width:150, SaveName:"appPrgmLnm", Align:"Left", Edit:1, Hidden:0}, 
                    {Type:"Text",     Width:150, SaveName:"appPrgmPnm", Align:"Left", Edit:1, Hidden:0}, 
                    {Type:"Combo",    Width:150, SaveName:"appPrgmDcd", Align:"Left", Edit:1, Hidden:0},
...
//         	grid_sheet.SetColProperty("appPrgmPnm", {KeyField:0});
...
//  	 	    var url = "<c:url value="/meta/app/regprgmdivision.do"/>";
//         	var param = "";
//         	if ("${search.popType}" == "I") {
...
//         	break;
 	 	...
 	 	case 'Save' : //엑셀 일괄 저장
 	 		grid_sheet.SetColProperty("appPrgmPnm", {KeyField:1 });
...
<div class="pop_tit" >
    ...
    <div class="pop_tit_txt">엑셀업로드-APP용어</div>
        ...
        <form id="frmSearch" name="frmSearch" method="post">
            ...
            <div class="tb_basic"  style="display: none;">
                <table width="100%" border="0" cellspacing="0" cellpadding="0" summary="메뉴조회">
                   ...
                   <tbody>
                   		<tr>                          
                            <th scope="row"><label for="stwdLnm">APP용어</label></th>
                            <td>
...
<!-- 	</div> -->
	<div class="divLstBtn" >	 
		<div class="bt03">
			...
			<button class="da_default_btn" id="btn_prgm_div" name="btn_prgm_div">항목자동분할</button>
		</div>
		<div class="bt02">
