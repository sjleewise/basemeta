...
//     	var cfg = {SearchMode:2,Page:100};
        ...
        var headers = [
                    {Text:"<s:message code='META.HEADER.APPSDITMCHANGE.DTL'/>", Align:"Center"}
                    /* No.|표준항목ID|만료일시|시작일시|표준항목논리명|표준항목물리명|논리명기준구분|도메인ID|도메인그룹|인포타입|인포타입변경여부|암호화여부|요청번호|요청일련번호|등록유형|버전|설명|최초요청일시|최초요청사용자ID|요청일시|요청사용자ID|승인일시|승인사용자ID|비고 */
                ];
        ...
        var cols = [                        
					...
					{Type:"Combo",   Width:100,  SaveName:"dmngId",   	Align:"Left", Edit:0, Hidden:0},
...
function grid_sub_sditmchange_OnSearchEnd(code, message) {
	//alert(grid_sub_sditmchange.GetDataBackColor()+":"+ grid_sub_sditmchange.GetDataAlternateBackColor());
if(code < 0) {
