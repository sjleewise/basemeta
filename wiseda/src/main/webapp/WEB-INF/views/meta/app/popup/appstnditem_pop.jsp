...
//     	//$( "#tabs" ).tabs();
      ...
      //파라미터 : (자동완성 대상 오브젝트, 검색할 단어종류, 최대표시 갯수(default-10개))
    	setautoComplete($("#frmSearch #appSditmLnm"), "API");
    	//파라미터 : (자동완성 대상 오브젝트, 검색할 단어종류, 최대표시 갯수(default-10개))
...
function initGrid()
{
    ...
    with(grid_sheet){
		...
		var headtext  = "<s:message code='META.HEADER.APPSTNDITEM.POP'/>"
		//No.|상태|선택|전문용어ID|전문용어논리명|전문용어물리명|논리명기준구분|데이터타입|길이|소수점|암호화여부|설명
		var headers = [
		...
		var cols = [						
					...
					{Type:"Text",   Width:100,  SaveName:"appSditmLnm",  Align:"Left", Edit:0, KeyField:1},
					{Type:"Text",   Width:100,  SaveName:"appSditmPnm",  Align:"Left", Edit:0, KeyField:1}, 
...
// 			alert(saveJson.Code); 처리대상 행이 없는 경우 리턴한다.
        	...
        	param += "&rqstDcd=CU";
        	var url = "<c:url value="/meta/app/regWam2WaqStndItem.do" />";
...
<div class="pop_tit"> <!-- 팝업가로사이즈 여기서 조절하면 됩니다 기본은 100% -->
    ...
    <div class="pop_tit_txt">전문용어 검색</div>
...
<div id="search_div">
        ...
        <form id="frmSearch" name="frmSearch" method="post">
            ...
            <legend>머리말</legend>
            <div class="tb_basic">
                <table width="100%" border="0" cellspacing="0" cellpadding="0" summary="전문용어조회">
                   <caption>전문용어 검색폼</caption>
                   <colgroup>
                   <col style="width:15%;" />
                   <col style="width:35%;" />
                   <col style="width:15%;" />
                   ...
                   <tbody>                            
						<tr>
							<th scope="row"><label for="appSditmLnm">전문용어명</label></th>
							<td><input type="text" id="appSditmLnm" name="appSditmLnm" value="${search.appSditmLnm }" /></td>
<!-- 							<th scope="row"><label for="dnmLnm">표준도메인</label></th> -->
