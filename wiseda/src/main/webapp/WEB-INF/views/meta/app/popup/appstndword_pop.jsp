...
function initGrid()
{
    ...
    with(grid_pop){
        ...
        var headtext = "<s:message code='META.HEADER.APPSTNDWORD.POP'/>";
//         	headtext += "No.|상태|선택|APP단어ID|APP단어논리명|APP단어물리명|영문의미|한자명|출처구분|APP단어구분|객체설명|객체버전";			
        ...
        var cols = [                        
                    ...
                    {Type:"Text",   Width:40,  SaveName:"appStwdId",    Align:"Center", Edit:0},
                    {Type:"Text",   Width:150,  SaveName:"appStwdLnm",    Align:"Left", Edit:0}, 
                    {Type:"Text",   Width:150,  SaveName:"appStwdPnm",    Align:"Left", Edit:0}, 
                    ...
                    {Type:"Text",   Width:60,  SaveName:"wdDcd",    Align:"Center", Edit:0, Hidden:1},
...
<div class="pop_tit" >
    ...
    <div class="pop_tit_txt">APP단어 검색</div>
        ...
        <form id="frmSearch" name="frmSearch" method="post">
            ...
            <div class="tb_basic2">
                <table width="100%" border="0" cellspacing="0" cellpadding="0" summary="메뉴조회">
                   ...
                   <tbody>
                   		<tr>                          
                            <th scope="row"><label for="appStwdLnm">APP단어명</label></th>
                            <td>
                                <span class="input_file">
                                <input type="text" name="appStwdLnm" id="appStwdLnm" />
                                </span>
                            </td>  
                       </tr>
                   </tbody>
