...
function initGrid()
{
    ...
    with(grid_sheet){
		...
		var headtext  = "<s:message code='META.HEADER.APPSTNDITEM.XLS'/>";
		//No.|상태|삭제|요청구분|등록유형|전문용어논리명|전문용어물리명|논리명기준구분|물리명기준구분|데이터타입|길이|소수점|암호화여부|설명
	var headers = [
	...
	var cols = [						
				...
				{Type:"Text",   Width:100,  SaveName:"appSditmLnm",  Align:"Left", Edit:1, KeyField:1},
				{Type:"Text",   Width:100,  SaveName:"appSditmPnm",  Align:"Left", Edit:1, KeyField:1}, 
				...
				{Type:"Text",   Width:60,   SaveName:"dataType",  Align:"Left", Edit:1, Hidden:0, KeyField:1},
				{Type:"Int",    Width:60,   SaveName:"dataLen",	  Align:"Left", Edit:1, Hidden:0, KeyField:1},
...
//              break;
        ...
        case "AutoDivision":
        	...
        	grid_sheet.SetColProperty("appSditmPnm", {KeyField:0});
...
//  	 	   	if(SaveJson.data.length == 0) return;
 	 	    ...
 	 	    var url = "<c:url value="/meta/app/regitemdivision.do"/>";
        	var param = "";
        	if ("${search.popType}" == "I") {
 	 	...
 	 	case 'Save' : //엑셀 일괄 저장
 	 		grid_sheet.SetColProperty("appSditmPnm", {KeyField:1 });
...
<div class="pop_tit" >
    ...
    <div class="pop_tit_txt">엑셀업로드-전문용어</div>
...
<!-- 	</div> -->
	<div class="divLstBtn" >	 
		<div class="bt03">
			...
			<button class="da_default_btn" id="btn_item_div" name="btn_item_div">항목자동분할</button>
		</div>
		<div class="bt02">
