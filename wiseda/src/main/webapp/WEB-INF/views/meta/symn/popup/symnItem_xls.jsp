...
function initGrid()
{
    ...
    with(grid_pop){
        ...
        var headtext = "<s:message code='META.HEADER.SYMNITEM.XLS'/>";
//         	headtext += "|요청번호|요청일련번호|등록유형코드|최초요청일시|최초요청사용자ID|요청일시|요청사용자ID|승인일시|승인사용자ID";			
        ...
        var cols = [                        
                    ...
                    {Type:"Text",   Width:40,  SaveName:"symnItemId",    Align:"Center", Edit:0},
                    {Type:"Text",   Width:80,  SaveName:"symnItemLnm",    Align:"Left", Edit:1, KeyField:1}, 
                    {Type:"Text",   Width:80,  SaveName:"symnItemPnm",    Align:"Left", Edit:1, KeyField:1}, 
                    {Type:"Text",   Width:80,  SaveName:"sditmLnm",    Align:"Left", Edit:1}, 
                    {Type:"Text",   Width:60,  SaveName:"sditmPnm",    Align:"Left", Edit:1}, 
                    {Type:"Text",   Width:80,  SaveName:"sditmId",    Align:"Left", Edit:1}, 
...
//              break;
        ...
        case "Search":
        	...
        	grid_pop.DoSearch('<c:url value="/meta/symn/getSymnItemList.do" />', param);
        ...
        case "Apply": //적용버튼 액션...
        	...
        	var retval = getibscheckjoin(grid_pop, "symnItemId");
        	alert(retval);
...
// 			alert(saveJson.Code);
        	...
        	var url = "<c:url value="/meta/symn/regWam2WaqSymnItem.do" />";
...
// 	if ('ibsSeq' == colsavename || 'ibsStatus' == colsavename || 'ibsCheck' == colsavename) return;
	...
	var tmphtml = '유사항목명 : ' + param.stwdLnm +' [ 물리명 : ' + param.stwdPnm + ' ]';
...
<div class="pop_tit" >
    ...
    <div class="pop_tit_txt">엑셀업로드-유사항목</div>
        ...
        <form id="frmSearch" name="frmSearch" method="post">
            ...
            <div class="tb_basic"  style="display: none;">
                <table width="100%" border="0" cellspacing="0" cellpadding="0" summary="메뉴조회">
                   ...
                   <tbody>
                   		<tr>                          
                            <th scope="row"><label for="stwdLnm">유사항목논리명</label></th>
                            <td>
