...
function initGrid()
{
    ...
    with(grid_pop){
        ...
        var headtext = "<s:message code='META.HEADER.SYMNITEM.POP'/>";
//         	headtext += "|요청번호|요청일련번호|등록유형코드|최초요청일시|최초요청사용자ID|요청일시|요청사용자ID|승인일시|승인사용자ID";			
        ...
        var cols = [                        
                    ...
                    {Type:"Text",   Width:150,  SaveName:"symnItemLnm",    Align:"Left", Edit:0}, 
                    {Type:"Text",   Width:150,  SaveName:"symnItemPnm",    Align:"Left", Edit:0}, 
                    {Type:"Text",   Width:100,  SaveName:"sditemLnm",    Align:"Left", Edit:0}, 
                    {Type:"Text",   Width:40,  SaveName:"sditmPnm",    Align:"Left", Edit:0, Hidden:0}, 
                    {Type:"Text",   Width:30,  SaveName:"sditmId",    Align:"Left", Edit:0, Hidden:0}, 
...
// 	   	SetColProperty("wdDcd", ${codeMap.wdDcdibs});
        ...
        SetColHidden("symnItemId"	,0);
        SetColHidden("sditmId"	,0);
...
// 	if ('ibsSeq' == colsavename || 'ibsStatus' == colsavename || 'ibsCheck' == colsavename) return;
	...
	var tmphtml = '유사항목 : ' + param.symnItemLnm +' [ 물리명 : ' + param.symnItemPnm + ' ]';
...
<div class="pop_tit" >
    ...
    <div class="pop_tit_txt">유사항목 검색</div>
        ...
        <form id="frmSearch" name="frmSearch" method="post">
            ...
            <div class="tb_basic2">
                <table width="100%" border="0" cellspacing="0" cellpadding="0" summary="메뉴조회">
                   ...
                   <tbody>
                   		<tr>                          
                            <th scope="row"><label for="symnItemLnm">유사항목명</label></th>
                            <td>
                                <span class="input_file">
                                <input type="text" name="symnItemLnm" id="symnItemLnm" />
                                </span>
                            </td>  
                       </tr>
                   </tbody>
