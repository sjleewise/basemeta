...
//                     ,{Text:"<s:message code='META.HEADER.CODEINIT.DTL.2'/>", Align:"Center"}
                    ,{Text:"No.|컬럼id|테이블id|컬럼명|컬럼물리명|컬럼id|테이블id|컬럼명|컬럼물리명"}
                ];
        ...
        var cols = [                        
				...
				{Type:"Text",   Width:100,  SaveName:"srcTblId",			Align:"Center", Edit:0, Hidden:1},
				{Type:"Text",   Width:300,  SaveName:"srcColKnm",		Align:"Left", Edit:0},
				{Type:"Text",   Width:300,  SaveName:"srcColEnm",		Align:"Left", Edit:0},
				...
				{Type:"Text",   Width:300,  SaveName:"tgtColKnm",		Align:"Left", Edit:0},
				{Type:"Text",   Width:300,  SaveName:"tgtColEnm",		Align:"Left", Edit:0}
