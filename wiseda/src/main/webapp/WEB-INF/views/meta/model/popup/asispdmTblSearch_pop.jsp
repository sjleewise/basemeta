...
//     	alert(1);
  ...
  //파라미터 : (자동완성 대상 오브젝트, 검색할 단어종류, 최대표시 갯수(default-10개))
    setautoComplete($("#frmSearch #pdmTblLnm"), "ASISPDMTBL");
...
function initGrid()
{
    ...
    with(grid_sheet){
        ...
        var headtext = "<s:message code='META.HEADER.ASIS.PDM.TBL.SRCH.POP2'/>";
        //No.|상태|선택|주제영역|시스템명|DB유형|DB명|테이블ID|테이블(물리명)|테이블(논리명)|이전테이블(물리명)|변환대상여부|미전환대상사유|모델논리명|상위주제영역논리명|주제영역ID|비고
        var headers = [
        ...
        var cols = [                        
                    ...
                    {Type:"Text",   Width:100, SaveName:"fullPath",	 	 Align:"Left", Edit:0, KeyField:1}, 
                    {Type:"Text",   Width:60, SaveName:"systemNm",	 	 Align:"Left", Edit:0, KeyField:1}, 
                    {Type:"Text",   Width:70, SaveName:"dbmsTypCd",	 	 Align:"Left", Edit:0, KeyField:1}, 
                    {Type:"Text",   Width:70, SaveName:"dbmsNm",	 	 Align:"Left", Edit:0, KeyField:1}, 
                    ...
                    {Type:"Text",   Width:180, SaveName:"pdmTblLnm", 	 Align:"Left",   Edit:0, KeyField:0},
                    {Type:"Combo",   Width:80, SaveName:"convTrgtYn", 	 Align:"Left",   Edit:0, KeyField:0},
                    {Type:"Text",   Width:150, SaveName:"nswtTrgtRsn", 	 Align:"Left",   Edit:0, KeyField:0},
...
// 			alert(saveJson.Code); 처리대상 행이 없는 경우 리턴한다.
        	...
        	param += "&rqstDcd=CU";
        	var url = "<c:url value="/meta/model/regWam2WaqAsisPdmTbl.do" />";
                   ...
                   <tbody>                            
                       <tr>                               
                           <th scope="row" class=""><label for="fullPath">주제영역명</label></th>
                            <td>
                                <input type="text" name="fullPath" id="fullPath" value="${search.fullPath}"/>
                            </td>
