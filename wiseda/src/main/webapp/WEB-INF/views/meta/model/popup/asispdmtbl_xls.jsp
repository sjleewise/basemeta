...
<html>
<head>
<title>AS-IS물리모델테이블-엑셀업로드</title>
...
function initGrid()
{
    ...
    with(grid_sheet){
        ...
        var headtext  = "<s:message code='META.HEADER.ASIS.PDM.TBL.XLS'/>";
        //No.|상태|선택|요청구분|등록유형|주제영역|시스템명|DB유형|DB명|테이블ID|테이블(물리명)|테이블(논리명)|이전테이블(물리명)|모델논리명|상위주제영역논리명|주제영역ID|표준적용여부|담당자ID|담당자명|비고
        var headers = [
        ...
        var cols = [
					...
					{Type:"Text",   Width:280, SaveName:"fullPath",	 	 Align:"Left", Edit:0, KeyField:1}, 
					{Type:"Text",   Width:280, SaveName:"systemNm",	 	 Align:"Left", Edit:0, KeyField:1}, 
					{Type:"Text",   Width:280, SaveName:"dbmsTypCd",	 	 Align:"Left", Edit:0, KeyField:1}, 
					{Type:"Text",   Width:280, SaveName:"dbmsNm",	 	 Align:"Left", Edit:0, KeyField:1}, 
					...
					{Type:"Text",   Width:190, SaveName:"pdmTblLnm", 	 Align:"Left",   Edit:0, KeyField:1},
...
<div class="pop_tit" >
    ...
    <div class="pop_tit_txt">엑셀업로드-AS-IS물리모델테이블</div>
