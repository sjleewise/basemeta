...
//             	showMsgBox("CNF", "선택한 테이블에 속한 컬럼도 삭제됩니다.<br>삭제 하시겠습니까?", "Delete");
        ...
        $("#btnBlank").click( function(){
    		location.href = '<c:url value="/meta/model/r7_pdmtbl_rqst.do" />';
        } );
...
function initGrid()
{
    ...
    with(grid_sheet){
        ...
        var cols = [                        
                    ...
                    {Type:"Text",   Width:120,   SaveName:"fullPath",	 	Align:"Left", Edit:0},
                    ...
                    {Type:"Text",   Width:100,  SaveName:"pdmTblLnm", 	 Align:"Left",   Edit:0},
...
function doAction(sAction)
{
    ...
    switch(sAction)
    {
        case "New":        //신규 추가...
        	...
        	var url   = "<c:url value="/meta/model/popup/r7_pdmtblSearchPop.do"/>";
			var param = "?popRqst=Y";
...
//	    		$("form#frmSearch input[name=rqstSno]").val(res.ETC.rqstSno);
		...
		case "<%=WiseMetaConfig.RqstAction.APPROVE%>":
			var url = '<c:url value="/meta/model/r7_pdmtbl_rqst.do" />';
			var param = $('form[name=mstFrm]').serialize();
...
<div style="clear:both; height:5px;"><span></span></div>
	...
	<div id="tabs">
	  ...
	  <div id="tabs-1">
		...
		<!-- 컬럼 목록 탭 -->
	  <div id="tabs-2">
		<%@include file="r7_pdmcol_rqst.jsp" %>
	  </div>
	  <div id="tabs-3">
