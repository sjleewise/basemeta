...
function initTblHlGrid()
{
    ...
    with(tblh_sheet){
        ...
        var cols = [                        
                    ...
                    {Type:"Text",    Width:300,  SaveName:"userRqstCntn",    Align:"Left", Edit:0, Hidden:0},
        ...
        SetColProperty("dwTrgTblYn", 	{ComboCode:"Y|", 	ComboText:"<s:message code='COMBO.NO.YES'/>"}); /* 아니요|예 */
        SetColProperty("partTblYn", 	{ComboCode:"Y|", 	ComboText:"<s:message code='COMBO.NO.YES'/>"}); /* 아니요|예 */
...
//         	var param = $('#frmSearch').serialize();
        	var param = $('#frmSearch').serialize();
//         	alert(param);
        	tblh_sheet.DoSearch("<c:url value="/meta/model/gethistbllist.do" />", param);
