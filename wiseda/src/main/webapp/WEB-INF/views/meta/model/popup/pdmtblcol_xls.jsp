...
// 		    headtext += "<s:message code='META.HEADER.PDMCOL.XLS.4'/>";
        ...
        var cols = [                        
                    ...
                    {Type:"Int",      Width:60,  SaveName:"colOrd"      ,Align:"Center",   Edit:1, KeyField:1},
                    ...
                    {Type:"Combo",    Width:40,  SaveName:"pkYn"        ,Align:"Center",   Edit:1},
                    {Type:"Int",      Width:60,  SaveName:"pkOrd"       ,Align:"Center",   Edit:1},
                    {Type:"Combo",    Width:80,  SaveName:"nonulYn"     ,Align:"Center",   Edit:1},
                    {Type:"Text",     Width:80,  SaveName:"defltVal"    ,Align:"Left",   Edit:1},
                    {Type:"Combo",    Width:80,  SaveName:"encYn"       ,Align:"Center",   Edit:1},
