...
<html>
<head>
<title>ERWIN7 <s:message code="TBL.INQ" /></title><!-- 테이블 검색 -->
...
function initGrid()
{
    ...
    with(grid_sheet){
        ...
        var headtext = "<s:message code='META.HEADER.R7.PDMTBLSEARCH.POP'/>";
...
// 			alert(saveJson.Code); 처리대상 행이 없는 경우 리턴한다.
        	...
        	var url = "<c:url value="/meta/model/regMart2WaqPdmTbl.do" />";
			//alert(saveJson);
