...
//             	showMsgBox("CNF", "선택한 테이블에 속한 컬럼도 삭제됩니다.<br>삭제 하시겠습니까?", "Delete");
        ...
        $("#btnBlank").click( function(){
        	location.href = '<c:url value="/meta/model/exerd_pdmtbl_rqst.do" />';
        });
...
function initGrid()
{
    ...
    with(grid_sheet){
        ...
        var cols = [                        
            ...
            {Type:"Text",   Width:380,  SaveName:"objDescn"  ,    Align:"Left",   Edit:0},
...
function doAction(sAction)
{
    ...
    {
        case "New":        //신규 추가...
        	var url   = "<c:url value="/meta/model/popup/exerd_pdmtblSearchPop.do"/>";
			var param = "popRqst=Y";
...
//	    		$("form#frmSearch input[name=rqstSno]").val(res.ETC.rqstSno);
		...
		case "<%=WiseMetaConfig.RqstAction.APPROVE%>":
			var url = '<c:url value="/meta/model/exerd_pdmtbl_rqst.do" />';
			var param = $('form[name=mstFrm]').serialize();
