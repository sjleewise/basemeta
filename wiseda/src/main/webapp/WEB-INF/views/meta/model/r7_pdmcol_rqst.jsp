...
function initColGrid()
{
    ...
    with(col_sheet){
        ...
        var headtext  = "<s:message code='META.HEADER.R7.PDMCOL.RQST.1'/>";
        	headtext += "<s:message code='META.HEADER.R7.PDMCOL.RQST.2'/>";
        	headtext += "<s:message code='META.HEADER.R7.PDMCOL.RQST.3'/>";
        	headtext += "<s:message code='META.HEADER.R7.PDMCOL.RQST.4'/>";
        	headtext += "<s:message code='META.HEADER.R7.PDMCOL.RQST.5'/>";
        	headtext += "<s:message code='META.HEADER.R7.PDMCOL.RQST.6'/>";
		    headtext += "<s:message code='META.HEADER.R7.PDMCOL.RQST.7'/>";
        ...
        var cols = [                        
                    ...
                    {Type:"Text",    Width:100, SaveName:"pdmColLnm"   ,Align:"Left",   Edit:0, KeyField:1},
					...
					{Type:"Text",   Width:50,   SaveName:"rqstUserId",  Align:"Center", Edit:0, Hidden:0},
