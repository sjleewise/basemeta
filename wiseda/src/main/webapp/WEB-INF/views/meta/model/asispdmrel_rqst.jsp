...
function rel_sheet_OnClick(row, col, value, cellx, celly) {
	...
	var tmphtml = '관계명 : ' + param.pdmRelPnm + ' [' + param.pdmRelLnm +']';
...
<!-- 			    <button class="btn_search" id="btnSearch" 	name="btnSearch">재조회</button>  -->
                <button class="btn_rqst_new" id="btnRelRqstNew" name="btnRelRqstNew">추가</button>                                                         
				  <ul class="add_button_menu">
				    <li class="btn_new" id="btnRelNew"><a><span class="ui-icon ui-icon-pencil"></span>신규 추가</a></li>
<%-- 				    <li class="btn_chang_add" id="btnColChangAdd"><a><span class="ui-icon ui-icon-folder-open"></span>변경대상 추가</a></li> --%>
				    <li class="btn_excel_load" id="btnRelExcelLoad"><a><span class="ui-icon ui-icon-document"></span>엑셀 올리기</a></li>
				  </ul>         
			    <button class="btn_save" id="btnRelSave" 	name="btnRelSave">저장</button> 
			    <button class="btn_delete" id="btnRelDelete" 	name="btnRelDelete">삭제</button> 
...
<!-- 			    <button class="btn_reg_rqst" id="btnRegRqst" name="btnRegRqst">등록</button>  -->
			...
			<div class="bt02">
	          <button class="btn_excel_down" id="btnRelExcelDown" name="btnRelExcelDown">엑셀 내리기</button>                       
	    	</div>
        </div>
         <!-- 버튼영역  -->
...
<!-- 그리드 하단 영역 : 레코드 선택시 내용 표시 및 수정 가능하도록 -->
	<div class="selected_title_area">
		    <div class="selected_title" id="rel_sel_title">관계를 선택하세요.</div>
	</div>
<div style="clear:both; height:5px;"><span></span></div>
