...
<html>
<head>
<title><s:message code="TBL.MAPG.DFNT.P.SRH"/></title><!-- 테이블매핑정의서 검색 -->
...
function initGrid()
{
    ...
    with(grid_sheet){
        ...
        var headers = [
                       {Text: "<s:message code='META.HEADER.TBLMAPSEARCH.POP1'/>"},
                       ...
                       {Text: "<s:message code='META.HEADER.TBLMAPSEARCH.POP2'/>", Align:"Center"}
...
<div class="pop_tit"> <!-- 팝업가로사이즈 여기서 조절하면 됩니다 기본은 100% -->
    ...
    <div class="pop_tit_txt"><s:message code="TBL.MAPG.DFNT.P.SRH"/></div> <!-- 테이블매핑정의서 검색 -->
