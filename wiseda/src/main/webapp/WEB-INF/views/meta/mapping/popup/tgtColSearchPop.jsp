...
function initGrid()
{
    ...
    with(grid_sheet){
        ...
        var headers = [
                    {Text:"<s:message code='META.HEADER.TGTCDSEARCHPOP'/>", Align:"Center"}
                    /* No.|상태|선택|테이블ID|테이블명(물리명)|테이블명(논리명)|컬럼ID|컬럼명(물리명)|컬럼명(논리명)|컬럼순서|PK여부|데이터타입|주제영역ID|주제영역 */
                ];
        ...
        var cols = [                        
                      {Type:"Seq",    Width:50,   SaveName:"ibsSeq",       Align:"Center", Edit:0},
                   	...
                   	{Type:"Text",   Width:120,  SaveName:"tgtTblPnm",    Align:"Left", Edit:0, KeyField:0 },
                   	{Type:"Text",   Width:120,  SaveName:"tgtTblLnm",    Align:"Left", Edit:0, KeyField:0 },    	
                   	{Type:"Text",   Width:80,  SaveName:"tgtColId",    Align:"Left", Edit:0, KeyField:0 , Hidden:1},
                   	{Type:"Text",   Width:80,  SaveName:"tgtColPnm",    Align:"Left", Edit:0, KeyField:0 },
                   	{Type:"Text",   Width:80,  SaveName:"tgtColLnm",    Align:"Left", Edit:0, KeyField:0 },                   	
                   	{Type:"Text",   Width:20,  SaveName:"colOrd",    Align:"Center", Edit:0, KeyField:0 },
                   	{Type:"Text",   Width:20,  SaveName:"tgtPkYn",    Align:"Center", Edit:0, KeyField:0 },
                   	{Type:"Text",   Width:80,  SaveName:"tgtDataType",    Align:"Left", Edit:0, KeyField:0 },
        ...
        //SetExtendLastCol(1);    
//         grid_sheet.DoSearch('<c:url value="/meta/mapping/getTgtColList.do" />');
        doAction("Search");
    }
...
//         	$('#frmSearch #tgtColPnm').val($('#frmSearch #tgtColPnm').val().toUpperCase());
        	var param = $('#frmSearch').serialize();
        	grid_sheet.DoSearch('<c:url value="/meta/mapping/getTgtColList.do" />', param);
...
function grid_sheet_OnDblClick(row, col, value, cellx, celly) {
	...
	if ("${search.popType}" == "I") {
		...
		parent.returnTgtColInfoPop(JSON.stringify(retjson));
 	
// 		parent.closeLayerPop();
	} else {
		opener.returnTgtColInfoPop(JSON.stringify(retjson));
		window.close();
	}
...
<div class="pop_tit" > <!-- 팝업가로사이즈 여기서 조절하면 됩니다 기본은 100% -->
    ...
    <div class="pop_tit_txt"><s:message code="TARG.CLMN.INQ"/></div><!-- 타겟컬럼 검색 -->
                   ...
                   <tbody>                          
                     	<th scope="row"><label for="tgtTblPnm"><s:message code="TBL.NM" /></div> <!-- 테이블명 -->
                            <td>
                                ...
                                <input type="text" name="tgtTblPnm" id="tgtTblPnm"  value="${search.tgtTblPnm}" class="wd98p" />
                                </span>
                            </td>  
                        <th scope="row"><label for="tgtColPnm"><s:message code="CLMN.NM" /></label></th> <!-- 컬럼명 -->
                            <td>
                                <span class="input_file">
                                <input type="text" name="tgtColPnm" id="tgtColPnm" class="wd98p" />
                                </span>
                            </td> 
                   </tbody>
                 </table>   
