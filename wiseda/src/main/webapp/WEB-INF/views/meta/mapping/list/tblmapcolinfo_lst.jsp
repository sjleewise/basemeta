...
<!-- 	                            </tr> -->
	                            <tr>
	                                <th scope="row" class=""><label for="pdmTblLnm"><s:message code="PHYC.MDEL.TBL" /></label></th> <!-- 물리모델테이블 -->
	                                <td colspan="1"><span class="" ><input type="text" id="pdmTblLnm" name="pdmTblLnm" readonly /></span></td>
...
<!-- 	                            </tr> -->
	                            <tr>
	                                ...
	                                <td colspan="1"><span class="" ><input type="text" id="pdmColPnm" name="pdmColPnm" readonly/></span></td>
<!-- 	                            </tr> -->
<!-- 	                            <tr> -->
	                                <th scope="row"><label for="pdmColLnm"><s:message code="PHYC.MDEL.CLMN.NM.LGC.NM"/></label></th> <!-- 물리모델컬럼명(논리명) -->
	                                <td colspan="1"><span class="" ><input type="text" id="pdmColLnm" name="pdmColLnm" readonly/></span></td>
	                            </tr>
	                            <tr>
	                                <th scope="row"><label for="colOrd"><s:message code="CLMN.SQNC" /></label></th> <!-- 컬럼순서 -->
	                                <td colspan="1"><span class="" ><input type="text" id="colOrd" name="colOrd" readonly/></span></td>
<!-- 	                            </tr> -->
<!-- 	                            <tr> -->
...
<!-- 	                            style="width:wd500;" -->
	                            ...
	                            <tr>
	                                ...
	                                <td colspan="1"><input type="text" id="dataType" name="dataType"  class="wd240"  readonly/></td>
...
<!-- 	                                <td colspan="1"><input type="text" id="sditmLnm" name="sditmLnm"  class=""  readonly/></td> -->
	                                ...
	                                <td colspan="1"><input type="text" id="sditmLnm" name="sditmLnm"  class="" onclick='window.open().location.href="../stnd/sditm_lst.do?objId="+$("#frmInput2 #sditmId").val()'  readonly />
...
<!-- 	                            <tr> -->
	                                ...
	                                <td colspan="1"><span class="" ><input type="text"  id="pkOrd" name="pkOrd" readonly/></span></td>
	                            </tr>
	                            <tr>
...
<!-- 	                            <tr> -->
	                                ...
	                                <td colspan="1"><span class="" ><input type="text" id="defltVal" name="defltVal" readonly></span></td>
	                            </tr>
	                        </tbody>
	                    </table>
	                </div>
