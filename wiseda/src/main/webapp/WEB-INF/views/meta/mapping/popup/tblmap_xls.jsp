...
<html>
<head>
<title><s:message code="TBL.MAPG.DFNT.P.EXCEL.UPLOAD"/></title> <!-- 테이블매핑정의서-엑셀업로드 -->
...
function initGrid()
{
    ...
    with(grid_sheet){
        ...
        var headers = [
                       {Text: "<s:message code='META.HEADER.TBLMAP.XLS1'/>"},
                       /* No.|상태|삭제|요청구분|등록유형|테이블매핑ID|매핑정의서ID|매핑정의서유형|매핑일련번호|테이블매핑유형|타겟(TOBE)|타겟(TOBE)|타겟(TOBE)|타겟(TOBE)|소스(ASIS)|소스(ASIS)|소스(ASIS)|소스(ASIS)|소스(ASIS)|선택/스킵조건|조인조건|사전이행 고려사항|응용담당자ID|응용담당자명|전환담당자ID|전환담당자명|참고사항 */
                       {Text: "<s:message code='META.HEADER.TBLMAP.XLS2'/>", Align:"Center"}
                       /* No.|상태|삭제|요청구분|등록유형|테이블매핑ID|매핑정의서ID|매핑정의서유형|매핑일련번호|테이블매핑유형|DB명|테이블명(물리명)|테이블명(논리명)|이행유형|DB명|시스템명|업무명|테이블명(물리명)|테이블명(논리명)|선택/스킵조건|조인조건|사전이행 고려사항|응용담당자ID|응용담당자명|전환담당자ID|전환담당자명|참고사항 */
                   ];
...
//					{Type:"Combo",  Width:60,  SaveName:"vrfCd",	Align:"Center", Edit:0},
					{Type:"Text",   Width:100,  SaveName:"tblMapId", 	 Align:"Center",   Edit:1, Hidden:1},
					{Type:"Text",   Width:100,  SaveName:"mapDfId", 	 Align:"Center",   Edit:1, KeyField:1},
					{Type:"Combo",   Width:100,  SaveName:"mapDfType", 	 Align:"Center",   Edit:1},
					{Type:"Text",   Width:100,  SaveName:"mapSno", 	 Align:"Center",   Edit:1, KeyField:1},
					{Type:"Combo",   Width:100,  SaveName:"tblMapType", 	 Align:"Center",   Edit:1},
					{Type:"Text",   Width:100,  SaveName:"tgtDbPnm", 	 Align:"Center",   Edit:1, KeyField:1},
					{Type:"Text",   Width:100,  SaveName:"tgtTblPnm", 	 Align:"Center",   Edit:1, KeyField:1},
					{Type:"Text",   Width:100,  SaveName:"tgtTblLnm", 	 Align:"Center",   Edit:1},
					{Type:"Combo",   Width:100,  SaveName:"tgtFlfType", 	 Align:"Center",   Edit:1},
					{Type:"Text",   Width:100,  SaveName:"srcSysNm", 	 Align:"Center",   Edit:1},
					{Type:"Text",   Width:100,  SaveName:"srcBizNm", 	 Align:"Center",   Edit:1},
					{Type:"Text",   Width:100,  SaveName:"srcDbPnm", 	 Align:"Center",   Edit:1},
					{Type:"Text",   Width:100,  SaveName:"srcTblPnm", 	 Align:"Center",   Edit:1},
					{Type:"Text",   Width:100,  SaveName:"srcTblLnm", 	 Align:"Center",   Edit:1},
					{Type:"Text",   Width:100,  SaveName:"sltSkpCndNm", 	 Align:"Center",   Edit:1},
					{Type:"Text",   Width:100,  SaveName:"jnCndNm", 	 Align:"Center",   Edit:1},
					{Type:"Text",   Width:100,  SaveName:"preFlfDescn", 	 Align:"Center",   Edit:1},
					{Type:"Text",   Width:100,  SaveName:"appCrgpId", 	 Align:"Center",   Edit:1},
					{Type:"Text",   Width:100,  SaveName:"appCrgpNm", 	 Align:"Center",   Edit:1},
					{Type:"Text",   Width:100,  SaveName:"cnvsCrgpId", 	 Align:"Center",   Edit:1},
					{Type:"Text",   Width:100,  SaveName:"cnvsCrgpNm", 	 Align:"Center",   Edit:1},
					{Type:"Text",   Width:100,  SaveName:"refDescn", 	 Align:"Center",   Edit:1}
...
<div class="pop_tit" >
    ...
    <div class="pop_tit_txt"><s:message code="EXCEL.UPLOAD.TBL.MAPG.DFNT.P"/></div> <!-- 엑셀업로드-테이블매핑정의서 -->
