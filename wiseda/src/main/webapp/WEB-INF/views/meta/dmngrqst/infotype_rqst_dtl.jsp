...
$(document).ready(function(){
    ...
    $("#btnColGridAdd").click(function(){
    	...
    	data.stndAsrt  = grid_sheet.GetCellValue(tblRow,"stndAsrt");
    	data.dmngLnm = grid_sheet.GetCellValue(tblRow,"dmngLnm");
	...
	if("${result.stndAsrt}"!="")
	{	
		$("#frmColInput #stndAsrt").val("${result.stndAsrt}");
	}
});
     ...
     <div class="tb_basic">
         <table width="100%" border="0" cellspacing="0" cellpadding="0" summary="<s:message code='MSG.TBL.SMRY' />"> <!-- 테이블 서머리입니다. -->
             ...
             <tbody>
                 ...
                 <tr>
                   <th scope="row" class="th_require"><label><s:message code="INFO.TY.NM" /></label></th> <!-- 인포타입명 -->
                     <td>
                     	</span><input type="text" id="infotpLnm" name="infotpLnm" class="wd200" value="${result.infotpLnm }" /> <!-- 물리명 -->
                     </td>
                 </tr>
                 <tr>
                     <th scope="row"><label><s:message code="DATA" /></label></th><!-- 데이터 -->
                     <td colspan="3">
                     	<s:message code="DATA.TY" /> : <input type="text" id="dataType" name="dataType" value="${result.dataType }" /> <!-- 데이터타입 -->
                     	<s:message code="DATA.LNGT" /> : <input type="text" id="dataLen" name="dataLen"  value="${result.dataLen }" /> <!-- 데이터길이 -->
                     	<s:message code="DATA.FPOINT.LNGT" /> : <input type="text" id="dataScal" name="dataScal" value="${result.dataScal }" /> <!-- 데이터소수점길이 -->
                     </td>
                 </tr>
                 <tr>
