...
<div id="input_form_div">
	...
	<div class="tb_basic">
		<table width="100%" border="0" cellspacing="0" cellpadding="0" summary="테이블 서머리입니다.">
			...
			<tbody>
				<tr>
					<th scope="row" class="th_require">DBMS / 스키마(소스)</th>
					<td colspan="3">
	...
	<div style="clear:both; height:10px;"><span></span></div>
	<div class="stit">DBMS 타겟 정보</div>
	<div style="clear:both; height:5px;"><span></span></div>
	<legend>타겟 정보</legend>
	<div class="tb_basic">
		<table width="100%" border="0" cellspacing="0" cellpadding="0" summary="테이블 서머리입니다.">
			<caption>DBMS 타겟 정보</caption>
			<colgroup>
			   <col style="width:15%;" /> 
               <col style="width:35%" />
               <col style="width:15%;" />
			...
			<tbody>
				<tr>
					...
					<th scope="row" class="th_require">DBMS / 스키마(타겟)</th>
					<td>
						<span class="input_inactive"><input type="hidden" class="wd100" id="tgtDbSchId" name="tgtDbSchId"  value="${result.tgtDbSchId}" readonly="readonly"/></span>
       ...
       <div class="tb_basic">
           <table width="100%" border="0" cellspacing="0" cellpadding="0" summary="테이블 서머리입니다.">
               ...
               <tbody>
                   ...
                   <tr>
                       <th scope="row" class="th_require"><label for="ddlTblPnm">테이블명(물리명)</label></th>
                       <td><input type="text" id="ddlTblPnm" name="ddlTblPnm"  class="wd300" value="${result.ddlTblPnm }" readonly/>
						</td>
                       <th scope="row"><label for="ddlTblLnm">테이블명(논리명)</label></th>
                       <td><input type="text" id="ddlTblLnm" name="ddlTblLnm"  class="wd300"  value="${result.ddlTblLnm }" readonly/></td>
                       
                   </tr> 
                   <tr>
                       <th scope="row" class="th_require"><label for="ddlIdxPnm">인덱스(물리명)</label></th>
                       <td colspan="3">
                       		<input type="text" id="ddlIdxPnm" name="ddlIdxPnm"  class="wd300" value="${result.ddlIdxPnm }" readonly/> 
                       </td>		                      
                   </tr>
                   <tr>
