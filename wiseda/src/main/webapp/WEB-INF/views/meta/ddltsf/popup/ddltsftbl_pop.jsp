...
function initGrid()
{
    ...
    with(grid_sheet){
        ...
        //No.|상태|선택|오브젝트구분|DBMS명|DB스키마명|DDL테이블ID|DDL테이블물리명|DDL테이블논리명|DDL인덱스ID|DDL인덱스물리명|DDL인덱스논리명|설명|PDM_TBL_ID

        var headtext  = "<s:message code='META.HEADER.DDLTSFTBL.POP'/>";
...
function doAction(sAction)
{
    ...
    switch(sAction)
    {
        ...
        case "Search":
        	...
        	grid_sheet.DoSearch("<c:url value="/meta/ddl/getDdlTsfTblListForRqst.do" />", param);
...
//         	alert(retval);
        	...
        	var url = "<c:url value="/meta/ddl/regWam2WaqDdlTsfTbl.do" />";  
