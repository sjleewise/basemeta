...
function grid_pc04_init() {
    ...
    with(grid_pc04){
       ...
       //콤보 목록 설정
		...
		SetColProperty("rngOpr1", 	{ComboCode:"|01|02|03|04|05", 	ComboText:"<s:message code='CHC' />|<|>|<=|>=|NOT NULL"}); /*선택*/
...
// 		SetColProperty("rngCnc", 	${codeMap.rngCncibs});
		SetColProperty("rngOpr2", 	{ComboCode:"|01|02|03|04|05", 	ComboText:"<s:message code='CHC' />|<|>|<=|>=|NOT NULL"}); /*선택*/
