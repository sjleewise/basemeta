...
function initGrid()
{
	...
	with(grid_sheet){
		...
		var headers = [
					{Text:"No.|상태|선택|검토상태|검토내용|요청구분|등록유형|검증결과|업무영역명|레벨|상위업무영역명|부서ID|부서명|설명|요청일시|요청자ID|요청자명|요청번호|요청일련번호", Align:"Center"}
				];
		//DQ.HEADER.BIZAREA.RQST
		...
		var cols = [						
					...
					{Type:"Combo",  Width:100,  SaveName:"rqstDcd",	 Align:"Center", Edit:0, KeyField:1},						
					...
					{Type:"Text",   Width:100,  SaveName:"deptId",   	Align:"Left", Edit:1, KeyField:0, Hidden:1}, 
					{Type:"Text",   Width:100,  SaveName:"deptNm",   	Align:"Left", Edit:1, KeyField:0}, 
...
// 			var param = $("form#frmInput").serialize(); 
		...
		case "deptPopup":
			...
			var param = "sflag="+param+"&row=0"; 
			var popwin = OpenModal(url+"?"+param, "deptPop",  800, 600, "no");
			popwin.focus();
			break;
...
// 			var xlspopup = OpenWindow(url ,"bizareaxls","800","600","yes");
		...
		case "Down2Excel":  //엑셀내려받기
			grid_sheet.Down2Excel({HiddenColumn:1, Merge:1, FileName:'업무영역등록요청'});
			break;
...
// 	console.log(ret);
	...
	$("#deptNm").val(retjson.deptNm);
	$("#deptId").val(retjson.deptId);
