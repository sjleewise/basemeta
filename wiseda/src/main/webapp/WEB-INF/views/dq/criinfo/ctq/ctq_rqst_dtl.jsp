...
<%-- 	  <input type="hidden" id="stwdId" name="stwdId" value="${result.stwdId}" > --%>
	...
	<div class="tb_basic3">
		<table width="100%" border="0" cellspacing="0" cellpadding="0" ><!--데이터품질지표-->
					<caption><s:message code="IMCE.INFO.ITEM.REG.INFO.REG"/></caption><!--중요정보항목 정보입력-->
					...
					<tbody>
						...
						<tr>
							<th scope="row"><label for="goal">항목별 목표</label></th> <!-- <s:message code="goal.val"/> -->
							<td>
