...
<body>
   ...
   <!-- 입력폼 시작 -->
    ...
    <table border="0" cellspacing="0" cellpadding="0"  summary="">
      ...
      <tr>
      	 <th>지표별 목표</th> <!--지표별 목표 <s:message code="goal.val" />-->
        <td>
        <input type="text" name="goal" class="wd300"  readonly value="${result.goal}" >&nbsp;&nbsp;&nbsp;(%)
        </td>
        <th>가중치</th> <!--가중치 <s:message code="weight.val" />-->
        <td>
        <input type="text" name="weight" class="wd300" readonly value="${result.weight}" >
        </td>
      </tr>
