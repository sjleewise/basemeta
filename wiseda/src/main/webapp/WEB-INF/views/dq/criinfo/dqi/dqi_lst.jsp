...
function initGrid()
{
    ...
    with(grid_sheet){
        ...
        //No.|상태|선택|데이터품질지표ID|데이터품질지표명|상위데이터품질지표명|데이터품질지표레벨|업무규칙수|데이터품질지표설명|전체경로|버전|등록유형|요청일시|요청자ID|요청자명
        ...
        var cols = [                        
                    ...
                    {Type:"Text",   Width:60,  SaveName:"bizruleCnt",  Align:"Right", Edit:0, defaultValue:0},
...
function doAction(sAction)
{
    ...
    switch(sAction)
    {
        ...
        case "Down2Excel":  //엑셀내려받기
            grid_sheet.Down2Excel({HiddenColumn:1, Merge:1, FileName:'데이터품질지표조회'});
            break;
    }       
}
