...
// 	}
	...
	$('#btnSearchDeptPop').click(function(event){
	    event.preventDefault();	//브라우저 기본 이벤트 제거...
	    //팝업 flag 값 설정
		doAction("deptPopup", "BIZAREA");
	});
					...
					<tbody>
						<tr>
							...
							<td>
								...
								<button id = "btnDelPop" class="btnDelPop" ><s:message code="DEL" /></button><!--삭제-->
						...
						<tr>
							...
							<td>
								...
								<input type="text" id="deptNm" name="deptNm" class="wd300"/>
								<button id="btnDelPop" class="btnDelPop" ><s:message code="DEL" /></button><!--삭제-->

        						<button class="btnSearchPop" id="btnSearchDeptPop"><s:message code="INQ" /></button><!--검색-->
							</td>
						</tr>
						<tr>
