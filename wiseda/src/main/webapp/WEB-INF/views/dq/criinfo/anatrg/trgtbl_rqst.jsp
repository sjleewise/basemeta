...
function initGrid()
{
    ...
    with(grid_sheet){
        ...
        var headerText = "<s:message code='DQ.HEADER.TRGTBL.RQST'/>";
        ...
        var cols = [                        
                    ...
                    {Type:"CheckBox", Width:160,   SaveName:"ibsCheck",      Align:"Center", Edit:1, Sort:0},                   
            ...
            <div class="tb_basic2">
                <table width="100%" border="0" cellspacing="0" cellpadding="0" summary="<s:message code='DIAG.TRGT.DBMS.INQ.2'/>"><!--진단대상DBMS조회-->
                   ...
                   <tbody>                            
                       ...
                       <tr>                               
                           <th scope="row"><label for="expYn">상시감시대상여부</label></th><!--제외대상여부-->
                           <td colspan="3">
