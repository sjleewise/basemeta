...
$(document).ready(function() {
	...
	createIBChart("bizareaChart", "bizareaChart", {
      width: "auto",
      height: "350px"
    });
});
...
function initGrid()
{
    with(grid_sheet){
        ...
        var cols = [                        
		            ...
		            {Type:"Text",   	Width:160,  SaveName:"dbConnTrgId",   	Align:"Left", Edit:0, Hidden:1},
		            {Type:"Text",   	Width:160,  SaveName:"dbConnTrgPnm",   	Align:"Left", Edit:0, Hidden:1},
		            {Type:"Text",   	Width:200,  SaveName:"dbConnTrgLnm",   	Align:"Left", Edit:0, Hidden:0, ColMerge:1},
		            {Type:"Text",   	Width:340,  SaveName:"dbcTblNm",   	Align:"Left", Edit:0, Hidden:1, ColMerge:1},
		            {Type:"Text",   	Width:280,  SaveName:"dbcColNm",   	Align:"Left", Edit:0, Hidden:1, ColMerge:1},
		            {Type:"Text",   	Width:120,  SaveName:"bizAreaId",   	Align:"Left", Edit:0, Hidden:1},
		            {Type:"Text",   	Width:120,  SaveName:"bizAreaLnm",   	Align:"Left", Edit:0, Hidden:1},
		            {Type:"Text",   	Width:180,  SaveName:"fullPath",   	Align:"Left", Edit:0, Hidden:0, ColMerge:0},
		            {Type:"Text",   	Width:120,  SaveName:"brCnt",   	Align:"Right", Edit:0, Hidden:0, ColMerge:0},
...
// 	    	getLineChart(param);
  		...
  		case "Down2Excel":  //엑셀내려받기
            grid_sheet.Down2Excel({HiddenColumn:1, Merge:1, FileName:'업무영역별품질현황'});
//             bizareaChart.Down2Image({FileName:"BizareaProg", Type:IBExportType.JPEG, Width:800, Url:"./../../../js/IBChart/jsp/Down2Image.jsp"});
            break;
    }
}
...
function chartDraw(strVal, endVal)	{
	...
	if($("#sortTyp").val() == "dbConnTrgLnm") {
		...
		for(var i=strVal, j=0; i<=endVal; i++, j++) {
			category.push (grid_sheet.GetCellValue(strVal+j, "bizAreaLnm"));
		}
	} else if($("#sortTyp").val() == "dbcTblNm") {
	...
	bizareaChart.setOptions(toCamel({
		Chart : {
		...
		XAxis : {
			...
			Title : { //X축 제목 설정
				Text : "<s:message code='BZWR.TRRT.NM' />" + "(" + titleText + ")"/*업무영역명*/
			}
		},
		YAxis : [{
	...
	bizareaChart.addSeries(seriesQuality);
	bizareaChart.addSeries(seriesSigma);
...
<div class="main_chart_01" id="bizareaChart">
        	
<%--             <script type="text/javascript">createIBChart("bizareaChart", "100%", "350px");</script> --%>
        </div>
