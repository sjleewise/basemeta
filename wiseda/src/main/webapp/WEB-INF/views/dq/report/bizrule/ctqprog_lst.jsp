...
$(document).ready(function() {
	...
	createIBChart("ctqChart", "ctqChart", {
      width: "auto",
      height: "350px"
    });
});
...
function initGrid()
{
    with(grid_sheet){
        ...
        var cols = [                        
		            ...
		            {Type:"Text",   	Width:170,  SaveName:"dbcTblNm",   	Align:"Left", Edit:0, Hidden:1, ColMerge:1},
		            {Type:"Text",   	Width:170,  SaveName:"dbcColNm",   	Align:"Left", Edit:0, Hidden:1, ColMerge:1},
		            {Type:"Text",   	Width:100,  SaveName:"ctqId",   	Align:"Left", Edit:0, Hidden:1},
		            {Type:"Text",   	Width:150,  SaveName:"ctqLnm",   	Align:"Left", Edit:0, Hidden:1},
		            {Type:"Text",   	Width:140,  SaveName:"fullPath",   	Align:"Left", Edit:0, Hidden:0, ColMerge:0},
...
// 	    	getLineChart(param);
  		...
  		case "Down2Excel":  //엑셀내려받기
            grid_sheet.Down2Excel({HiddenColumn:1, Merge:1, FileName:'중요정보항목별품질현황'});
//             ctqChart.Down2Image({FileName:"CtqProg", Type:IBExportType.JPEG, Width:800, Url:"./../../../js/IBChart/jsp/Down2Image.jsp"});
            break;
    }
}
...
function chartDraw(strVal, endVal)	{
	...
	if($("#sortTyp").val() == "dbConnTrgLnm") {
		...
		for(var i=strVal, j=0; i<=endVal; i++, j++) {
			category.push (grid_sheet.GetCellValue(strVal+j, "ctqLnm"));
		}
	} else if($("#sortTyp").val() == "dbcTblNm") {
	...
	ctqChart.setOptions(toCamel({
		...
		XAxis : {
			...
			Title : { //X축 제목 설정
				Text : "<s:message code='IMCE.INFO.ITEM.NM'/>" + "(" + titleText + ")"/*데이터품질지표명*/
			},
			Opposite : 0
		},
		YAxis : [{
	...
	ctqChart.addSeries(seriesQuality);
	ctqChart.addSeries(seriesSigma);
...
<div class="main_chart_01" id="ctqChart">
        	
<%--             <script type="text/javascript">createIBChart("ctqChart", "100%", "350px");</script> --%>
        </div>
