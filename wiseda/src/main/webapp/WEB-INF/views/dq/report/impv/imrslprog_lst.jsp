...
function initGrid()
{
    with(grid_sheet){
        ...
        var cols = [                        
                    ...
                    {Type:"Float",   	Width:80,   SaveName:"impRate", 	Align:"Right", Edit:0, Hidden:0, ColMerge:0},
    ...
    switch(sAction)
    {
	    case "Search":
  		...
  		case "Down2Excel":  //엑셀내려받기
            grid_sheet.Down2Excel({HiddenColumn:1, Merge:1, FileName:'개선결과현황'});
                    ...
                    <tbody>  
                   	<tr>                        
                        ...
                        <th scope="row"><label for="anaDgr"><s:message code="ANLY.HIST" /></label></th><!--분석차수-->
	                        ...
	                        <th scope="row"><label for="searchBgnDe"><s:message code="ANLY.DT" /></label></th><!--분석일자-->
                            <td><input id="searchBgnDe" name="searchBgnDe" type="text" class="wd80" value="" />  - <input id="searchEndDe" name="searchEndDe" type="text" class="wd80" value=""/></td>                                       
