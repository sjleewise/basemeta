...
// 	else if(tab == "TRS"){
// 		$('div#colanatrsdtl').load('<c:url value="/dq/report/ajaxgrid/getColAnaTrsDtl.do"/>', param, function(){});
// 	}
}
...
<%-- 					<li id="tab-04"><a href="#tabs-04"><s:message code="CLMN.ANLY.TRS.INQ"/></a></li> --%>
...
<!-- 				<div id="tabs-04"> -->
<%-- 					<div id="colanatrsdtl"><%@include file="colanatrs_dtl.jsp" %></div> --%>
<!-- 				</div> -->
			</div>
