...
function doAction(sAction)
{
    ...
    switch(sAction)
    {
        ...
        case "Search":
        	...
        	grid_sheet.DoSearch('<c:url value="/dq/dqrs/dqrsResult.do" />', param);
        ...
        case "poiDown":
        	...
        	$('#dbmsLnm').val(dbmsLnm);		//선택된 DBMS의 값
        	$('#schPnm').val(schPnm);		//선택된 스키마의 값
        	$('#maskingYn').val("N");		//IP 마스킹 처리 YN
        	//hidden input을 가지고있는 poiForm
        	var myForm = document.poiForm;
        	var url ='<c:url value="/dq/dqrs/poiDown.do" />';
