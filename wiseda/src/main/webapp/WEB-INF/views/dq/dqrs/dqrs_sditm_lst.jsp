...
function initGrid()
{
    ...
    with(grid_sheet){
		...
		var headers = [
						{Text:"상태|선택|검증결과|DB물리명|스키마물리명|DBMS논리명|스키마논리명|표준용어ID|표준용어명|영문약어명|용어설명|도메인ID|도메인명|데이터타입|데이터길이|소수점 이하 자리수|출처|엑셀여부", Align:"Center"}
					];
			...
			var cols = [
						...
						{Type:"Text",   	Width:120,  SaveName:"dbConnTrgPnm",Align:"Left", 	KeyField:0, Hidden:1}, // DB물리명
						{Type:"Text",   	Width:120,  SaveName:"dbSchPnm",   	Align:"Left", 	KeyField:0, Hidden:1}, // 스키마물리명
						{Type:"Combo",   	Width:120,  SaveName:"dbConnTrgId",Align:"Left", 	Edit:1, KeyField:1, Hidden:0}, // DBMS명
						{Type:"Combo",   	Width:120,  SaveName:"dbSchId",   	Align:"Left", 	Edit:1, KeyField:1, Hidden:0}, // 스키마명
						...
						{Type:"Text",		Width:80,	SaveName:"objDescn",		Align:"Center", Edit:1, Hidden:0},
