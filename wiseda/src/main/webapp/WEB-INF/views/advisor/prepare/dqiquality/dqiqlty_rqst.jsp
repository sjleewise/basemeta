...
<script type="text/javascript">
	...
	function doAction(sAction) {
		...
		case "Search":
			...
			case 0:
				grid_dqi.DoSearch("<c:url value="/advisor/prepare/dqiquality/getDqiQltyList.do" />", param);
				break;
			/* case 1:
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0" summary="<s:message code='CLMN.PROF.MNG'/>">
                   ...
                   <tbody>                            
                       <tr>                               
                           ...
                           <th scope="row"><label for="algNm"><s:message code="DQI.NM" /></label></th>	<!--품질지표명-->

                       		<td colspan="6">
                       			<select id="dqiId"  name="dqiId" style="width:30%;">
                           		<option value=""><s:message code='MSG.DQIQLTY.RQST' /></option><!--품질지표를 선택하세요.-->
							    <c:forEach var="code" items="${codeMap.dqiCd}" varStatus="status">
							    <option value="${code.codeCd}">${code.codeLnm}</option>
							    </c:forEach>
                           		</select>
                       		</td>
                          <%--  <th scope="row"><label for="dbcTblNm"><s:message code="TBL.NM" /></label></th>	<!--테이블명-->
                       		...
                       		<td>
                       			...
                       			<input type="text" name="dbcTblNm" id="schDbcTblNm" class="wd98p"/>
                       		</td>
