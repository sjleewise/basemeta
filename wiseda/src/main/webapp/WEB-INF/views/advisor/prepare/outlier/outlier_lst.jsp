...
//         InitComboNoMatchText(1, "");
    ...
    with(grid_outlier){
        ...
        var headers = [
                    {Text:"<s:message code='BDQ.HEADER.OUTLIERPRF.LST4'/>", Align:"Center"}
                ];
        //No|상태|이상값탐지ID|데이터셋ID|이상값알고리즘ID|알고리즘유형|알고리즘(논리명)|알고리즘(물리명)|
        //분석시작일시|분석종료일시|분석시간|분석변수ID|분석차수|분석건수|추정오류건수|추정오류율(%)|분석로그ID|분석사용자ID|분석자
        var headerInfo = {Sort:1, ColMove:0, ColResize:1, HeaderCheck:1};
        ...
        var cols = [                        
                    ...
                    {Type:"Combo",   Width:100,  SaveName:"algTypCd",    Align:"Center", Edit:0, Hidden:0},
                    {Type:"Text",   Width:150,  SaveName:"algLnm",    	Align:"Center", Edit:0, Hidden:0},
                    {Type:"Text",   Width:150,  SaveName:"algPnm",    	Align:"Center", Edit:0, Hidden:0},
                      
                    {Type:"Text",   Width:100,  SaveName:"anaStrDtm",   Align:"Center", Edit:0, Hidden:1}, 
                    {Type:"Text",   Width:100,  SaveName:"anaEndDtm",   Align:"Center", Edit:0, Hidden:1}, 
                    ...
                    {Type:"Text",   Width:100,  SaveName:"anaCnt",    	Align:"Center", Edit:0}, 
                    {Type:"Text",   Width:100,  SaveName:"esnErCnt",    Align:"Center", Edit:0, Hidden:0},
	...
	//진단대상 컬럼 grid
   	with(grid_col){
           ...
           //Position|상태|선택|타겟변수여부|변수ID|프로파일ID|주제영역ID|주제영역명|진단대상ID|진단대상명|스키마ID|스키마명|테이블명|컬럼명|컬럼한글명|Pk여부|
           //데이터타입|변수타입|히스토그램여부|추천도메인|추천도메인확률|최종도메인|Null여부|Default|메타연계분석|최소값|최대값
           ...
           var cols = [                        
                   ...
                   {Type:"Text",   Width:120,  SaveName:"dbcColNm",    	Align:"Center", Edit:0}, 
                   ...
                   {Type:"Text",   Width:100,  SaveName:"varType",    	Align:"Center", Edit:0, Hidden:0},
...
<%-- 	<tiles:insertTemplate template="/WEB-INF/decorators/buttonProfile.jsp" /> --%>
	...
	<div style="clear:both; height:10px;"><span></span></div>
	<div class="stit">이상값 탐지 목록 </div><!--검색조건-->
	<div style="clear:both; height:5px;"><span></span></div>
	...
	<div id="tabs">
	  <ul>
	    <li id="tab-out01"><a href="#tabs-out01">이상값탐지결과</a></li><!--컬럼분석-->
	    <li id="tab-out02"><a href="#tabs-out02">이상값목록</a></li><!--코드분석-->
	  </ul>
	  <div id="tabs-out01">
	  	<%@include file="boxplotchart_dtl.jsp" %>
	  </div>
	  <div id="tabs-out02">
...
<div style="clear:both; height:5px;"><span></span></div>
	...
	<div style="clear:both; height:10px;"><span></span></div>
	<div class="stit">이상값탐지 컬럼(변수) 목록 </div><!--검색조건-->
	<div style="clear:both; height:5px;"><span></span></div>
...
<%-- 			    <button class="btn_save" id="btnPrfSave" 	name="btnPrfSave"><s:message code="STRG" /></button> <!-- 저장 -->  --%>
<!-- 				<button class="btn_rqst_new2" id="btnSaveOutlier" 	name="btnSaveOutlier">이상값 탐지요청</button> -->
<%-- 			    <button class="btn_delete" id="btnPrfDelete" 	name="btnPrfDelete"><s:message code="DEL" /></button> <!-- 삭제 -->  --%>
