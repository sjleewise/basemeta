...
//         InitComboNoMatchText(1, "");
	...
	//진단대상 컬럼 grid
   	with(grid_col){
           ...
           //Position|상태|변수ID|프로파일ID|주제영역ID|주제영역명|진단대상ID|진단대상명|스키마ID|스키마명|테이블명|컬럼명|컬럼한글명
           //|Pk여부|데이터타입|변수타입|추천도메인|추천도메인확률|최종도메인|품질지표|Null여부|Default|메타연계분석|최소값|최대값
...
// 	    	if(SaveJson.data.length == 0) return;
			...
			var url = "<c:url value="/advisor/prepare/domain/requestDmnClass.do"/>";
...
function grid_col_OnClick(row, col, value, cellx, celly) {
	...
	$('div#dmn_add_feature').load('<c:url value="/advisor/prepare/domain/getdmnfeature_dtl.do"/>', param1, function(){});
...
<div style="clear:both; height:5px;"><span></span></div>
	...
	<div id="tabs">
	  ...
	  <div id="tabs-pc01">
	  	<%@include file="dmnpdtresult_dtl.jsp" %>
	  </div>
	  <div id="tabs-pc02">
	  <div id="colanaresdtl"></div>
	  </div>
	  <div id="tabs-pc03">
	  	<%@include file="colpc01dataptr_dtl.jsp" %>
	  </div>
	  <div id="tabs-pc04">
