...
function initGrid()
{
    ...
    with(grid_tbl){
        ...
        var headers = [
                    {Text:"<s:message code='BDQ.HEADER.DMNCLASS.NSTND.RQST3'/>", Align:"Center"}
                ];
        //No|상태|선택|주제영역ID|주제영역명|진단대상ID|진단대상명|스키마ID|스키마명|테이블명|테이블한글명|메타연계분석
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0" summary="<s:message code='PROF.MNG'/>"> <!-- 프로파일 관리 -->
			   ...
			   <col style="width:38%;" />
			       ...
			       <tbody>   
			               ...
			               <td>
			                   <input  type="text"  name="dbConnTrgPnm" id="dbConnTrgPnm"  class="b0" readonly />
			               </td>
			               <th scope="row"  ><label for="dbSchPnm"><s:message code="SCHEMA.NM" /></label></th><!-- 스키마명 -->
			               <td>
			                   <input type="text" name="dbSchPnm" id="dbSchPnm"  class="b0" readonly />
			               </td>
			           </tr>                         
			           <tr>                               
...
<%-- 	<tiles:insertTemplate template="/WEB-INF/decorators/buttonProfile.jsp" /> --%>
	...
	<%-- <div id="tabs" style="display: none;">
	  <ul>
	    <li id="tab-pc01"><a href="#tabs-pc01"><s:message code="CLMN"/></a></li><!--컬럼분석-->
	    <li id="tab-pc02"><a href="#tabs-pc02"><s:message code="CD"/></a></li><!--코드분석-->
	    <li id="tab-pc03"><a href="#tabs-pc03"><s:message code="DATE.FRMT"/></a></li><!--날짜형식분석-->
	    <li id="tab-pc04"><a href="#tabs-pc04"><s:message code="RNG"/></a></li><!--범위분석-->
