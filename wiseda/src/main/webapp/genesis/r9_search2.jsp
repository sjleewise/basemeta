...
<script language>
	...
	function goSearch(){
		...
		if(document.fx.work[0].checked == true) fx.action	= "_comboEntity.jsp";
		if(document.fx.work[1].checked == true) fx.action	= "_comboAttri.jsp";
		if(document.fx.work[2].checked == true) fx.action	= "_comboIndex.jsp";
		if(document.fx.work[3].checked == true) fx.action	= "_comboRelation.jsp";
		if(document.fx.work[4].checked == true) fx.action	= "_comboRelationAttri.jsp";
