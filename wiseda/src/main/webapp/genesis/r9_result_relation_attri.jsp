...
%>
		<tr>
			...
			<td><input type=text value="<%= map.get("relation_entity_name_parent"			)%>"	style="font-size:11" size="15" readOnly size=15></td>
			<td><input type=text value="<%= map.get("relation_entity_name_physical_parent"	)%>"	style="font-size:11" size="15" readOnly size=15></td>
			<td><input type=text value="<%= map.get("relation_entity_name_child"			)%>"	style="font-size:11" size="15" readOnly size=15></td>
			<td><input type=text value="<%= map.get("relation_entity_name_physical_child"	)%>"	style="font-size:11" size="15" readOnly size=15></td>

			<td align="center"><%= map.get("relation_attri_order_index")%></td>
			...
			<td><input type=text value="<%= map.get("relation_subjectArea_name_parent"			)%>"	style="font-size:12" size="10" readOnly ></td>
			<td><input type=text value="<%= map.get("relation_subjectArea_name_child"	)%>"			style="font-size:11" size="10" readOnly ></td>
<td align="center"><input type=text value="<%= map.get("relation_attribute_name_parent")%>"				style="font-size:11" size="10" readOnly ></td>
<td align="center"><input type=text value="<%= map.get("relation_attribute_name_physical_parent")%>"	style="font-size:11" size="10" readOnly ></td>
<td align="center"><input type=text value="<%= map.get("relation_attribute_name_child")%>"				style="font-size:11" size="10" readOnly ></td>
<td align="center"><input type=text value="<%= map.get("relation_attribute_name_physical_child")%>"		style="font-size:11" size="10" readOnly ></td>
<td align="center"><%= map.get("relation_attribute_key_YN_child")%></td>
