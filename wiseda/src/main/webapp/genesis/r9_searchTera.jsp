...
<script language>
	...
	function goSearch(){
		...
		if(fx.entity_id[0].selected == true){
			if(fx.entity_name.value == ''){
				if(fx.entity_name_physical.value == ''){
					alert('엔티티를 선택하거나 입력 하세요');
					return ;
				}
			}
		}
		...
		if(document.fx.work[0].checked == true) fx.action	= "_comboEntityTera.jsp";
