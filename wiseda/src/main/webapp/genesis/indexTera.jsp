...
<iframe name="iframe_search" src = "r9_searchTera.jsp" width="1500" height="150"/>
</iframe>

<iframe id="iframe_result" name="iframe_result" src = "_comboEntityTera.jsp?work=1" width="1500" height="600"/>
</iframe>