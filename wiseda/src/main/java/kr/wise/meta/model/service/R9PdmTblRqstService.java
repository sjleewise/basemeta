 ...
 * </PRE>
 */
public interface R9PdmTblRqstService extends CommonRqstService {
	...
	/** @return insomnia
	 * @throws Exception */
	int regMart9Waq(WaqMstr reqmst, ArrayList<WaqPdmTbl> list) throws Exception;
	...
	/** @param search
	/** @return insomnia */
	List<WaqPdmTbl> getMart9TblList(WaqPdmTbl search) throws Exception;

	//모델마트연계 관계정보 조회
	List<WaqPrfRelColVO> getErMart9RelLst(WaqPrfRelColVO search);

	List<WaqPdmTbl> getMart9TblListSoft(WaqPdmTbl search) throws Exception;
