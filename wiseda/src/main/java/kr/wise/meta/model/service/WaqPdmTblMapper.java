...
@Mapper
public interface WaqPdmTblMapper extends CommonRqstMapper {
	...
	HashMap<String,String> selectSubjDbmsTypCd(String rqstNo);

	boolean checkEmptyRqst(@Param("rqstNo") String rqstno);

	int changeOwner(WaqPdmTbl regVo);  
	
	void checkprsvTerm(Map<String, Object> checkmap);

	void checkdqDgnsYn(Map<String, Object> checkmap);

	void checknopenDtlRelBss(Map<String, Object> checkmap);

	void checkoccrCyl(Map<String, Object> checkmap);

	void checkopenDataLst(Map<String, Object> checkmap);

	void checkopenRsnCd(Map<String, Object> checkmap);

	void checktblTypNm(Map<String, Object> checkmap);

	void checktblVol(Map<String, Object> checkmap);

	void checknopenRsn(Map<String, Object> checkmap);  
}