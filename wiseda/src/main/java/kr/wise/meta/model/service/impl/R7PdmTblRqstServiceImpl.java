...
public class R7PdmTblRqstServiceImpl implements R7PdmTblRqstService {
...
//			waqcolmapper.insertByRqstMartCol(saveVo);
			List<WaqPdmCol> collist = r7mapper.selectR7ColListbyTblId(saveVo);
...
//		List<WaqPdmTbl> martlist = waqmapper.selectmartlist(reqmst, list);
		List<WaqPdmTbl> martlist = r7mapper.selectmartlist(reqmst, list);
	...
	public List<WaqPdmTbl> getMartTblList(WaqPdmTbl search) {
		List<WaqPdmTbl> list = r7mapper.selectMartList(search);
		return list;
	}

	@Override
	public List<WaqPrfRelColVO> getErMart7RelLst(WaqPrfRelColVO search) {
		List<WaqPrfRelColVO> list = r7mapper.selectErMart7RelLst(search);
		return list;
	}
