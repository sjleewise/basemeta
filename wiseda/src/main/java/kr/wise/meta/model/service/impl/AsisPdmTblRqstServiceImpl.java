...
import kr.wise.meta.model.service.WaqAsisPdmColMapper;
import kr.wise.meta.model.service.WaqAsisPdmTblMapper;
 ...
 * </PRE>
 */
@Service("asisPdmTblRqstService")
public class AsisPdmTblRqstServiceImpl implements AsisPdmTblRqstService {

	private final Logger logger = LoggerFactory.getLogger(getClass());

	@Inject
	private WaqAsisPdmTblMapper waqmapper;

	@Inject
	private WaqAsisPdmColMapper waqcolmapper;

//	@Inject
//	private WaqAsisPdmRelMapper waqPdmRelMapper;
...
//		waqcolmapper.updateNonObjEnm(rqstNo);
		...
		//주제영역 단위 표준 적용 여부가 Y인 테이블만 SUBJ_ID 를 컬럼에 적용한다.
		waqcolmapper.updateSubjId(rqstNo);
...
//		waqPdmRelMapper.updateSubjId(rqstNo);
		...
		checkmap.put("tblnm"	, "WAQ_ASIS_PDM_TBL");
		checkmap.put("rqstNo"	, rqstNo);
		checkmap.put("bizDtlCd"	, "TBL");
...
//		waqmapper.checkCommonCol(checkmap); 
		...
		checkmap2.put("tblnm", "WAQ_ASIS_PDM_COL");
...
//				return "-999";
	...
	public List<WaqPdmRel> getPdmRelRqstList(WaqMstr search) {
		WaqPdmRel tmp = new WaqPdmRel();
//		return waqPdmRelMapper.selectPdmRelRqstList(search);
		return (List<WaqPdmRel>) tmp;
	}
