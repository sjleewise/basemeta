 ...
 * </PRE>
 */
public interface DasPdmTblRqstService extends CommonRqstService {
	...
	/** @return insomnia
	 * @throws Exception */
	int regMartDasWaq(WaqMstr reqmst, ArrayList<WaqPdmTbl> list) throws Exception;
	...
	/** @param search
	/** @return insomnia */
	List<WaqPdmTbl> getMartDasTblList(WaqPdmTbl search) throws Exception;

	//모델마트연계 관계정보 조회
	List<WaqPrfRelColVO> getErMartDasRelLst(WaqPrfRelColVO search);
