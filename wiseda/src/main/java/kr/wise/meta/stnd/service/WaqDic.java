...
public class WaqDic extends CommonVo {
    ...
    private String dicRqstNo;

    

	public String getDicRqstNo() {
		return dicRqstNo;
	}

	public void setDicRqstNo(String dicRqstNo) {
		this.dicRqstNo = dicRqstNo;
	}
	...
	public String toString() {
		return "WaqDic [wdName=" + wdName + ", dicOrgn=" + dicOrgn + ", ennm=" + ennm + ", dicDesc=" + dicDesc
				+ ", dicRqstUserId=" + dicRqstUserId + "]";
	}
}