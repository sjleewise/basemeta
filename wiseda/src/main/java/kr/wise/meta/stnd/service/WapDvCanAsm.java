...
public class WapDvCanAsm extends WaaInfoType {
    ...
    public String getDelPartly() {
		return delPartly;
	}

	public void setDelPartly(String delPartly) {
		this.delPartly = delPartly;
	}
	...
	public String getDvOrgPnm() {
		return dvOrgPnm;
	}

	public void setDvOrgPnm(String dvOrgPnm) {
		this.dvOrgPnm = dvOrgPnm;
	}
	...
	public String toString() {
		...
		builder.append("WapDvCanAsm [dvRqstNo=").append(dvRqstNo)
  		        .append(", delPartly=").append(delPartly)
				...
				.append(", dvOrgLnm=").append(dvOrgLnm).append(", dvOrgPnm=").append(dvOrgPnm)
				.append(", dvEncYn=").append(dvEncYn)
				.append(", dvObjDescn=").append(dvObjDescn)
