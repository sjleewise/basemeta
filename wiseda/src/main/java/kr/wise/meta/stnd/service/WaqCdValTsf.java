...
public class WaqCdValTsf extends CommonVo {
...
//    }
	...
	public String toString() {
		...
		builder.append("WaqCdVal [rqstDtlSno=").append(rqstDtlSno)
				.append(", cdValId=").append(cdValId).append(", cdVal=")
				.append(cdVal).append(", cdValNm=").append(cdValNm)
				.append(", dmnId=").append(dmnId).append(", dmnLnm=")
				.append(dmnLnm).append(", uppCdValId=").append(uppCdValId)
				.append(", uppCdVal=").append(uppCdVal).append("]");
