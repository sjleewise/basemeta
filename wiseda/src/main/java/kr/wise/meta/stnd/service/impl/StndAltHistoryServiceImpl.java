 ...
 * </PRE>
 */
@Service("StndAltHistoryService")
public class StndAltHistoryServiceImpl implements StndAltHistoryService {
	...
	/** insomnia */
	@Override
	public List<WamStwd> getAltHistoryList(WamStwd data) {
		if(data.getRegTypCd() == null)		{
			data.setRegTypCd("ALL");
		}
		return mapper.selectAltHistoryList(data);
	}
