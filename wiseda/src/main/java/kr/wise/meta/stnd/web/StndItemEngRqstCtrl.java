...
import kr.wise.meta.stnd.web.StndItemRqstCtrl.WaqSditms;
...
@Controller("StndItemEngRqstCtrl") 
public class StndItemEngRqstCtrl {
	...
	@Inject
	private StndItemEngRqstService stndItemEngRqstService; 
...
//		codeMap.put("sysareaibs", sysareaibs);
    ...
    /** 표준용어(다국어) 요청서 입력 폼.... @throws Exception insomnia */
    @RequestMapping("/meta/stnd/stnditem_eng_rqst.do")
...
//    	logger.debug("reqmst:{}", reqmst);
    	...
    	if (!StringUtils.hasText(reqmst.getRqstNo())){
    		reqmst.setBizDcd("SDENG");
    		reqmst.setBizDtlCd("SDENG");
    	...
    	return "/meta/stnd/stnditem_eng_rqst";

    }

    /** 표준용어 (다국어) 요청서 상세정보 조회 @return insomnia 
     * @throws Exception */
    @RequestMapping("/meta/stnd/ajaxgrid/stnditem_eng_rqst_dtl.do")
    public String goStndItemDetail(WaqSditm searchVo, ModelMap model) throws Exception {
    	...
    	return "/meta/stnd/stnditem_eng_rqst_dtl";
    }
    
    /** 표준용어(다국어) 요청 리스트 조회.... @return insomnia */
    @RequestMapping("/meta/stnd/getItemEngRqstList.do")
    @ResponseBody
    public IBSheetListVO<WaqSditm> getItemEngRqstList (WaqMstr search) {
    	logger.debug("search:{}", search);

    	List<WaqSditm> list = stndItemEngRqstService.getItemEngRqstList(search);

    	return new IBSheetListVO<WaqSditm>(list, list.size());
    }
    

    /** 표준용어(다국어) 리스트 등록 @throws Exception insomnia */
    @RequestMapping("/meta/stnd/regItemEngRqstlist.do")
    @ResponseBody
	public IBSResultVO<WaqMstr> regItemEngRqstlist(@RequestBody WaqSditms data, WaqMstr reqmst, Locale locale) throws Exception {

		logger.debug("reqmst:{}\ndata:{}", reqmst, data);
		ArrayList<WaqSditm> list = data.get("data");

		int result = stndItemEngRqstService.register(reqmst, list);

		result += stndItemEngRqstService.check(reqmst);
    ...
    //표준용어 승인 다국어
    @RequestMapping("/meta/stnd/approveStndItemEng.do")
    @ResponseBody
    public IBSResultVO<WaqMstr> approveStndItem (@RequestBody WaqSditms data, WaqMstr reqmst, Locale locale) throws Exception {
    	...
    	int result = stndItemEngRqstService.approve(reqmst, list);
