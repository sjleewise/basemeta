...
public class ModelGapVO extends CommonVo {
	...
	private String ddlSeqNm;
	private String ddlSeqErrDescn;
	private String dbcminval;
	private String dbcmaxval;
	private String dbcincby;
	private String dbccycYn;
	private String dbcordYn;
	private String dbccacheSz;

	private String dbcSeqId;
	private String dbcSeqNm;
	private String dbcSeqErrDescn;
	private String ddlminval;
	private String ddlmaxval;
	private String ddlincby;
	private String ddlcycYn;
	private String ddlordYn;
	private String ddlcacheSz;
    ...
    public String getDbcminval() {
		return dbcminval;
	}



	public void setDbcminval(String dbcminval) {
		this.dbcminval = dbcminval;
	}



	public String getDbcmaxval() {
		return dbcmaxval;
	}



	public void setDbcmaxval(String dbcmaxval) {
		this.dbcmaxval = dbcmaxval;
	}



	public String getDbcincby() {
		return dbcincby;
	}



	public void setDbcincby(String dbcincby) {
		this.dbcincby = dbcincby;
	}



	public String getDbccycYn() {
		return dbccycYn;
	}



	public void setDbccycYn(String dbccycYn) {
		this.dbccycYn = dbccycYn;
	}



	public String getDbcordYn() {
		return dbcordYn;
	}



	public void setDbcordYn(String dbcordYn) {
		this.dbcordYn = dbcordYn;
	}



	public String getDbccacheSz() {
		return dbccacheSz;
	}



	public void setDbccacheSz(String dbccacheSz) {
		this.dbccacheSz = dbccacheSz;
	}



	public String getDdlminval() {
		return ddlminval;
	}



	public void setDdlminval(String ddlminval) {
		this.ddlminval = ddlminval;
	}



	public String getDdlmaxval() {
		return ddlmaxval;
	}



	public void setDdlmaxval(String ddlmaxval) {
		this.ddlmaxval = ddlmaxval;
	}



	public String getDdlincby() {
		return ddlincby;
	}



	public void setDdlincby(String ddlincby) {
		this.ddlincby = ddlincby;
	}



	public String getDdlcycYn() {
		return ddlcycYn;
	}



	public void setDdlcycYn(String ddlcycYn) {
		this.ddlcycYn = ddlcycYn;
	}



	public String getDdlordYn() {
		return ddlordYn;
	}



	public void setDdlordYn(String ddlordYn) {
		this.ddlordYn = ddlordYn;
	}



	public String getDdlcacheSz() {
		return ddlcacheSz;
	}



	public void setDdlcacheSz(String ddlcacheSz) {
		this.ddlcacheSz = ddlcacheSz;
	}
	...
	public String getDdlSeqNm() {
		return ddlSeqNm;
	}



	public void setDdlSeqNm(String ddlSeqNm) {
		this.ddlSeqNm = ddlSeqNm;
	}
	...
	public String getDbcSeqId() {
		return dbcSeqId;
	}



	public void setDbcSeqId(String dbcSeqId) {
		this.dbcSeqId = dbcSeqId;
	}
	...
	public String getDbcSeqErrDescn() {
		return dbcSeqErrDescn;
	}



	public void setDbcSeqErrDescn(String dbcSeqErrDescn) {
		this.dbcSeqErrDescn = dbcSeqErrDescn;
	}
