...
/**
 * <PRE>
 * 1. ClassName : AppStndMainCtrl
 * 2. FileName  : AppStndMainCtrl.java
 * 3. Package  : kr.wise.meta.app.web
 * 4. Comment  :
 * 5. 작성자   : mse
 * 6. 작성일   : 2016. 3. 18. 오후 16:30:51
 * </PRE>
 */
@Controller("AppStndMainCtrl")
@RequestMapping("/meta/app/*")
public class AppStndMainCtrl{
	 ...
	 * @return
	 */
	@RequestMapping(value="appstnd_lst.do")
	 ...
	 * @return
	 */
	@RequestMapping(value="appstwd_lst.do")
	public String goStndStwdList(HttpSession session, @RequestParam(value="action",  required=false) String action, @RequestParam(value="objId", required=false) String stwdId, String linkFlag, Model model) {
		...
		return "/meta/app/appstwd_lst";
	}

	@RequestMapping(value="stwd_ifm.do")
	public String goStndStwdTop30(HttpSession session) {
		return "/meta/app/stwd_ifm";
	}
	...
	public String goStndAltHistoryList(HttpSession session, @RequestParam(value="action",  required=false) String action, Model model) {
		logger.debug("{}", action);
		model.addAttribute("action", action);
		return "/meta/app/althistory_lst";
	}

	@RequestMapping(value="althistory_ifm.do")
	public String goAltHistoryTop30(HttpSession session) {
		return "/meta/app/althistory_ifm";
	}


	
	@RequestMapping(value="dmn_ifm.do")
	public String goStndDmnTop30(HttpSession session) {

		return "/meta/app/dmn_ifm";
	}
	 ...
	 * @throws Exception 
	 */
	@RequestMapping(value="appsditm_lst.do")
	public String goStndSditmList(HttpSession session, @RequestParam(value="objId", required=false) String sditmId, String linkFlag, Model model) throws Exception {
		...
		return "/meta/app/appsditm_lst";
	}

	@RequestMapping(value="sditm_ifm.do")
	public String goStndSditmTop30(HttpSession session) {

		return "/meta/app/sditm_ifm";
	}
}