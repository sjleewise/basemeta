...
public class WaqDdlRel extends CommonVo{
...
//    }
	...
	public String toString() {
		...
		builder.append("WaqDdlRel [ddlRelPnm=").append(ddlRelPnm)
				.append(", paEntyPnm=").append(paEntyPnm)
				.append(", paAttrPnm=").append(paAttrPnm)
				.append(", chEntyPnm=").append(chEntyPnm)
				.append(", chAttrPnm=").append(chAttrPnm).append(", ddlRelId=")
				.append(ddlRelId).append(", ddlRelLnm=").append(ddlRelLnm)
				.append(", relTypCd=").append(relTypCd).append(", crdTypCd=")
				.append(crdTypCd).append(", paOptTypCd=").append(paOptTypCd)
				.append(", paSubjId=").append(paSubjId).append(", paSubjPnm=")
				.append(paSubjPnm).append(", paEntyId=").append(paEntyId)
				.append(", paAttrId=").append(paAttrId).append(", chSubjId=")
				.append(chSubjId).append(", chSubjPnm=").append(chSubjPnm)
				.append(", chEntyId=").append(chEntyId).append(", chAttrId=")
				.append(chAttrId).append("]");
