package kr.wise.meta.ddl.script.platform.sybase;
 ...
 */
public class SybaseASEBuilder extends SqlBuilder
{
    ...
    public SybaseASEBuilder()
    {
        ...
        {
        	throw new WiseBizException("SybaseASEBuilder Error");
        }
    }
