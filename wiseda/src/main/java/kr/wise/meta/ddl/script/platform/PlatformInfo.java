...
public class PlatformInfo
{
    ...
    private boolean _nullAsDefaultValueRequired = true;
    ...
    private boolean _primaryKeyEmbedded = false;
    ...
    /** Whether grant are embedded inside the create table statement. */
    private boolean _grantEmbedded = false;
    ...
    public boolean getGrantEmbedded()
    {
        return _grantEmbedded;
    }

    public void setGrantEmbedded(boolean grantEmbedded)
    {
    	_grantEmbedded = grantEmbedded;
    }
