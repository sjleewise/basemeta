package kr.wise.meta.ddl.script.platform.teradata;
 ...
 */
public class TeradataBuilder extends SqlBuilder
{
    ...
    public TeradataBuilder()
    {
        ...
        {
        	throw new WiseBizException("TeradataBuilder Error");
        }
    }
