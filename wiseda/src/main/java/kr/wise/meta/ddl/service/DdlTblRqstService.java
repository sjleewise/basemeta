 ...
 * </PRE>
 */
public interface DdlTblRqstService extends CommonRqstService {
	...
	List<WaqDdlTbl> getDdlTsfTblRqstList(WaqMstr search);
	

	List<WaqDdlTbl> getDdlTblVrfCdList(WaqMstr reqmst);

	int regTsfWam2Waq(WaqMstr reqmst, ArrayList<WaqDdlTbl> list) throws Exception;
