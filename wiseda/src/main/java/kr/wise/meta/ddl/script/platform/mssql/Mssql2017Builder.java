package kr.wise.meta.ddl.script.platform.mssql;
 ...
 */
public class Mssql2017Builder extends SqlBuilder
{
    ...
    public Mssql2017Builder()
    {
        ...
        {
        	throw new WiseBizException("Mssql2017Builder Error");
        }
    }
...
//    	if(!StringUtils.isBlank(table.getDdltbl().getDdlTblLnm())) {
    	if(!StringUtils.isBlank(table.getDescription())) {
    		...
    		print("EXEC sp_addextendedproperty @name = N'Caption', @value = N'"+table.getDescription()+"'");
    		print(",");
    		print("@level0Type = N'Schema', @Level0Name = '"+ table.getSchema()+"'");
    		print(",");
    		print("@level1Type = N'Table', @Level1Name = '"+table.getName()+"'");
	...
	public void writeColCommentStmt(Table table) throws IOException {
        for (int idx = 0; idx < table.getColumnCount(); idx++)
        {
        	...
        	if(!StringUtils.isBlank(col.getDescription())) {
        		...
        		print("EXEC sp_addextendedproperty @name = N'Caption', @value = N'"+col.getDescription()+"'");
        		print(",");
        		print("@level0Type = N'Schema', @Level0Name = '"+ table.getSchema()+"'");
        		print(",");
        		print("@level1Type = N'Table', @Level1Name = '"+table.getName()+"'");
        		print(",");
        		print("@level2type = N'Column', @level2name = '"+getColumnName(col)+"'");
        		println(getPlatformInfo().getSqlCommandDelimiter());
        	}
