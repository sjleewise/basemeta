 ...
 */
public class Column extends WaqDdlCol implements Serializable
{
...
//        }
	...
	public String toString() {
		...
		builder.append("Column [_name=").append(_name)
				.append(", _description=").append(_description)
				.append(", _primaryKey=").append(_primaryKey)
				.append(", _required=").append(_required)
				.append(", _typeCode=").append(_typeCode).append(", _type=")
				.append(_type).append(", _defaultValue=").append(_defaultValue)
				.append(", dataLen=").append(dataLen).append(", dataScal=")
				.append(dataScal).append("]");
