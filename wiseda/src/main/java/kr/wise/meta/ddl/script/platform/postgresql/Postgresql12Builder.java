package kr.wise.meta.ddl.script.platform.postgresql;
 ...
 */
public class Postgresql12Builder extends SqlBuilder
{
    ...
    public Postgresql12Builder()
    {
        ...
        {
        	throw new WiseBizException("Postgresql12Builder Error");
        }
    }
...
//    		createPrimaryKey(table, table.getPrimaryKeyColumns());
	...
	public void modifyColumn(Table table, Column newColumn) throws IOException
    {
    	...
    	print(" ALTER COLUMN ");
    	writeAlterColumn(table, newColumn);
    	printEndOfStatement();
    }
	...
	public void addColumn(Table table, Column newColumn) throws IOException
    {
        ...
        print(getTableName(table));
        print(" ADD COLUMN ");
        super.writeColumn(table, newColumn);
        printEndOfStatement();
    }
