 ...
 * </PRE>
 */ 
public class MtResultVO extends CommonVo{
	...
	private List<MtResultDataVO> errList;
	
	private List<MtResultDataVO> errData;
	...
	public List<MtResultDataVO> getErrData() {
		return errData;
	}

	public void setErrData(List<MtResultDataVO> errData) {
		this.errData = errData;
	}

	public List<MtResultDataVO> getErrList() {
		return errList;
	}

	public void setErrList(List<MtResultDataVO> errList) {
