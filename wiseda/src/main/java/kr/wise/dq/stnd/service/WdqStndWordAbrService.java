...
public interface WdqStndWordAbrService {
	...
	public int regStndWordByAbr(WaqMstr waqMstr, ArrayList<WdqmStwdAbr> list);  
	
	List<WdqmStwdAbr> selectStwdAbbreviatedList(WdqmStwdAbr searchVO);
	
	Map<String, String> delStwdAbrLst(List<WdqmStwdAbr> list)  throws Exception;
