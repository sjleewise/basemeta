 ...
 */
@Controller("wdqStndDmnRqstViewCtrl")
public class WdqStndDmnRqstViewCtrl {
...
//    	logger.debug("reqmst:{}", reqmst);
    ...
    public String getstnddmnDetail(WdqqDmn searchVo, ModelMap model) throws Exception {
    	...
    	if(searchVo.getRqstSno() == null) {
    		...
    		WdqqDmn resultvo =  WdqStndDmnRqstService.getStndDmnRqstDetail(searchVo);
    ...
    public String gostnddmnxlspage(@ModelAttribute("search") WdqqDmn search) {
	...
	public String domaindivisionpop(@ModelAttribute("search") WdqqDmn search, Model model, Locale locale) {
	...
	public String gostndcdval(@ModelAttribute("search") WdqqDmn search ){
	...
	public String gostnddmnxls(@ModelAttribute("search") WdqqDmn search ){
...
//        System.out.println("카운트 : " + mapcount);
    ...
    public String getcodedmnDetail(WdqqDmn searchVo, ModelMap model) throws Exception {
