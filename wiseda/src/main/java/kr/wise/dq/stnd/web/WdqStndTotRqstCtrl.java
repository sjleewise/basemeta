...
import kr.wise.dq.stnd.service.WdqStndTotRqstService;
 ...
 */
@Controller
public class WdqStndTotRqstCtrl {
	...
	@Inject
	private WdqStndTotRqstService WdqStndTotRqstService;
...
//    	logger.debug("reqmst:{}", reqmst);
        ...
        //int dmnYn = WdqStndDmnRqstService.checkExistsWdqqDmn(reqmst);
        //int itemYn = WdqStndItemRqstService.checkExistsWaqItem(reqmst);
...
//    @ResponseBody
//	public IBSResultVO<WaqMstr> regapproveStndWord(@RequestBody WdqqStwds data, WaqMstr reqmst, Locale locale) throws Exception {
//
//		logger.debug("reqmst:{} \ndata:{}", reqmst, data);
//		String resmsg;
//
...
//		ArrayList<WdqqStwd> list = data.get("data");
//
//		int result = WdqStndWordRqstService.regapprove(reqmst, list); 
//
//
//		if(result >= 0) {
//			result = 0;
...
//	@ResponseBody
//	public IBSResultVO<WaqMstr> regapproveStndDmn(@RequestBody WdqqDmns data, WaqMstr reqmst, Locale locale) throws Exception {
//
//		logger.debug("reqmst:{} \ndata:{}", reqmst, data);
//		String resmsg;
//
...
//
//		int result  = WdqStndDmnRqstService.regapprove(reqmst, list);
//
//        
//		if(result >= 0) {
//			result = 0;
...
//    @ResponseBody
//    public IBSResultVO<WaqMstr> regapproveStndItem (@RequestBody WdqqSditms data, WaqMstr reqmst, Locale locale) throws Exception {
//
//    	logger.debug("reqmst:{} \ndata:{}", reqmst, data);
//    	String resmsg;
//
...
//
//    	int result = WdqStndItemRqstService.regapprove(reqmst, list);
//
//
//		if(result >= 0) {
//			result = 0;
...
//		*/
//		
//		List<WdqqStwd> lstWord  = (List<WdqqStwd>) data.get("word");
//		List<WdqqDmn> lstDmn   = (List<WdqqDmn>) data.get("dmn");
//		List<WdqqSditm> lstSditm = (List<WdqqSditm>) data.get("item");   
//		
//		logger.debug("\n lstWord size:" + lstWord.size());
//		logger.debug("\n lstDmn size:" + lstDmn.size());
//		logger.debug("\n lstSditm size:" + lstSditm.size());
//
//		int result = WdqStndTotRqstService.aprvStndTot(reqmst, lstSditm, lstDmn, lstWord);  
//				
//    	//int result = WdqStndTotRqstService.approve(reqmst, null);
//
//
//		if(result >= 0) {
//			result = 0;
