 ...
 * </PRE>
 */
public interface WdqStndWordRqstService extends CommonRqstService {

	/** @param search
	/** @return insomnia */
	List<WdqqStwd> getStndWordRqstist(WaqMstr search);

	/** @param list
	/** @return insomnia */
	int regStndWordRqstlist(ArrayList<WdqqStwd> list);

	/** @param searchVO
	/** @return insomnia */
	WdqqStwd getStndWordRqstDetail(WdqqStwd searchVO);
	...
	/** @return insomnia
	 * @throws Exception */
	int regWam2Waq(WaqMstr reqmst, ArrayList<WdqqStwd> list) throws Exception;

	/** @param reqmst
	/** @param list
	/** @return insomnia
	 * @throws Exception */
	int delStndWordRqstList(WaqMstr reqmst, ArrayList<WdqqStwd> list) throws Exception;

	/** @param reqmst
	/** @param list
	/** @return insomnia */
	int regapprove(WaqMstr reqmst, List<WdqqStwd> list); 
