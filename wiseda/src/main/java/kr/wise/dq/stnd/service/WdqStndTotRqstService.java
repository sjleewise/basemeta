 ...
 * </PRE>
 */
public interface WdqStndTotRqstService extends CommonRqstService {

	//int approveTot(WaqMstr reqmst, List<WdqqSditm> lstSditm, List<WdqqDmn> lstDmn, List<WdqqStwd> lstWord) throws Exception;

	int aprvStndTot(WaqMstr reqmst, List<WdqqSditm> lstSditm,
			List<WdqqDmn> lstDmn, List<WdqqStwd> lstWord) throws Exception;  		 
