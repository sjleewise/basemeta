...
@Mapper
public interface WdqqCdValMapper extends CommonRqstMapper{
	int deleteByPrimaryKey(WdqqCdVal record);
    ...
    int insert(WdqqCdVal record);

    int insertSelective(WdqqCdVal record);

    WdqqCdVal selectByPrimaryKey(@Param("rqstNo") String rqstNo, @Param("rqstSno") Integer rqstSno, @Param("rqstDtlSno") Integer rqstDtlSno);

    int updateByPrimaryKeySelective(WdqqCdVal record);

    int updateByPrimaryKey(WdqqCdVal record);

	/** @param search
	/** @return insomnia */
	List<WdqqCdVal> selectCdvalRqstVal(WaqMstr search);
    ...
    /** @param rqstno
	/** @return insomnia */
	List<WdqqCdVal> selectWaqC(@Param("rqstNo") String rqstNo);

	/** @param savevo insomnia */
	int updateidByKey(WdqqCdVal savevo);
	...
	/** @param wamlist
	/** @return insomnia */
	int insertwam2waq(@Param("reqmst") WaqMstr reqmst, @Param("list") ArrayList<WdqqDmn> wamlist);

	/** @param saveVo insomnia */
	int insertByDmnSno(WdqqDmn saveVo);
