...
@Controller
@RequestMapping("/dq/govstnd/*")
public class DqGovSditmCtrl {

	private final Logger logger = LoggerFactory.getLogger(getClass());
	
	@Inject
	private DqGovSditmService govSditmService;
	...
	static class GovSditms extends HashMap<String, ArrayList<DqGovSditm>> {}
...
//		codeMap.put("sysareaOwner", UtilJson.convertJsonString(sysareaOwner));
	...
	public String goStndDiagSditmList(Model model) throws Exception {
		...
		return "/dq/govstnd/diag_sditm_lst";
	}

	/** 진단 표준용어 조회 -IBSheet json */
	@RequestMapping("/dq/govstnd/getdiagSditmList.do")
	@ResponseBody
	public IBSheetListVO<DqGovSditm> getdiagSditmList(@ModelAttribute DqGovSditm data, Locale locale) {
		logger.debug("****************************************");
		logger.debug("data:{}", data);
		logger.debug("data:{}", data.getDbSchId());
		
		List<DqGovSditm> list = govSditmService.getdiagSditmList(data);

		return new IBSheetListVO<DqGovSditm>(list, list.size());
	}
	...
	@RequestMapping("/dq/govstnd/addDiagSditmList.do")
	@ResponseBody
	public IBSResultVO<DqGovSditm> addDiagSditmList(@RequestBody GovSditms data, HttpSession session, Locale locale) throws Exception {

		logger.debug("data:{}", data);

		ArrayList<DqGovSditm> list = data.get("data");
...
//		int result = stndWordRqstService.regStndWordRqstlist(list);
		...
		return new IBSResultVO<DqGovSditm>(result, resmsg, action);
	}
	 ...
	 * 
	 */
	@RequestMapping("/dq/govstnd/deleteDiagSditmList.do")
	@ResponseBody
	public IBSResultVO<DqGovSditm> deleteDiagSditmList(WaqMstr reqmst, @RequestBody GovSditms data, Locale locale) throws Exception {
...
//	}
	...
	@RequestMapping("/dq/govstnd/autoCreStnd.do")
	@ResponseBody
