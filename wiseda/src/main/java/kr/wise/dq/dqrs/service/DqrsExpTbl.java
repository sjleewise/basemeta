...
public class DqrsExpTbl extends CommonVo{
...
//	private String bYn;
	...
	private String colRmkYn;
	
	private String anaStsCd;
	
	private String addCndYn;
	
	private String tblCntn;

    
	
	public String getTblCntn() {
		return tblCntn;
	}


	public void setTblCntn(String tblCntn) {
		this.tblCntn = tblCntn;
	}


	public String getAddCndYn() {
		return addCndYn;
	}


	public void setAddCndYn(String addCndYn) {
		this.addCndYn = addCndYn;
	}
	...
	public String getColRmkYn() {
		return colRmkYn;
	}


	public void setColRmkYn(String colRmkYn) {
		this.colRmkYn = colRmkYn;
	}
...
//	}
	...
	public String toString() {
		return "WaaExpTbl [dbConnTrgId=" + dbConnTrgId + ", dbConnTrgPnm=" + dbConnTrgPnm + ", dbConnTrgLnm="
				+ dbConnTrgLnm + ", dbSchId=" + dbSchId + ", dbSchPnm=" + dbSchPnm + ", dbSchLnm=" + dbSchLnm
				+ ", dbcTblNm=" + dbcTblNm + ", dbcTblKorNm=" + dbcTblKorNm + ", expYn=" + expYn + ", expRsnCntn="
				+ expRsnCntn + ", updtDtm=" + updtDtm + ", dbcColNm=" + dbcColNm + ", dbcColKorNm=" + dbcColKorNm
				+ ", ruleRelId=" + ruleRelId + ", regYn=" + regYn + ", vrfcTyp=" + vrfcTyp + ", addCnd=" + addCnd
				+ ", anaYn=" + anaYn + ", logSearch=" + logSearch + ", excStndRule=" + excStndRule + ", expRuleId="
				+ expRuleId + ", relation=" + relation + ", regTyp=" + regTyp + ", selectNm=" + selectNm
				+ ", selectCol=" + selectCol + ", dataType=" + dataType + ""
//						+ ", fYn=" + fYn + ", bYn=" + bYn 
						+ "]";
	}
