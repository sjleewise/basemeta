...
public class WaqBrCtqMap {
    private String rqstNo;

    private String rqstSno;
    ...
    public String getRqstSno() {
        return rqstSno;
    }

    public void setRqstSno(String rqstSno) {
    ...
    public String getObjVers() {
        return objVers;
    }

    public void setObjVers(String objVers) {
    ...
    public String getFrsRqstDtm() {
        return frsRqstDtm;
    }

    public void setFrsRqstDtm(String frsRqstDtm) {
