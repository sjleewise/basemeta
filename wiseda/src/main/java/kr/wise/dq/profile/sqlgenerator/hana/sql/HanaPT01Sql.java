...
public class HanaPT01Sql {
	...
	public HanaPT01Sql(Map<String, Object> sqlGenMap){
...
//	 			strQuery4.append("\n    AND P."+vo.getPaTblDbcColNm()+" IS NULL  ");
	...
	//에러건수
		...
		public String getErrorDataSql() 
		{
			...
			strQuery.append(" SELECT C." + chTblDbcColNm);
