...
public class PostPT01Sql {
	...
	public PostPT01Sql(Map<String, Object> sqlGenMap){
	...
	public String getTotalCountSql() 
	{
		...
		strQuery.append("\n   FROM "+chDbcTblNm ); 
		strQuery.append("\n  WHERE 1 = 1 ");
		if(chAdtCndSql != null && !chAdtCndSql.isEmpty())
		{
			strQuery.append("\n    AND "+chAdtCndSql );   
		}
...
//			strQuery.append(" SELECT " + chTblDbcColNm);
		...
		public String getRelColSql() 
		{
			...
			strQuery.append("\n           FROM " + chDbcTblNm );
			strQuery.append("\n          WHERE 1 = 1 "  );
			if(null != chAdtCndSql && !chAdtCndSql.isEmpty())
			{
				strQuery.append("\n            AND "+chAdtCndSql );   
			}
			strQuery.append("\n         ) C ");
			...
			strQuery.append("\n                            FROM "+ paDbcTblNm );
			strQuery.append("\n                           WHERE 1 = 1 " );
			if(null != paTblAdtCndSql && !paTblAdtCndSql.isEmpty())
			{
				strQuery.append("\n                             AND "+paTblAdtCndSql );   
			}
			strQuery.append("\n                          ) P  ");
