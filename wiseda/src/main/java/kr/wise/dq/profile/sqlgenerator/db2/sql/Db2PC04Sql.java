...
public class Db2PC04Sql {
	...
	public Db2PC04Sql(Map<String, Object> sqlGenMap){
...
//		this.dbcTblNm = prfMstrVO.getDbcTblNm();
	...
	public String getRangeSql(){
		...
		//데이터타입이 CHAR형인경우 따옴표를 붙이고, 아닌 경우는 안붙임
		//연결자 데이터가 있는 경우 두번째 범위유효값을 붙이고, 아닌 경우는 안붙임
		if(null != prfDtlVO.getRngCnc()){
			if(UtilString.null2Blank(prfMstrVO.getDataType()).contains("CHAR")){
