...
public class CubridPC05Sql {
	...
	public CubridPC05Sql(Map<String, Object> sqlGenMap){
	...
	public String getErrorValidPatternCondSql()  {
		...
		strQuery.append("\n           FROM (SELECT "+dbcColNm );
		strQuery.append("\n                        ,TRAN_DATA1 ");
		strQuery.append("\n                        ,NVL(NULLIF(REPLACE(TRANSLATE(TRAN_DATA1,'"+G_TRANS_STRING+"', LPAD(' ', "+G_TRANS_STRING.length()+",' ')), ' ', ''),''),'C') AS TRAN_DATA2 ");
		strQuery.append("\n                        ,LENGTH(NVL(NULLIF((REPLACE(TRANSLATE(TRAN_DATA1,'"+G_TRANS_STRING+"', LPAD(' ', "+G_TRANS_STRING.length()+",' ')), ' ', ''),'')'C')) AS TRAN_DATA2_LENGTH ");
		strQuery.append("\n                   FROM (SELECT "+dbcColNm);
