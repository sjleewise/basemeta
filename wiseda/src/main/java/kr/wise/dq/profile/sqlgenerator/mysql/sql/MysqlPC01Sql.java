...
public class MysqlPC01Sql {
	...
	//일자여부 
		...
		{		
			...
			sb.append("\n                             FROM " + dbcTblNm + "                                                                               ");
			sb.append("\n                            WHERE " + dbcColNm + " IS NOT NULL                                                                   ");
			sb.append("\n                              AND LENGTH(TRIM(" + dbcColNm + ")) >= 2)  aaa                                                      ");
			sb.append("\n                          )            ELSE 'N'                                                                                  ");
			sb.append("\n             END AS DATE_YN                                                                                                      ");
//			sb.append("\n    FROM DUAL                                                                                                    ");
...
//			sb.append("\n 	  FROM DUAL                                                                                                ");
		...
		{		
			...
			sb.append("\n 		           FROM (SELECT REPLACE(" + dbcColNm + ",'0123456789abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ~`!@#$%^&*()_-+=|{}[]:;?/<>,.|\" '  ,'9999999999aaaaaaaaaaaaaaaaaaaaaaaaaaAAAAAAAAAAAAAAAAAAAAAAAAAA~`!@#$%^&*()_-+=|{}[]:;?/<>,.|\"B') AS TRAN_DATA1 ");                            
			sb.append("\n 		                   FROM " + dbcTblNm + "                                                                            ");
			sb.append("\n 		                  WHERE " + dbcColNm + " IS NOT NULL) aaa                                                          ");
//			sb.append("\n 		          WHERE ROWNUM = 1                                                                                    ");
			sb.append("\n 		          LIMIT 1                                                                                    ");
...
//			sb.append("\n 		           FROM (SELECT CASE WHEN SUBSTR(LTRIM(TO_CHAR(" + dbcColNm + ")),-3) = '000' THEN 1 ELSE 0 END AS NUM_CNT ");
...
//			sb.append("\n 	FROM DUAL                                                                     ");
			...
			sb.append("\n 		         SELECT STDDEV(case when '" + dataType + "' in ('smallint', 'int', 'bigint', 'real', 'double precision', 'numeric', 'integer') then " + dbcColNm + " else '0' end) AS STDDEV_VAL   ");            
			sb.append("\n 		           FROM " + dbcTblNm + "                                  ");
			sb.append("\n 		          WHERE " + dbcColNm + " IS NOT NULL                      ");
			sb.append("\n 		            AND REGEXP_REPLACE(OBJ_VERS, '[0-9]', '') = ''   ");
...
//			sb.append("\n 	FROM DUAL                                                                     ");
			...
			sb.append("\n 		         SELECT VARIANCE(case when '" + dataType + "' in ('smallint', 'int', 'bigint', 'real', 'double precision', 'numeric', 'integer') then " + dbcColNm + " else '0' end) AS VARIANCE_VAL  ");            
			sb.append("\n 		           FROM " + dbcTblNm + "                                  ");
			sb.append("\n 		          WHERE " + dbcColNm + " IS NOT NULL                      ");
			sb.append("\n 		            AND REGEXP_REPLACE(OBJ_VERS, '[0-9]', '') = ''   ");
...
//			sb.append("\n 	FROM DUAL                                                                     ");
			...
			sb.append("\n 		         SELECT AVG(case when '" + dataType + "' in ('smallint', 'int', 'bigint', 'real', 'double precision', 'numeric', 'integer') then " + dbcColNm + " else '0' end) AS AVG_VAL   ");            
			sb.append("\n 		           FROM " + dbcTblNm + "                                  ");
			sb.append("\n 		          WHERE " + dbcColNm + " IS NOT NULL                      ");
			sb.append("\n 		            AND REGEXP_REPLACE(OBJ_VERS, '[0-9]', '') = ''   ");
