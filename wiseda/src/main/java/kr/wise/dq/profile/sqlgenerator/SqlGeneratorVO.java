...
public class SqlGeneratorVO implements Serializable
{
	...
	public String datePatSql;
	public String userPatSql;
	...
	//표준편차
	private String stddevValSql;
	//분산
	private String varianceValSql;
	//평균
	private String avgValSql;
	//유일값수
	private String unqCntSql;
	//최소빈도값
	private String minCntValSql;
	//최대빈도값
	private String maxCntValSql;
	
	public String getStddevValSql() {
		return stddevValSql;
	}
	public void setStddevValSql(String stddevValSql) {
		this.stddevValSql = stddevValSql;
	}
	public String getVarianceValSql() {
		return varianceValSql;
	}
	public void setVarianceValSql(String varianceValSql) {
		this.varianceValSql = varianceValSql;
	}
	public String getAvgValSql() {
		return avgValSql;
	}
	public void setAvgValSql(String avgValSql) {
		this.avgValSql = avgValSql;
	}
	public String getUnqCntSql() {
		return unqCntSql;
	}
	public void setUnqCntSql(String unqCntSql) {
		this.unqCntSql = unqCntSql;
	}
	public String getMinCntValSql() {
		return minCntValSql;
	}
	public void setMinCntValSql(String minCntValSql) {
		this.minCntValSql = minCntValSql;
	}
	public String getMaxCntValSql() {
		return maxCntValSql;
	}
	public void setMaxCntValSql(String maxCntValSql) {
		this.maxCntValSql = maxCntValSql;
	}
