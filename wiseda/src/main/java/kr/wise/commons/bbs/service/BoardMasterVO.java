...
public class BoardMasterVO extends BoardMaster implements Serializable {
	...
	builder.append("BoardMasterVO [searchBgnDe=").append(searchBgnDe)
			...
			.append(", frstRegisterNm=").append(frstRegisterNm)
			.append(", bbsTyCodeNm=").append(bbsTyCodeNm)
			.append(", bbsAttrbCodeNm=").append(bbsAttrbCodeNm)
			.append(", tmplatNm=").append(tmplatNm)
			.append(", lastUpdusrNm=").append(lastUpdusrNm)
			.append(", authFlag=").append(authFlag)
			.append(", tmplatCours=").append(tmplatCours)
			.append(", tmplatId=").append(tmplatId)
			.append(", posblAtchFileNumber=").append(posblAtchFileNumber)
