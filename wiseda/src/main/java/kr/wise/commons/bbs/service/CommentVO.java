...
public class CommentVO extends Comment {
    ...
    /** 전체 페이지 개수 */
    private int subTotalPageCount = 0;
    
    /** 전체 레코드 개수 */
    private int subTotalRecordCount = 0;
	...
	public int getSubTotalPageCount() {
		return subTotalPageCount;
	}

	public void setSubTotalPageCount(int subTotalPageCount) {
		this.subTotalPageCount = subTotalPageCount;
	}

	public int getSubTotalRecordCount() {
		return subTotalRecordCount;
	}

	public void setSubTotalRecordCount(int subTotalRecordCount) {
		this.subTotalRecordCount = subTotalRecordCount;
	}
