...
public class WahShdMstr {
    ...
    public Date getStaDtm() {
        return staDtm;
    }

    public void setStaDtm(Date staDtm) {
        this.staDtm = staDtm;
    }
    ...
    public Date getShdStrDtm() {
        return shdStrDtm;
    }

    public void setShdStrDtm(Date shdStrDtm) {
