 ...
 * </PRE>
 */
public interface DbSynonymAuthService {

	/** @param search
	/** @return yeonho */
	List<WaaDbSynonym> getDbSynonymAuthList(WaaDbSynonym search);

	/** @param list
	/** @return yeonho 
	 * @throws Exception */
	int regDbSynonymAuthList(ArrayList<WaaDbSynonym> list) throws Exception;

	/** @param list
	/** @return yeonho */
	int delDbSynonymAuthList(ArrayList<WaaDbSynonym> list);
