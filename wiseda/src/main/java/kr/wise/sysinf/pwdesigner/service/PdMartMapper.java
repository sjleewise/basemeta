 ...
 */
package kr.wise.sysinf.pwdesigner.service;
...
public interface PdMartMapper {
	...
	/** @param saveVo
	/** @return insomnia */
	List<WaqPdmCol> selectPdColListbyTblId(WaqPdmTbl saveVo);
	
	//ermart7 
	List<WaqPrfRelColVO> selectPdMartRelLst(WaqPrfRelColVO search);
