 ...
 * </PRE>
 */
public class DomainClassNstndCallableImpl extends DomainClassNstnd implements Callable<Boolean> {

	/** insomnia */
	public DomainClassNstndCallableImpl(String logId, ExecutorDM executorDM) {
