 ...
 * <PRE>
 * 1. ClassName :
 * 2. FileName  : CollectorMysqlV5.java
 ...
 * </PRE>
 */
public class CollectorMysqlV5 implements CollectorMysqlService {

	private static final Logger logger = Logger.getLogger(CollectorMysqlV5.class);
	...
	public CollectorMysqlV5() {

	}

	public CollectorMysqlV5(Connection source, Connection target, List<TargetDbmsDM> lsitdm) {
		this.con_org = source;
		this.con_tgt = target;
