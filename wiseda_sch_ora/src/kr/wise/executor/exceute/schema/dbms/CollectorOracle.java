 ...
 * </PRE>
 */
public class CollectorOracle {

	private static final Logger logger = Logger.getLogger(CollectorOracle.class);
	...
	public CollectorOracle() {

	}

	/** insomnia */
	public CollectorOracle(Connection source, Connection target,	List<TargetDbmsDM> lsitdm) {
		this.con_org = source;
		this.con_tgt = target;
...
//		this.dbName = targetDb.getDbms_enm();
	...
	public boolean doProcess() throws Exception {
		...
		for (TargetDbmsDM targetDb : targetDblist) {
			...
			//DBA_OBJECTS ---------------------------------------------------
//			cnt = insertDBA_SEQUENCE();
//			logger.debug(sp + (++p) + ". insertDBA_SEQUENCE " + cnt + " OK!!");
				...
				if( cnt > 0 ) {
					...
					try {
						if(resultSet.next()){
							...
							//레파지토리가 티베로일때
//							TbClob clob = (TbClob)resultSet.getObject("TEXT");
...
//			                src = new CharArrayReader(strText.toCharArray());
	...
	private int insertDBA_INDEXES() throws SQLException
	{
		...
		sb.append("\n      ,A.FUNCIDX_STATUS                      ");
		sb.append("\n      ,B.CREATED           "); //생성 시간
		sb.append("\n      ,B.LAST_DDL_TIME     "); //최종변경 시간
		sb.append("\n   FROM DBA_INDEXES A                       ");
		sb.append("\n        LEFT OUTER JOIN DBA_OBJECTS B   ");
		sb.append("\n          ON A.OWNER = B.OWNER   ");
		...
		if( rs != null ) {
			...
			while(rs.next())
			{
				...
				pst_org.setTimestamp(rsGetCnt++, rs.getTimestamp("CREATED"));
				pst_org.setTimestamp(rsGetCnt++, rs.getTimestamp("LAST_DDL_TIME"));
...
//System.out.println(sb.toString());
	...
	private int insertDBA_TAB_COLUMNS() throws SQLException
	{
		...
		if(dbmsVersion.equals("")) {
			...
			sb.append("\n         ,A.TABLE_NAME                                               ");
			sb.append("\n         ,A.COLUMN_NAME                                              ");
			sb.append("\n         ,SUBSTR(C.COMMENTS,1,4000) AS COMMENTS                                                 ");
			sb.append("\n         ,A.DATA_TYPE                                                ");
			sb.append("\n         ,DATA_TYPE_MOD                                              ");
			sb.append("\n         ,DATA_TYPE_OWNER                                            ");
...
//				pst_org.setBigDecimal(rsGetCnt++, rs.getBigDecimal("USER_ID"));
	...
	private int insertDBA_SEQUENCE() throws Exception {
		StringBuffer sb = new StringBuffer();
		sb.append("\n SELECT                               ");
		sb.append("\n --,데이터베이스명                    ");
		sb.append("\n      '").append(dbName).append("' AS OF_DATABASE");
		...
		sb.append("\n     ,LAST_NUMBER                     ");
		sb.append("\n  FROM DBA_SEQUENCES                  ");
		sb.append("\n WHERE SEQUENCE_OWNER = '").append(schemaName).append("'");

		getResultSet(sb.toString());
		sb.setLength(0);

		sb.append("\nINSERT INTO WAE_ORA_SEQ (       ");
		sb.append("\n  DB_NM                         ");
		sb.append("\n ,SCH_NM                        ");
		sb.append("\n ,DB_SCH_ID                     ");
		sb.append("\n ,SEQUENCE_NAME                 ");
		...
		if( rs != null ) {
			...
			{
				pst_org.setString(rsGetCnt++, dbName);
				pst_org.setString(rsGetCnt++, rs.getString("SEQUENCE_OWNER"));
				pst_org.setString(rsGetCnt++, schemaId);
				pst_org.setString(rsGetCnt++, rs.getString("SEQUENCE_NAME"));
				pst_org.setBigDecimal(rsGetCnt++, rs.getBigDecimal("MIN_VALUE"));
				pst_org.setBigDecimal(rsGetCnt++, rs.getBigDecimal("MAX_VALUE"));
				pst_org.setBigDecimal(rsGetCnt++, rs.getBigDecimal("INCREMENT_BY"));
				pst_org.setString(rsGetCnt++, rs.getString("CYCLE_FLAG"));
				pst_org.setString(rsGetCnt++, rs.getString("ORDER_FLAG"));
				pst_org.setBigDecimal(rsGetCnt++, rs.getBigDecimal("CACHE_SIZE"));
				pst_org.setBigDecimal(rsGetCnt++, rs.getBigDecimal("LAST_NUMBER"));
...
//		strSQL.append("\n     AND SCH_NM = '"+schemaName+"' ");
		...
		strSQL.setLength(0);
		strSQL.append("\n  DELETE FROM WAE_ORA_OBJ ");
		strSQL.append("\n   WHERE DB_NM = '"+dbName+"' ");
//		strSQL.append("\n     AND SCH_NM = '"+schemaName+"' ");

		result = setExecuteUpdate_Org(strSQL.toString());
		logger.debug("delete WAE_ORA_OBJ : " + result);
...
//		strSQL.append("\n     AND SCH_NM = '"+schemaName+"' ");
		...
		strSQL.setLength(0);
		strSQL.append("\n  DELETE FROM WAE_ORA_OBJ_SRC ");
		strSQL.append("\n   WHERE DB_NM = '"+dbName+"' ");
//		strSQL.append("\n     AND SCH_NM = '"+schemaName+"' ");

		result = setExecuteUpdate_Org(strSQL.toString());
		logger.debug("delete WAE_ORA_OBJ_SRC : " + result);

		strSQL.setLength(0);
		strSQL.append("\n  DELETE FROM WAE_ORA_VIEW ");
		strSQL.append("\n   WHERE DB_NM = '"+dbName+"' ");
//		strSQL.append("\n     AND SCH_NM = '"+schemaName+"' ");

		result = setExecuteUpdate_Org(strSQL.toString());
		logger.debug("delete WAE_ORA_VIEW : " + result);

		strSQL.setLength(0);
		strSQL.append("\n  DELETE FROM WAE_ORA_SEG ");
		strSQL.append("\n   WHERE DB_NM = '"+dbName+"' ");
//		strSQL.append("\n     AND SCH_NM = '"+schemaName+"' ");

		result = setExecuteUpdate_Org(strSQL.toString());
		logger.debug("delete WAE_ORA_SEG : " + result);

		strSQL.setLength(0);
		strSQL.append("\n  DELETE FROM WAE_ORA_SCH ");
		strSQL.append("\n   WHERE DB_NM = '"+dbName+"' ");
//		strSQL.append("\n     AND SCH_NM = '"+schemaName+"' ");

		result = setExecuteUpdate_Org(strSQL.toString());
		logger.debug("delete WAE_ORA_SCH : " + result);

		strSQL.setLength(0);
		strSQL.append("\n  DELETE FROM WAE_ORA_IDX ");
		strSQL.append("\n   WHERE DB_NM = '"+dbName+"' ");
//		strSQL.append("\n     AND SCH_NM = '"+schemaName+"' ");

		result = setExecuteUpdate_Org(strSQL.toString());
		logger.debug("delete WAE_ORA_IDX : " + result);

		strSQL.setLength(0);
		strSQL.append("\n  DELETE FROM WAE_ORA_IDX_COL ");
		strSQL.append("\n   WHERE DB_NM = '"+dbName+"' ");
//		strSQL.append("\n     AND SCH_NM = '"+schemaName+"' ");

		result = setExecuteUpdate_Org(strSQL.toString());
		logger.debug("delete WAE_ORA_IDX_COL : " + result);
...
//		strSQL.append("\n     AND SCH_NM = '"+schemaName+"' ");
		...
		strSQL.setLength(0);
		strSQL.append("\n  DELETE FROM WAE_ORA_TBL_SPAC ");
		strSQL.append("\n   WHERE DB_NM = '"+dbName+"' ");
//		strSQL.append("\n     AND SCH_NM = '"+schemaName+"' ");

		result = setExecuteUpdate_Org(strSQL.toString());
		logger.debug("delete WAE_ORA_TBL_SPAC : " + result);

	    strSQL.setLength(0);
	    strSQL.append("\n  DELETE FROM WAE_ORA_DEPENDENCIES ");
	    strSQL.append("\n   WHERE DB_NM = '" + this.dbName + "' ");

	    result = setExecuteUpdate_Org(strSQL.toString());
	    logger.debug("delete WAE_ORA_DEPENDENCIES : " + result);
	    

	    strSQL.setLength(0);
	    strSQL.append("\n  DELETE FROM WAE_ORA_SEQ ");
	    strSQL.append("\n   WHERE DB_NM = '" + this.dbName + "' ");

	    result = setExecuteUpdate_Org(strSQL.toString());
	    logger.debug("delete WAE_ORA_SEQ : " + result);
	...
	public boolean saveWat(TargetDbmsDM targetDb) throws Exception {
		...
		//WAT_DEPENDENCIES
		cnt = insertwatdependencies();
	    logger.debug("insertwatdependencies : " + cnt + " OK!!");
	    
		//WAT_SEQUENCES
		cnt = insertwatseq();
	    logger.debug("insertwatseq : " + cnt + " OK!!");
...
//		String tdbnm = targetDbmsDM.getDbms_enm();
		...
		sb.append("\n      , ''                  "); //DDL_IDX_ID
		sb.append("\n      , ''                  "); //PDM_IDX_ID
		sb.append("\n      , CASE WHEN D.CNST_TYPE = 'P' THEN 'Y' ELSE 'N' END PK_YN  "); //PK_YN
		sb.append("\n      , CASE WHEN D.CNST_TYPE = 'U' THEN 'Y' ELSE 'N' END PK_YN  "); //UQ_YN
		sb.append("\n      , E.COL_CNT           "); //COL_EACNT
		sb.append("\n      , C.BYTES AS IDX_SIZE "); //IDX_SIZE
		sb.append("\n      , ''  AS BF_IDX_EACNT "); //BF_IDX_EACNT
		sb.append("\n      , ''  AS BF_IDX_SIZE  "); //BF_IDX_SIZE
		sb.append("\n      , LAST_ANALYZED  AS ANA_DTM      "); //ANA_DTM
		sb.append("\n      , CREATED  AS CRT_DTM      "); //CRT_DTM
		sb.append("\n      , LAST_DDL_TIME  AS CHG_DTM      "); //CHG_DTM
		sb.append("\n      , '' AS IDX_DQ_EXP_YN    ");
		sb.append("\n      , '' AS SGMT_BYTE_SIZE   ");
...
//		String tdbnm = targetDbmsDM.getDbms_enm();
	...
	private int insertwatdependencies() throws Exception  {
		StringBuffer sb = new StringBuffer();
		sb.append("\n INSERT INTO WAT_DBC_DEPENDENCIES           ");
		sb.append("\n SELECT S.DB_CONN_TRG_ID  AS DB_CONN_TRG_ID       ");
		sb.append("\n        ,S.DB_SCH_ID   AS DB_SCH_ID    ");
		sb.append("\n        ,A.DB_NM                ");     
		sb.append("\n        ,A.SCH_NM               ");
		sb.append("\n        ,A.NAME                 ");
		sb.append("\n        ,A.TYPE                 ");
		...
		sb.append("\n        ,A.DEPENDENCY_TYPE      ");
		sb.append("\n   FROM WAE_ORA_DEPENDENCIES A      ");
		sb.append("\n  INNER JOIN (             ");
		sb.append(getdbconnsql());
		sb.append("\n  ) S                      ");
		sb.append("\n     ON A.DB_NM = S.DB_CONN_TRG_PNM   ");
		sb.append("\n    AND A.SCH_NM = S.DB_SCH_PNM       ");
		sb.append("\n  WHERE A.DB_NM = '" + this.dbName + "'  ");
	  
		return setExecuteUpdate_Org(sb.toString());
  }

	private int insertwatseq() throws Exception {
		StringBuffer sb = new StringBuffer();
	...
	/**
	 * DBC DBA_DEPENDENCIES 저장
	 * @return int 수행결과 건수
	 * @throws SQLException
	 */
	  private int insertDBA_DEPENDENCIES()
	    throws Exception
	  {
	    StringBuffer sb = new StringBuffer();
	    sb.append("\nSELECT OWNER   ");
	    ...
	    sb.append("\n WHERE NVL(OWNER, '_') = '").append(this.schemaName).append("'");
...
//	    logger.error(sb.toString());
	    ...
	    sb.append("\nINSERT INTO WAE_ORA_DEPENDENCIES (");
	    sb.append("\n   DB_NM      ");
	    sb.append("\n  ,SCH_NM     ");
	    sb.append("\n  ,NAME       ");
	    sb.append("\n  ,TYPE       ");
	    ...
	    int cnt = 0;
	    if (this.rs != null) {
	      this.pst_org = this.con_org.prepareStatement(sb.toString());
	      ...
	      while (this.rs.next())
	      {
	        this.pst_org.setString(rsGetCnt++, this.dbName);
//	        this.pst_org.setString(rsGetCnt++, this.schemaName);
	        this.pst_org.setString(rsGetCnt++, this.rs.getString("OWNER") == null ? this.schemaName : this.rs.getString("OWNER") );
	        this.pst_org.setString(rsGetCnt++, this.rs.getString("NAME"));
	        this.pst_org.setString(rsGetCnt++, this.rs.getString("TYPE"));
	        this.pst_org.setString(rsGetCnt++, this.rs.getString("REFERENCED_OWNER"));
	        this.pst_org.setString(rsGetCnt++, this.rs.getString("REFERENCED_NAME"));
	        this.pst_org.setString(rsGetCnt++, this.rs.getString("REFERENCED_TYPE"));
	        this.pst_org.setString(rsGetCnt++, this.rs.getString("REFERENCED_LINK_NAME"));
	        this.pst_org.setString(rsGetCnt++, this.rs.getString("DEPENDENCY_TYPE"));
