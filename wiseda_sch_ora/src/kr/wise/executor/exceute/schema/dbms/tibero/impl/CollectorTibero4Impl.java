 ...
 * <PRE>
 * 1. ClassName :
 * 2. FileName  : CollectorTibero4Impl.java
 ...
 * </PRE>
 */
public class CollectorTibero4Impl implements CollectorTiberoService {

	private static final Logger logger = Logger.getLogger(CollectorTibero4Impl.class);
	...
	public CollectorTibero4Impl() {

	}

	public CollectorTibero4Impl(Connection source, Connection target, List<TargetDbmsDM> lsitdm) {
		this.con_org = source;
		this.con_tgt = target;
	...
	private int insertDBA_TABLES() throws SQLException {
		...
		sb.append("\n      , A.LAST_ANALYZED                   ");
		sb.append("\n      , A.PARTITIONED                     ");
		sb.append("\n      , '' AS IOT_TYPE                    "); // TIBERO4 없는 컬럼 A.IOT_TYPE
		sb.append("\n      , A.TEMPORARY                       ");
		sb.append("\n      , A.BUFFER_POOL                     ");
		sb.append("\n      , A.ROW_MOVEMENT                    ");
		sb.append("\n      , A.DURATION                        ");
