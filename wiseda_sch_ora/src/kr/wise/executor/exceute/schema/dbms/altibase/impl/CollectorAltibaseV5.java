 ...
 * <PRE>
 * 1. ClassName :
 * 2. FileName  : CollectorAltibaseV5.java
 ...
 * </PRE>
 */
public class CollectorAltibaseV5 implements CollectorAltibaseService{

	private static final Logger logger = Logger.getLogger(CollectorAltibaseV5.class);
	...
	public CollectorAltibaseV5() {

	}

	public CollectorAltibaseV5(Connection source, Connection target,	List<TargetDbmsDM> lsitdm) {
		this.con_org = source;
		this.con_tgt = target;
	...
	private int insertDBA_TABLES() throws SQLException {
		...
		StringBuffer sb = new StringBuffer();
  		...
  		sb.append("\n ) VALUES (                      ");
  		sb.append("\n ?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,            ");
  		sb.append("\n ?,TO_CHAR(?,'YYYY-MM-DD HH24:MI:SS'),TO_CHAR(?,'YYYY-MM-DD HH24:MI:SS'),?,?,? ");
  		sb.append("\n ) ");
