 ...
 * </PRE>
 */
public class PythonExecuteCallableImpl extends PythonExecute implements Callable<Boolean> {

	/** insomnia */
	public PythonExecuteCallableImpl(String logId, ExecutorDM executorDM) {
