 ...
 * </PRE>
 */
public class PythonTMExecuteCallableImpl extends PythonTMExecute implements Callable<Boolean> {

	/** insomnia */
	public PythonTMExecuteCallableImpl(String logId, ExecutorDM executorDM) {
