 ...
 * </PRE>
 */
public class PythonTMExecuteRunnableImpl extends PythonTMExecute implements Runnable {

	/** insomnia */
	public PythonTMExecuteRunnableImpl(String logId, ExecutorDM executorDM) {
