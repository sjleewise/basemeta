 ...
 * </PRE>
 */
public class PythonTCExecuteRunnableImpl extends PythonTCExecute implements Runnable {

	/** insomnia */
	public PythonTCExecuteRunnableImpl(String logId, ExecutorDM executorDM) {
