 ...
 * </PRE>
 */
public class PythonTCExecuteCallableImpl extends PythonTCExecute implements Callable<Boolean> {

	/** insomnia */
	public PythonTCExecuteCallableImpl(String logId, ExecutorDM executorDM) {
