 ...
 * </PRE>
 */
public class PythonSMExecuteCallableImpl extends PythonSMExecute implements Callable<Boolean> {

	/** insomnia */
	public PythonSMExecuteCallableImpl(String logId, ExecutorDM executorDM) {
