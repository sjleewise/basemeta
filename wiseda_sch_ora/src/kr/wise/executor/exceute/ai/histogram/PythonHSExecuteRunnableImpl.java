 ...
 * </PRE>
 */
public class PythonHSExecuteRunnableImpl extends PythonHSExecute implements Runnable {

	/** insomnia */
	public PythonHSExecuteRunnableImpl(String logId, ExecutorDM executorDM) {
