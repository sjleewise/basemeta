 ...
 * </PRE>
 */
public class PythonUOExecuteCallableImpl extends PythonUOExecute implements Callable<Boolean> {

	/** insomnia */
	public PythonUOExecuteCallableImpl(String logId, ExecutorDM executorDM) {
