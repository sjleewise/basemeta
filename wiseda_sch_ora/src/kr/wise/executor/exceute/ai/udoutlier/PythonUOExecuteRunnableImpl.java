 ...
 * </PRE>
 */
public class PythonUOExecuteRunnableImpl extends PythonUOExecute implements Runnable {

	/** insomnia */
	public PythonUOExecuteRunnableImpl(String logId, ExecutorDM executorDM) {
