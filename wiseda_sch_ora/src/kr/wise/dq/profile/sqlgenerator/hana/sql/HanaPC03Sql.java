...
public class HanaPC03Sql {
	...
	public HanaPC03Sql(Map<String, Object> sqlGenMap){
	...
	public String getErrorCountDateValidCondSql_YYYYMMDDHH24MISS() {
		...
		.append("\n     	THEN CASE WHEN SUBSTRING(" + dbcColNm + ",9,2) BETWEEN '00' AND '24'  ")
	...
	public String getErrorCountDateValidCondSql_YYYY_MM_DD_HH24MI() {
		...
		.append("\n		AND SUBSTRING(" + dbcColNm + " , 2,1) BETWEEN '0' AND '9'  ")
		.append("\n		AND SUBSTRING(" + dbcColNm + ", 3,1) BETWEEN '0' AND '9'  ")
		.append("\n		AND SUBSTRING(" + dbcColNm + ", 4,1) BETWEEN '0' AND '9'  ")	//년
		.append("\n		AND SUBSTRING(" + dbcColNm + ", 5,1) = '-'  ")
		.append("\n		AND SUBSTRING(" + dbcColNm + ", 6,1) BETWEEN '0' AND '9'  ")
		.append("\n		AND SUBSTRING(" + dbcColNm + ", 7,1) BETWEEN '0' AND '9'  ")	//월
		.append("\n		AND SUBSTRING(" + dbcColNm + ", 8,1) = '-'  ")
		.append("\n		AND SUBSTRING(" + dbcColNm + ", 9,1) BETWEEN '0' AND '9'  ")
		.append("\n		AND SUBSTRING(" + dbcColNm + ", 10,1) BETWEEN '0' AND '9'  ")	//일
		.append("\n		AND SUBSTRING(" + dbcColNm + ", 11,1) = ' '  ")
		.append("\n		AND SUBSTRING(" + dbcColNm + ", 12,1) BETWEEN '0' AND '9'  ")
		.append("\n		AND SUBSTRING(" + dbcColNm + ", 13,1) BETWEEN '0' AND '9'  ")	//시
		.append("\n		AND SUBSTRING(" + dbcColNm + ", 14,1) BETWEEN '0' AND '9'  ")
		.append("\n		AND SUBSTRING(" + dbcColNm + ", 15,1) BETWEEN '0' AND '9'  ")	//분
		.append("\n     	THEN CASE WHEN SUBSTRING(" + dbcColNm + ",12,2) BETWEEN '00' AND '24'  ")
		.append("\n	      		  	  THEN CASE WHEN SUBSTRING(" + dbcColNm + ",14,2) BETWEEN '00' AND '59'  ")
		.append("\n	      			                      THEN   ")
										.append("\n      		 CASE WHEN SUBSTRING(" + dbcColNm + ",6,2) IN ('01','03','05','07','08','10','12')  ")
										...
										.append("\n	      		      THEN CASE WHEN (MOD(SUBSTRING(" + dbcColNm + ",1,4), 4)) = 0  ")
										.append("\n	      			            THEN CASE WHEN (MOD(SUBSTRING(" + dbcColNm + ",1,4), 400)) = 0  ")
										.append("\n	      				                  THEN CASE WHEN SUBSTRING(" + dbcColNm + ",9,2) BETWEEN '01' AND '29'  ")
										.append("\n	      				                            THEN 1  ")
										.append("\n	      			     	                        ELSE 0  ")
										.append("\n	      			     	                    END ")
										.append("\n	      		                          ELSE CASE WHEN (MOD(SUBSTRING(" + dbcColNm + ",1,4) ,100)) = 0  ")
	...
	public String getErrorCountDateValidCondSql_YYYYMMDD_HH24MISS() {
		...
		.append("\n		AND SUBSTRING(" + dbcColNm + ", 6,1) BETWEEN '0' AND '9'  ")
		.append("\n		AND SUBSTRING(" + dbcColNm + ", 7,1) BETWEEN '0' AND '9'  ")
		.append("\n		AND SUBSTRING(" + dbcColNm + ", 8,1) BETWEEN '0' AND '9'  ") //yyyymmdd
		.append("\n		AND SUBSTRING(" + dbcColNm + ", 9,1) BETWEEN '0' AND '9'  ")
		.append("\n		AND SUBSTRING(" + dbcColNm + ", 10,1) BETWEEN '0' AND '9'  ") //hh
		.append("\n		AND SUBSTRING(" + dbcColNm + ", 11,1) = ':'  ") //:
		.append("\n		AND SUBSTRING(" + dbcColNm + ", 12,1) BETWEEN '0' AND '9'  ")
		.append("\n		AND SUBSTRING(" + dbcColNm + ", 13,1) BETWEEN '0' AND '9'  ") //mm
		.append("\n		AND SUBSTRING(" + dbcColNm + ", 14,1) = ':'  ") //:
		.append("\n		AND SUBSTRING(" + dbcColNm + ", 15,1) BETWEEN '0' AND '9'  ")
		.append("\n		AND SUBSTRING(" + dbcColNm + ", 16,1) BETWEEN '0' AND '9'  ") //ss	
		.append("\n     	THEN CASE WHEN SUBSTRING(" + dbcColNm + ",9,2) BETWEEN '00' AND '24'  ")
		.append("\n	      		  	  THEN CASE WHEN SUBSTRING(" + dbcColNm + ",12,2) BETWEEN '00' AND '59'  ")
		.append("\n	      			            THEN CASE WHEN SUBSTRING(" + dbcColNm + ",15,2) BETWEEN '00' AND '59'  ")
		.append("\n	      			                      THEN   ")
										.append("\n      		 CASE WHEN SUBSTRING(" + dbcColNm + ",5,2) IN ('01','03','05','07','08','10','12')  ")
										.append("\n	  			      THEN CASE WHEN SUBSTRING(" + dbcColNm + ",7,2) BETWEEN '01' AND '31'  ")
										.append("\n		   				        THEN 1  ")
	...
	public String getErrorCountDateValidCondSql_YYYY_MM(){
		...
		.append("\n		AND SUBSTRING(" + dbcColNm + " , 2,1) BETWEEN '0' AND '9'  ")
		.append("\n		AND SUBSTRING(" + dbcColNm + ", 3,1) BETWEEN '0' AND '9'  ")
		.append("\n		AND SUBSTRING(" + dbcColNm + ", 4,1) BETWEEN '0' AND '9'  ") //YYYY
		.append("\n		AND SUBSTRING(" + dbcColNm + ", 5,1) = '-'                ")
		.append("\n		AND SUBSTRING(" + dbcColNm + ", 6,1) BETWEEN '0' AND '9'  ")
		.append("\n		AND SUBSTRING(" + dbcColNm + ", 7,1) BETWEEN '0' AND '9'  ") //MM
	...
	public String getErrorCountDateValidCondSql_YYYYMMDDHH() {
		...
		.append("\n		AND SUBSTRING(" + dbcColNm + ", 4,1) BETWEEN '0' AND '9'  ") //YYYY
		.append("\n		AND SUBSTRING(" + dbcColNm + ", 5,1) BETWEEN '0' AND '9'  ")
		.append("\n		AND SUBSTRING(" + dbcColNm + ", 6,1) BETWEEN '0' AND '9'  ") //MM
		.append("\n		AND SUBSTRING(" + dbcColNm + ", 7,1) BETWEEN '0' AND '9'  ")
		.append("\n		AND SUBSTRING(" + dbcColNm + ", 8,1) BETWEEN '0' AND '9'  ") //DD
		.append("\n		AND SUBSTRING(" + dbcColNm + ", 9,1) BETWEEN '0' AND '9'  ")
		.append("\n		AND SUBSTRING(" + dbcColNm + ", 10,1) BETWEEN '0' AND '9'  ") //HH
		.append("\n     	THEN CASE WHEN SUBSTRING(" + dbcColNm + ",9,2) BETWEEN '00' AND '24'  ")
		.append("\n	      		  	  THEN CASE WHEN SUBSTRING(" + dbcColNm + ",11,2) BETWEEN '00' AND '59'  ")
	...
	public String getErrorCountDateValidCondSql_YYYYMMDDHHMI() {
		...
		.append("\n		AND SUBSTRING(" + dbcColNm + ", 10,1) BETWEEN '0' AND '9'  ") //HH
		.append("\n		AND SUBSTRING(" + dbcColNm + ", 11,1) BETWEEN '0' AND '9'  ")
		.append("\n		AND SUBSTRING(" + dbcColNm + ", 12,1) BETWEEN '0' AND '9'  ") //MM		
		.append("\n     	THEN CASE WHEN SUBSTRING(" + dbcColNm + ",9,2) BETWEEN '00' AND '24'  ")
		.append("\n	      		  	  THEN CASE WHEN SUBSTRING(" + dbcColNm + ",11,2) BETWEEN '00' AND '59'  ")
		.append("\n	      			            THEN CASE WHEN SUBSTRING(" + dbcColNm + ",13,2) BETWEEN '00' AND '59'  ")
		.append("\n	      			                      THEN   ")
	...
	public String getErrorCountDateValidCondSql_HH_24MI_SS() {
		...
		strQuery
		.append("\n    AND (CASE WHEN SUBSTRING(" + dbcColNm + " , 1,1) BETWEEN '0' AND '9'                           ")
		.append("\n		AND SUBSTRING(" + dbcColNm + " , 2,1) BETWEEN '0' AND '9'                                     ") //hh
		.append("\n		AND SUBSTRING(" + dbcColNm + ", 3,1) = ':'                                                    ") //:
		.append("\n		AND SUBSTRING(" + dbcColNm + ", 4,1) BETWEEN '0' AND '9'                                      ")
		.append("\n		AND SUBSTRING(" + dbcColNm + ", 5,1) BETWEEN '0' AND '9'                                      ") //mm
		.append("\n		AND SUBSTRING(" + dbcColNm + ", 6,1) = ':'                                                    ") //:
		.append("\n		AND SUBSTRING(" + dbcColNm + ", 7,1) BETWEEN '0' AND '9'                                      ")
		.append("\n		AND SUBSTRING(" + dbcColNm + ", 8,1) BETWEEN '0' AND '9'                                      ") //ss
		.append("\n     	THEN CASE WHEN SUBSTRING(" + dbcColNm + ",1,2) BETWEEN '00' AND '24'                      ")
		.append("\n	      		  	  THEN CASE WHEN SUBSTRING(" + dbcColNm + ",4,2) BETWEEN '00' AND '59'            ")
		.append("\n	      			            THEN CASE WHEN SUBSTRING(" + dbcColNm + ",7,2) BETWEEN '00' AND '59'  ")
		.append("\n	      			                      THEN 1                                                   ")
		.append("\n	      			                      ELSE 0                                                   ")
		.append("\n	      			                      END                                                      ")
		.append("\n	      			            ELSE 0                                                             ")
	...
	public String getErrorCountDateValidCondSql_HHMI() {
		...
		.append("\n		AND SUBSTRING(" + dbcColNm + " , 2,1) BETWEEN '0' AND '9'                                     ") //hh
		.append("\n		AND SUBSTRING(" + dbcColNm + ", 3,1) BETWEEN '0' AND '9'                                      ")
		.append("\n		AND SUBSTRING(" + dbcColNm + ", 4,1) BETWEEN '0' AND '9'                                      ") //mm
		.append("\n     	THEN CASE WHEN SUBSTRING(" + dbcColNm + ",1,2) BETWEEN '00' AND '24'                      ")
		.append("\n	      		  	  THEN CASE WHEN SUBSTRING(" + dbcColNm + ",3,2) BETWEEN '00' AND '59'            ")
		.append("\n	      			            THEN 1                                                             ")
		.append("\n	      			            ELSE 0                                                             ")
		.append("\n	      			            END                                                                ")
		.append("\n	      		      ELSE 0                                                                       ")
	...
	public String getErrorCountDateValidCondSql_HH24MISS() {
		...
		.append("\n		AND SUBSTRING(" + dbcColNm + ", 4,1) BETWEEN '0' AND '9'                                      ") //mm
		.append("\n		AND SUBSTRING(" + dbcColNm + ", 5,1) BETWEEN '0' AND '9'                                      ")
		.append("\n		AND SUBSTRING(" + dbcColNm + ", 6,1) BETWEEN '0' AND '9'                                      ") //ss
		.append("\n     	THEN CASE WHEN SUBSTRING(" + dbcColNm + ",1,2) BETWEEN '00' AND '24'                      ")
		.append("\n	      		  	  THEN CASE WHEN SUBSTRING(" + dbcColNm + ",3,2) BETWEEN '00' AND '59'            ")
		.append("\n	      			            THEN CASE WHEN SUBSTRING(" + dbcColNm + ",5,2) BETWEEN '00' AND '59'  ")
		.append("\n	      			                      THEN 1                                                   ")
		.append("\n	      			                      ELSE 0                                                   ")
		.append("\n	      			                      END                                                      ")
		.append("\n	      			            ELSE 0                                                             ")
