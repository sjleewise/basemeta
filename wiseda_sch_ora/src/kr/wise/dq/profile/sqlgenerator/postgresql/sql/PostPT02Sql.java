...
public class PostPT02Sql {
	...
	public PostPT02Sql(Map<String, Object> sqlGenMap){
	...
	public String getErrorCountSql() 
	{
		...
		strQuery.append(" SELECT coalesce(SUM(cnt),0) AS ERR_CNT ");
		strQuery.append("\n   FROM ( SELECT COUNT(*) as cnt FROM "+dbcTblNm ); 
		strQuery.append("\n  WHERE 1 = 1 ");
		if(adtCndSql != null && !adtCndSql.isEmpty())
		{
			strQuery.append("\n    AND "+adtCndSql );   
