package kr.wise.dq.profile.sqlgenerator.cubrid.sql;
...
public class CubridPC03Sql {
	...
	public CubridPC03Sql(Map<String, Object> sqlGenMap){
	...
	public String getErrorCountSql() 
	{
		...
		}else if(prfDtlVO.getDateFrmCd().equals("16")){
			strQuery.append(" " + getErrorCountDateValidCondSql_DD()+" ") ;
		}else if(prfDtlVO.getDateFrmCd().equals("17")){
			strQuery.append(" " + getErrorCountDateValidCondSql_MMDD()+" ") ;
		}else if(prfDtlVO.getDateFrmCd().equals("18")){
			strQuery.append(" " + getErrorCountDateValidCondSql_YYYY_MM_DD_HH_MI_SS()+" ") ;
		}else if(prfDtlVO.getDateFrmCd().equals("19")){
			strQuery.append(" " + getErrorCountDateValidCondSql_YYMMDD()+" ") ;
		}else{
	...
	//DD
			public String getErrorCountDateValidCondSql_DD() {
				...
				strQuery
				.append("\n    AND (                          ")
				.append("\n    				CASE WHEN SUBSTR(" + dbcColNm + " , 1,1) BETWEEN '0' AND '9'                           ")
				.append("\n				                            AND SUBSTR(" + dbcColNm + " , 2,1) BETWEEN '0' AND '9'                                     ") //숫자형 문자 검증
				.append("\n     				           THEN CASE WHEN SUBSTR(" + dbcColNm + ",1,2) BETWEEN '01' AND '31'                      ")			  // 일(day) 검증
				.append("\n	      			                                  THEN 1                                                                                 ")
				.append("\n         											  ELSE 0                                                                                 ")
				.append("\n         								  END                                                                            ")
				.append("\n         					   ELSE 0                                                                                 ")
			...
			//MMDD
			public String getErrorCountDateValidCondSql_MMDD() {
				StringBuffer strQuery = new StringBuffer();
				String sqlStr = new String();
				...
				.append("\n		AND SUBSTR(" + dbcColNm + ", 3,1) BETWEEN '0' AND '9'  ")
				.append("\n		AND SUBSTR(" + dbcColNm + ", 4,1) BETWEEN '0' AND '9'  ")
				.append("\n      	THEN CASE WHEN SUBSTR(" + dbcColNm + ",1,2) IN ('01','03','05','07','08','10','12')  ")
				.append("\n	  			      THEN CASE WHEN SUBSTR(" + dbcColNm + ",3,2) BETWEEN '01' AND '31'  ")
				.append("\n		   				        THEN 1  ")
				.append("\n		   		                ELSE 0  ")
				.append("\n		   		            END 	 ")
				.append("\n	                  WHEN SUBSTR(" + dbcColNm + ",1,2) IN ('04','06','09','11')  ")
				.append("\n	      		      THEN CASE WHEN SUBSTR(" + dbcColNm + ",3,2) BETWEEN '01' AND '30'  ")
				.append("\n	      			            THEN 1  ")
				.append("\n	      			 	        ELSE 0  ")
				.append("\n	      			        END  ")
				.append("\n	                  WHEN SUBSTR(" + dbcColNm + ",1,2) IN ('02')  ")
				.append("\n	      		      THEN CASE WHEN SUBSTR(" + dbcColNm + ",3,2) BETWEEN '01' AND '29'  ")
				.append("\n	      			            THEN 1  ")
				.append("\n	      			 	        ELSE 0  ")
				.append("\n	      			           END  ")
				.append("\n   		ELSE 0  ")
			...
			public String getErrorCountDateValidCondSql_YYYY_MM_DD_HH_MI_SS() {
				...
				strQuery
				.append("\n    AND (CASE WHEN SUBSTR(" + dbcColNm + " , 1,1) BETWEEN '0' AND '9'  ")//YYYY
				.append("\n		AND SUBSTR(" + dbcColNm + " , 2,1) BETWEEN '0' AND '9'  ")
				.append("\n		AND SUBSTR(" + dbcColNm + ", 3,1) BETWEEN '0' AND '9'  ")
				.append("\n		AND SUBSTR(" + dbcColNm + ", 4,1) BETWEEN '0' AND '9'  ")
				.append("\n		AND SUBSTR(" + dbcColNm + ", 5,1) = '-'  ")
				...
				.append("\n		AND SUBSTR(" + dbcColNm + ", 7,1) BETWEEN '0' AND '9'  ")
				.append("\n		AND SUBSTR(" + dbcColNm + ", 8,1) = '-'  ")
				.append("\n		AND SUBSTR(" + dbcColNm + ", 9,1) BETWEEN '0' AND '9'  ")	//DD
				.append("\n		AND SUBSTR(" + dbcColNm + ", 10,1) BETWEEN '0' AND '9'  ")
				.append("\n		AND SUBSTR(" + dbcColNm + ", 11,1) = ' '  ")
				.append("\n		AND SUBSTR(" + dbcColNm + ", 12,1) BETWEEN '0' AND '9'  ") //HH
				.append("\n		AND SUBSTR(" + dbcColNm + ", 13,1) BETWEEN '0' AND '9'  ")
				.append("\n		AND SUBSTR(" + dbcColNm + ", 14,1) = ':'  ")
				.append("\n		AND SUBSTR(" + dbcColNm + ", 15,1) BETWEEN '0' AND '9'  ")//MI
				.append("\n		AND SUBSTR(" + dbcColNm + ", 16,1) BETWEEN '0' AND '9'  ")
				.append("\n		AND SUBSTR(" + dbcColNm + ", 17,1) = ':'  ")
				.append("\n		AND SUBSTR(" + dbcColNm + ", 18,1) BETWEEN '0' AND '9'  ")//SS
			...
			public String getErrorCountDateValidCondSql_YYMMDD() {
				...
				.append("\n	  			      THEN CASE WHEN SUBSTR(" + dbcColNm + ",2,2) BETWEEN '01' AND '31'  ")
				.append("\n		   				        THEN 1  ")
				.append("\n		   		                ELSE 0  ")
				.append("\n		   		            END 	 ")
				...
				.append("\n	      			 	        ELSE 0  ")
				.append("\n	      			        END  ")
				.append("\n	      		      WHEN SUBSTR(" + dbcColNm + ",3,2) IN ('02')  ")
